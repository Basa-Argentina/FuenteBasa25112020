...
<title><spring:message code="formularioGroup.tituloConsulta"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioGroup.tituloConsulta" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarGroup.html" commandName="groupBusqueda"
					method="post">
					<fieldset>
						<table width="100%">
							<thead>
										...
										<table>
											<tr>
												...
												<td class="texto_ti"><input type="text" id="groupName"
													name="groupName" style="width: 200px;"
				...
				<fieldset>
					<display:table name="groups" id="group"
						requestURI="mostrarGroup.html" pagesize="7" sort="list"
						keepStatus="true">
						...
						<display:column property="groupName"
							titleKey="formularioGroup.groupName" sortable="true"
					...
					<div style="width: 100%;" align="right">
						<button name="agregar" type="button" onclick="agregarGroup();"
							class="botonCentrado">
