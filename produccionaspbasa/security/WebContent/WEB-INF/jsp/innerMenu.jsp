	...
	<div id="menu">
		<ul class="menu">
			...
			<sec:authorize ifAllGranted="ROLE_MOD_SEGURIDAD">
				<li><a href="#" class="parent"><span><spring:message
								code="menu.administrar" htmlEscape="true" /></span></a>
					<ul>
						<sec:authorize ifAnyGranted="ROLE_ABM_GRUPOS_DE_USUARIOS">
							<li><a href="iniciarGroup.html"><spring:message
										code="menu.adminGrupos" htmlEscape="true" /></a></li>
						</sec:authorize>
						<li><a href="iniciarAuthority.html"><spring:message
									code="menu.adminPrivilegios" htmlEscape="true" /></a></li>
						<sec:authorize ifAllGranted="ROLE_ABM_USUARIOS">
							<li><a href="iniciarUser.html"><spring:message
										code="menu.adminUsuarios" htmlEscape="true" /></a></li>
						</sec:authorize>
			...
			<sec:authorize ifAllGranted="ROLE_MOD_SEGURIDAD">
				<li><a href="#" class="parent"><span><spring:message
					...
					<ul>
						<li><a
							href="../configuracionGeneral/manuales/Manual-Seguridad.pdf"
			...
			<sec:authorize ifAllGranted="ROLE_ASP_ADMIN">
				<li><a href="#" class="parent"><span><spring:message
								code="menu.administrar" htmlEscape="true" /></span></a>
					<ul>
						<li><a href="iniciarCliente.html"><spring:message
									code="menu.administracion.adminClientes" htmlEscape="true" /></a></li>
						<li><a href="iniciarLicencia.html"><spring:message
									code="menu.administracion.adminLicencias" htmlEscape="true" /></a></li>
						<li><a href="precargaFormularioParameter.html"><spring:message
									code="menu.parametrosAdministrador" htmlEscape="true" /></a></li>
					</ul></li>
			</sec:authorize>
			<sec:authorize ifAllGranted="ROLE_ASP_ADMIN">
				<li><a href="#" class="parent"><span><spring:message
