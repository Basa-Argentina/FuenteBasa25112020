...
<title><spring:message code="formularioLicencia.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioLicencia.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form id="formLicencia" action="filtrarLicencia.html"
					commandName="licenciaBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLicencia.licencia.desde" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioLicencia.licencia.hasta" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioLicencia.licencia.estado" htmlEscape="true" />
									</td>
								...
								<tr>
									...
									<td class="texto_ti"><select id="estadoId" name="estadoId"
										size="1" style="width: 200px;">
											<c:forEach items="${estados}" var="estado">
												<option
													...
													<spring:message
														code="formularioLicencia.estado.${estado.nombre}" />
												</option>
											</c:forEach>
									</select></td>
								</tr>
				...
				<fieldset>
					<display:table name="licencias" id="licencia" requestURI=""
						...
						<display:column property="cliente.clienteStr"
							titleKey="formularioLicencia.cliente" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="estado.nombre"
							titleKey="formularioLicencia.licencia.estado" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="fechaDesdeStr"
							titleKey="formularioLicencia.licencia.desde" sortable="true"
							class="celdaAlineadoIzquierda" sortProperty="fechaDesde" />
						<display:column property="fechaHastaStr"
							titleKey="formularioLicencia.licencia.hasta" sortable="true"
							class="celdaAlineadoIzquierda" sortProperty="fechaHasta" />
