...
<title><c:if test="${accion == 'NUEVO'}">
		<spring:message code="formularioGroup.tituloFormAgregar"
		...
		<spring:message code="formularioGroup.tituloFormModificar"
			htmlEscape="true" /> - <spring:message code="general.empresa"
			htmlEscape="true" /> (<spring:message code="general.ambiente"
			htmlEscape="true" />)
			</c:if> <c:if test="${accion == 'CONSULTA'}">
		<spring:message code="formularioGroup.tituloFormConsultar"
			htmlEscape="true" /> - <spring:message code="general.empresa"
			htmlEscape="true" /> (<spring:message code="general.ambiente"
			htmlEscape="true" />)
			</c:if></title>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="guardarActualizarGroup.html"
					commandName="groupForm" method="post">
					...
					<input type="hidden" id="privilegiosGrupoSeleccionados"
						name="privilegiosGrupoSeleccionados" />
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
										...
										<table>
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioGroup.groupName" htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="text" id="groupName"
													name="groupName" style="width: 300px;" class="requerido"
													maxlength="60"
										...
										<fieldset>
												...
												<thead>
													<tr>
														<th align="left" id="grupoImg"><font
															style="color: #003090"> <spring:message
																	code="formularioGroup.asignacionPrivilegios"
																	htmlEscape="true" />
											...
											<div id="grupoDiv" align="center">
												<table>
													<tr>
														<td><spring:message
																code="formularioGroup.privilegiosDisponibles"
																htmlEscape="true" />:</td>
														<td>&nbsp;</td>
														<td><spring:message
																code="formularioGroup.privilegiosAsignados"
																htmlEscape="true" />:</td>
													</tr>
													<tr>
														<td width="40%" align="center"><select
															id="privilegiosGrupoSeleccionadosIzq"
															name="privilegiosGrupoSeleccionadosIzq" size="8"
															style="width: 250px" multiple="multiple">
																<c:forEach items="${privilegiosIzq}" var="privilegioIzq">
																	<option
																		value="<c:out value="${privilegioIzq.authority}"/>">
																		<c:out value="${privilegioIzq.authority}" />
																	</option>
																</c:forEach>
														</select></td>
														<td width="20%" align="center"><sec:authorize
																ifAnyGranted="ROLE_ABM_GRUPOS_DE_USUARIOS">
																<c:if test="${accion != 'CONSULTA'}">
																	<img
																		src="<%=request.getContextPath()%>/images/insertar.png"
																		onclick="leftToRight('privilegiosGrupoSeleccionados')"
																		title=<spring:message code="botones.insertar" htmlEscape="true"/>>
																	<br />
																	<img
																		src="<%=request.getContextPath()%>/images/quitar.png"
																		onclick="rightToLeft('privilegiosGrupoSeleccionados')"
																		title=<spring:message code="botones.quitar" htmlEscape="true"/>>
																	<br />
																</c:if>
															</sec:authorize></td>
														<td width="40%" align="center"><select
															id="privilegiosGrupoSeleccionadosDer"
															name="privilegiosGrupoSeleccionadosDer" size="8"
															style="width: 250px" multiple="multiple">
																<c:forEach items="${privilegiosDer}" var="privilegioDer">
																	<option
																		value="<c:out value="${privilegioDer.authority}"/>">
