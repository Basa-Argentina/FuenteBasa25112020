					...
					<fieldset>
						...
						<div style="width: 100%;" id="busquedaDiv" align="center">
							<table style="width: 100%;">
								<tr>
									<td colspan="4" style="text-align: left;">
										<fieldset>
											<legend>
												<spring:message
													code="formularioCliente.datosCliente.identificacion"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioCliente.datosCliente.identificacion.razonSocial"
															htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
															code="formularioCliente.datosCliente.identificacion.nombreAbreviado"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text"
														id="persona.razonSocial" name="persona.razonSocial"
														style="width: 200px;" maxlength="60"
														value="<c:out value="${clienteFormulario.persona.razonSocial}" default="" />"
														class="requerido"
													...
													<td class="texto_ti"><input type="text"
														id="nombreAbreviado" name="nombreAbreviado"
														style="width: 200px;" maxlength="30"
														value="<c:out value="${clienteFormulario.nombreAbreviado}" default="" />"
														class="requerido lowerCase"
														<c:if test="${accion != 'NUEVO'}">
																	readonly="readonly"
																</c:if> />
								...
								<tr>
													...
													<td>
														<fieldset style="border: none;">
															<table>
																...
																<tr>
																	<td class="texto_ti"><select
																		id="persona.direccion.idBarrio"
																		name="persona.direccion.idBarrio" size="1"
													...
													<td>
														<fieldset style="border: none;">
															<table>
																...
																<tr>
																	<td class="texto_ti"><input type="text"
																		id="persona.direccion.calle"
																		name="persona.direccion.calle" style="width: 190px;"
																		size="60" class="requerido capitalizar"
																...
																<tr>
																	<td class="texto_ti"><input type="text"
																		id="persona.direccion.numero"
																		name="persona.direccion.numero" style="width: 50px;"
																		maxlength="6" class="requerido"
																...
																<tr>
																	<td class="texto_ti"><input type="text"
																		id="persona.direccion.piso"
																		name="persona.direccion.piso" style="width: 50px;"
																		maxlength="3"
																...
																<tr>
																	<td class="texto_ti"><input type="text"
																		id="persona.direccion.dpto"
																		name="persona.direccion.dpto" style="width: 50px;"
																		maxlength="1"
									...
									<td style="vertical-align: top;">
										<fieldset style="height: 222px;">
											<legend>
												<spring:message
													code="formularioCliente.datosCliente.datosAdicionales"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioCliente.datosCliente.datosAdicionales.tipoDocumento"
															htmlEscape="true" /></td>
												</tr>
												<tr>
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioCliente.datosCliente.datosAdicionales.numeroDocumento"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text"
														id="persona.numeroDoc" name="persona.numeroDoc"
														style="width: 190px;" maxlength="15"
														value="<c:out value="${clienteFormulario.persona.numeroDoc}" default="" />"
														class="requerido"
														<c:if test="${accion == 'CONSULTA'}">
																	readonly="readonly"
																</c:if> />
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioCliente.datosCliente.datosAdicionales.telefono"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text"
														id="persona.telefono" name="persona.telefono"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioCliente.datosCliente.datosAdicionales.mail"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text"
														id="persona.mail" name="persona.mail"
									...
									<td style="vertical-align: top;">
										<fieldset style="height: 222px;">
											<legend>
												<spring:message
													code="formularioCliente.datosCliente.observaciones"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
													<td class="texto_ti" rowspan="8"><textarea
															id="observaciones" name="observaciones" rows="10"
								...
								<tr>
									<td colspan="4"><br style="font-size: xx-small;" />
										<fieldset>
											<table width="100%">
												<thead>
													<tr>
														<th align="left" id="grupoImg"><font
															...
															title="<spring:message code="textos.cerrarPanel" htmlEscape="true"/>">
															<img id="grupoImgSrc" style="DISPLAY: none"
															src="images/skip.png"
															title="<spring:message code="textos.abrirPanel" htmlEscape="true"/>">
														</th>
													</tr>
													...
													<tr>
														<td colspan="4" style="text-align: left;">
															<fieldset>
																<legend>
																	<spring:message
																		code="formularioCliente.datosCliente.contacto.identificacion"
																		htmlEscape="true" />
																</legend>
																<table>
																	<tr>
																		<td class="texto_ti"><spring:message
																				code="formularioCliente.datosCliente.contacto.identificacion.nombre"
																				htmlEscape="true" /></td>
																		<td class="texto_ti"><spring:message
																				code="formularioCliente.datosCliente.contacto.identificacion.apellido"
																				htmlEscape="true" /></td>
																	</tr>
																	<tr>
																		<td class="texto_ti"><input type="text"
																			id="contacto.nombre" name="contacto.nombre"
																			style="width: 200px;" maxlength="30"
																			class="requerido capitalizar"
																		...
																		<td class="texto_ti"><input type="text"
																			id="contacto.apellido" name="contacto.apellido"
																			style="width: 200px;" maxlength="30"
																			class="requerido capitalizar"
																		...
																		<td>
																			<fieldset style="border: none;">
																				<table>
																					...
																					<tr>
																						<td class="texto_ti"><select
																							id="paisContacto" name="pais" size="1"
																							style="width: 190px;"
																							<c:if test="${accion == 'CONSULTA'}">
																										disabled="disabled"
																									</c:if>>
																					...
																					<tr>
																						<td class="texto_ti"><select
																							id="provinciaContacto" name="provincia" size="1"
																							style="width: 190px;"
																							<c:if test="${accion == 'CONSULTA'}">
																										disabled="disabled"
																									</c:if>>
																					...
																					<tr>
																						<td class="texto_ti"><select
																							id="localidadContacto" name="localidad" size="1"
																							style="width: 190px;"
																							<c:if test="${accion == 'CONSULTA'}">
																										disabled="disabled"
																									</c:if>>
																					...
																					<tr>
																						<td class="texto_ti"><select
																							id="contacto.direccion.idBarrio"
																							name="contacto.direccion.idBarrio" size="1"
																							style="width: 190px;" class="requerido"
																							<c:if test="${accion == 'CONSULTA'}">
																										disabled="disabled"
																									</c:if>>
																		...
																		<td>
																			<fieldset style="border: none;">
																				<table>
																					...
																					<tr>
																						<td class="texto_ti"><input type="text"
																							id="contacto.direccion.calle"
																							name="contacto.direccion.calle" maxlength="30"
																							class="capitalizar"
																					...
																					<tr>
																						<td class="texto_ti"><input type="text"
																							id="contacto.direccion.piso"
																							name="contacto.direccion.piso"
																					...
																					<tr>
																						<td class="texto_ti"><input type="text"
																							id="contacto.direccion.dpto"
																							name="contacto.direccion.dpto"
														...
														<td style="vertical-align: top;">
															<fieldset style="height: 220px;">
																...
																<table>
																	...
																	<tr>
																		<td class="texto_ti"><input type="text"
																			id="contacto.telefono" name="contacto.telefono"
																	...
																	<tr>
																		<td class="texto_ti"><spring:message
																				code="formularioCliente.datosCliente.contacto.mail"
																				htmlEscape="true" /></td>
																	</tr>
																	<tr>
																		<td class="texto_ti"><input type="text"
																			id="contacto.mail" name="contacto.mail"
																			style="width: 200px;" maxlength="60"
																			class="requerido lowerCase"
														...
														<td style="vertical-align: top;">
															<fieldset style="height: 220px;">
																...
																<table>
																	<tr>
																		<td class="texto_ti"><spring:message
																				code="formularioCliente.datosCliente.contacto.username"
																				htmlEscape="true" /></td>
																	</tr>
																	<tr>
																		<td class="texto_ti"><input type="text"
																	...
																	<c:if test="${accion == 'NUEVO'}">
																		<tr>
																			<td class="texto_ti"><spring:message
																					code="formularioCliente.datosCliente.contacto.password"
																					htmlEscape="true" /></td>
																		</tr>
																		<tr>
																			<td class="texto_ti"><input type="password"
																				id="user.password" name="user.password"
																				style="width: 150px;" maxlength="30" /></td>
																		</tr>
																		<tr>
																			<td class="texto_ti"><spring:message
																					code="formularioCliente.datosCliente.contacto.passwordConfirmar"
																					htmlEscape="true" /></td>
																		</tr>
																		<tr>
																			<td class="texto_ti"><input type="password"
																				id="user.confirmarContrasenia"
																				name="user.confirmarContrasenia"
																				style="width: 150px;" maxlength="30" /></td>
																		</tr>
																	</c:if>
																</table>
