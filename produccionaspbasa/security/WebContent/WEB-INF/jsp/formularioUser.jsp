...
<title><c:if test="${accion == 'NUEVO'}">
		<spring:message code="formularioUser.tituloFormAgregar"
		...
		<spring:message code="formularioUser.tituloFormModificar"
			htmlEscape="true" /> - <spring:message code="general.empresa"
			htmlEscape="true" /> (<spring:message code="general.ambiente"
			htmlEscape="true" />)
			</c:if> <c:if test="${accion == 'CONSULTA'}">
		<spring:message code="formularioUser.tituloFormConsultar"
			htmlEscape="true" /> - <spring:message code="general.empresa"
			htmlEscape="true" /> (<spring:message code="general.ambiente"
			htmlEscape="true" />)
			</c:if></title>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="guardarActualizarUser.html"
					...
					<c:if test="${accion != 'NUEVO'}">
						<input type="hidden" id="id" name="id"
							value="<c:out value="${userFormulario.id}" default=""/>" />
					</c:if>
					<fieldset>
						<table width="100%">
							<thead>
							...
							<table style="width: 100%;">
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioUser.username" htmlEscape="true" /></td>
									<c:if test="${accion != 'CONSULTA'}">
										<td class="texto_ti"><spring:message
												code="formularioUser.password" htmlEscape="true" /></td>
										<td class="texto_ti"><spring:message
												code="formularioUser.confirmarPassword" htmlEscape="true" />
										</td>
									</c:if>
								</tr>
								<tr>
									<td class="texto_ti"><input type="text" id="username"
										name="username" style="width: 200px;" maxlength="30"
										class="requerido"
										<c:if test="${accion != 'NUEVO'}">
									...
									<c:if test="${accion != 'CONSULTA'}">
										<td class="texto_ti"><input type="password" id="password"
											name="password" style="width: 200px;" maxlength="30"
										...
										<td class="texto_ti"><input type="password"
											...
											maxlength="30" style="width: 200px;" class="descripcionCorta" />
										</td>
									</c:if>
								</tr>
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioUser.firstName" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioUser.surName" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioUser.eMail" htmlEscape="true" /></td>
								</tr>
								<tr>
									...
									<td class="texto_ti"><input type="text" id="persona.mail"
										name="persona.mail" style="width: 200px;" class="requerido"
										maxlength="60"
										...
										<fieldset>
												...
												<thead>
													<tr>
														<th align="left" id="grupoImg"><font
															style="color: #003090"> <spring:message
																	code="formularioUser.asignacionGrupos"
																	htmlEscape="true" />
											...
											<div id="grupoDiv" align="center">
												<table>
													<tr>
														<td class="texto_ti"><spring:message
																code="formularioUser.gruposDisponibles"
																htmlEscape="true" /></td>
														<td>&nbsp;</td>
														<td class="texto_ti"><spring:message
																code="formularioUser.gruposAsignados" htmlEscape="true" />
														</td>
													</tr>
													<tr>
														<td width="40%" align="center"><select
															id="assignedRolesIzq" name="assignedRolesIzq" size="8"
