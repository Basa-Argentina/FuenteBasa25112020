...
<title><spring:message
		code="formularioParameterInsMod.tituloForm" htmlEscape="true" /> - <spring:message
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioParameterInsMod.tituloForm" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="guardarActualizarParameter.html"
					commandName="parameterInsModForm" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="textos.datosCaracteristicos" htmlEscape="true" />
								...
								<tr>
									<td style="width: 42%; vertical-align: top;">
										<fieldset style="height: 190px;">
											<legend>
												<spring:message
													code="formularioParameterInsMod.tituloSeguridad"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.passwordExpirationDays"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="text"
														id="passwordExpirationDays" name="passwordExpirationDays"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.passwordWarningDays"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="text"
														id="passwordWarningDays" name="passwordWarningDays"
														style="width: 50px;" class="requerido"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.failedLoginCounter"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="text"
														id="failedLoginCounter" name="failedLoginCounter"
														style="width: 50px;" class="requerido"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.minutesSanctionLogin"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="text"
														id="minutesSanctionLogin" name="minutesSanctionLogin"
														style="width: 50px;" class="requerido"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.enableOldPassword"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="checkbox"
														id="enable" name="enable" style="width: auto;"
									...
									<td style="width: auto; vertical-align: top;">
										<fieldset style="height: 190px;">
											<legend>
												<spring:message code="formularioParameterInsMod.tituloSMTP"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.hostSMTP"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="text" id="hostSMTP"
														name="hostSMTP" style="width: 200px;" class="requerido"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.portSMTP"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="text" id="portSMTP"
														name="portSMTP" style="width: 200px;" class="requerido"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.enableSSLSMTP"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="checkbox"
														id="enableSSL" name="enableSSL" style="width: auto;"
														class="requerido"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.userSMTP"
															htmlEscape="true" />:</td>
													<td class="texto_ti"><input type="text" id="userSMTP"
														name="userSMTP" style="width: 200px;" class="requerido"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.eMailUserSMTP"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="text"
														id="eMailUserSMTP" name="eMailUserSMTP"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.passwordSMTP"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="password"
														id="passwordSMTP" name="passwordSMTP"
														style="width: 200px;" class="requerido"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioParameterInsMod.enableSPASMTP"
															htmlEscape="true" /></td>
													<td class="texto_ti"><input type="checkbox"
														id="enableSPA" name="enableSPA" style="width: auto;"
			...
			<c:if test="${accion == 'CONSULTA'}">
				<div align="center">
					<button name="volver_atras" type="button" onclick="volver();"
						class="botonCentrado">
						<img src="<%=request.getContextPath()%>/images/volver.png">
