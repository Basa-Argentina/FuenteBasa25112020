...
<title><spring:message code="formularioAuthority.tituloConsulta"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioAuthority.tituloConsulta" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarAuthority.html"
					commandName="authorityBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
										...
										<table>
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioAuthority.authority" htmlEscape="true" />
												</td>
											...
											<tr>
												<td class="texto_ti"><input type="text" id="authority"
													name="authority" style="width: 200px;"
				...
				<fieldset>
					<display:table name="authoritys" id="authority"
						requestURI="mostrarAuthority.html" pagesize="7" sort="list"
						keepStatus="true">
						...
						<display:column property="authority"
							titleKey="formularioAuthority.authority" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="description"
							titleKey="formularioAuthority.description" sortable="true"
							class="celdaAlineadoIzquierda" />
					</display:table>
				</fieldset>
				<br style="font-size: xx-small;" />
