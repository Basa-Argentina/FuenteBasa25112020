	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_td"><spring:message
											code="formularioCliente.nombreCliente" htmlEscape="true" /></td>
									...
									<td class="texto_td"><spring:message
											code="formularioCliente.nombreContacto" htmlEscape="true" />
									</td>
									<td class="texto_ti"><input type="text"
				...
				<fieldset>
					<display:table name="clientes" id="cliente" requestURI=""
						...
						<display:column property="clienteStr"
							titleKey="formularioCliente.nombreCliente" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="contactoStr"
							titleKey="formularioCliente.nombreContacto" sortable="true"
							class="celdaAlineadoIzquierda" />
