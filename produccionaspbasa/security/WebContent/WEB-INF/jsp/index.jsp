...
<title>SECMOD - <spring:message code="general.empresa"
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="center">
			...
			<fieldset style="border: none; text-align: left;">
				<legend>
					<font class="tituloForm" size="5"> <sec:authorize
							ifAnyGranted="ROLE_ASP_ADMIN">
							<spring:message code="bienvenidoAsp" htmlEscape="true" />
						</sec:authorize> <sec:authorize ifAnyGranted="ROLE_MOD_SEGURIDAD">
