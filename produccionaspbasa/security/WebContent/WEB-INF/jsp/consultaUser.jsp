...
<title><spring:message code="formularioUser.tituloConsulta"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioUser.tituloConsulta" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarUser.html" commandName="userBusqueda"
					method="post">
					<fieldset>
						<table width="100%">
							<thead>
				...
				<fieldset>
					<display:table name="users" id="user"
						requestURI="/mostrarUser.html" pagesize="7" sort="list"
						keepStatus="true">
						...
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_eliminar"
								value="<spring:message code="notif.user.deleteUser" htmlEscape="true"/>" />
						</display:column>
						<display:column property="usernameSinCliente"
							titleKey="formularioUser.username" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="persona.nombre"
							titleKey="formularioUser.firstName" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="persona.apellido"
							titleKey="formularioUser.surName" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column titleKey="formularioUser.enabled" sortable="true"
					...
					<div style="width: 100%" align="right">
						<button name="agregar" type="button" onclick="agregarUser();"
							class="botonCentrado">
