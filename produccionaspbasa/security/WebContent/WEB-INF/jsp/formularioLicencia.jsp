...
<title><c:if test="${accion == 'NUEVO'}">
		<spring:message code="formularioLicencia.titulo.registar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'MODIFICACION'}">
		<spring:message code="formularioLicencia.titulo.modificar"
			htmlEscape="true" />
	</c:if></title>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form name="formLicencia"
					action="guardarActualizarLicencia.html"
					commandName="licenciaFormulario" method="post"
					modelAttribute="licenciaFormulario">
					<input type="hidden" id="accion" name="accion"
						value="<c:out value="${accion}" default="" />" />
					<input type="hidden" id="id" name="id"
						value="<c:out value="${licenciaFormulario.id}" default="" />" />
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table style="width: 100%;">
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLicencia.cliente" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLicencia.estado" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLicencia.desde" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLicencia.hasta" htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti"><select id="idCliente"
										name="idCliente" size="1" style="width: 200px;"
										class="requerido">
									...
									<td class="texto_ti"><select id="estadoId" name="estadoId"
										size="1" style="width: 200px;" class="requerido">
									...
									<td class="texto_ti"><input type="text" id="fechaDesde"
										name="fechaDesde" maxlength="10" class="requerido"
									...
									<td class="texto_ti"><input type="text" id="fechaHasta"
										name="fechaHasta" maxlength="10" class="requerido"
