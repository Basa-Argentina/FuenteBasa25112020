...
<title><spring:message
		code="formularioUserPersonalData.tituloForm" htmlEscape="true" /> - <spring:message
...
<script language="JavaScript"
	src="js/mavalos_formulario_user_personal_data.js"
	type="text/javascript"></script>
...
<body onload="mostrarErrores(${errores});">
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="center">
			...
			<fieldset style="border: none;">
				<legend align="left">
					<font class="tituloForm" size="5"> <spring:message
							code="formularioUserPersonalData.tituloForm" htmlEscape="true" />
					</font>
				</legend>
			</fieldset>
			...
			<table>
				<tr>
					<td><form:form action="guardarActualizarUserPersonalData.html"
							method="post" modelAttribute="userPersonalDataFormulario">
							<input type="hidden" id="persona.id" name="persona.id"
								value="<c:out value="${userPersonalDataFormulario.persona.id}" default="" />" />
							<fieldset>
								<table width="100%">
									<thead>
										<tr>
											<th align="left" id="caractImg"><font
												style="color: #003090"><spring:message
														code="textos.datosCaracteristicos" htmlEscape="true" /></font></th>
										</tr>
									</thead>
								</table>
								<div class="seccion3">
										...
										<tr>
											<td colspan="3">
												<fieldset>
													<legend>
														<spring:message
															code="formularioUserPersonalData.datospersonales"
															htmlEscape="true" />
													</legend>
													<table>
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.datospersonales.nombre"
																	htmlEscape="true" /></td>
															<td style="width: 20px;"></td>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.datospersonales.apellido"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_field"><input type="text"
										...
										<tr>
											<td style="vertical-align: top;">
												<fieldset style="height: 220px;">
													<legend>
														<spring:message
															code="formularioUserPersonalData.ubicacion"
															htmlEscape="true" />
													</legend>
													<table>
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.ubicacion.pais"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_label"><select id="pais"
																name="pais" size="1" style="width: 190px;">
														...
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.ubicacion.provincia"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_label"><select id="provincia"
														...
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.ubicacion.localidad"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_label"><select id="localidad"
														...
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.ubicacion.barrio"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_label"><select
											...
											<td style="vertical-align: top;">
												<fieldset style="height: 220px;">
													<legend>
														<spring:message
															code="formularioUserPersonalData.direccion"
															htmlEscape="true" />
													</legend>
													<table>
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.direccion.calle"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_label"><input type="text"
																id="persona.direccion.calle"
																name="persona.direccion.calle" style="width: 100px;"
																value="<c:out value="${userPersonalDataFormulario.persona.direccion.calle}" default="" />" />
															</td>
														</tr>
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.direccion.numero"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_label"><input type="text"
																id="persona.direccion.numero"
																name="persona.direccion.numero" style="width: 100px;"
																value="<c:out value="${userPersonalDataFormulario.persona.direccion.numero}" default="" />" />
															</td>
														</tr>
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.direccion.piso"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_label"><input type="text"
																id="persona.direccion.piso"
																name="persona.direccion.piso" style="width: 100px;"
																value="<c:out value="${userPersonalDataFormulario.persona.direccion.piso}" default="" />" />
															</td>
														</tr>
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.direccion.dpto"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_label"><input type="text"
																id="persona.direccion.dpto"
																name="persona.direccion.dpto" style="width: 100px;"
											...
											<td style="vertical-align: top;">
												<fieldset style="height: 220px;">
													<legend>
														<spring:message code="formularioUserPersonalData.contacto"
															htmlEscape="true" />
													</legend>
													<table>
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.contacto.mail"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_field"><input type="text"
														...
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.contacto.telefono"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_field"><input type="text"
										...
										<tr>
											<td colspan="3">
												<fieldset>
													<legend>
														<spring:message
															code="formularioUserPersonalData.datosPorDefecto"
															htmlEscape="true" />
													</legend>
													<table style="width: 100%;">
														<tr>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.datosPorDefecto.empresa"
																	htmlEscape="true" /></td>
															<td class="texto_label"><spring:message
																	code="formularioUserPersonalData.datosPorDefecto.sucursal"
																	htmlEscape="true" /></td>
														</tr>
														<tr>
															<td class="texto_field"><input type="text"
			...
			<div align="center">
				<button name="guardar" type="button" onclick="guardar()"
					class="botonCentrado">
