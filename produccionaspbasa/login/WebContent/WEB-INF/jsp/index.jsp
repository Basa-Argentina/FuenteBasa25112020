...
<title><spring:message code="bienvenido" htmlEscape="true" /> -
...
<script language="JavaScript" src="js/mavalos_jquery.tools.min.js"
	type="text/javascript"></script>
<script language="JavaScript" src="js/mavalos_index.js"
	type="text/javascript"></script>
...
<body
	onload="mostrarErrores(${errores}); mostrarAvisos(${hayAvisos || hayAvisosNeg}); setSeparador('<c:out value="${separador}"/>')">
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="center">
			...
			<fieldset style="border: none;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="bienvenido" htmlEscape="true" />
					</font>
				</legend>
			</fieldset>
			<br>
							...
							<td valign="top" style="text-align: left;">
								<fieldset>
									<table width="100%">
										<thead>
											<tr>
												<th align="left" id="agenciaImg"><font
													style="color: #003090"><spring:message
															code="index.loggin" htmlEscape="true" /></font></th>
											</tr>
										</thead>
									</table>
											...
											<fieldset style="border: none;">
												<table width="100%">
													<tr>
														<td align="left">
															<p>
																<label for="j_empresa"><spring:message
																		code="login.empresa" htmlEscape="true" /></label> <input
																	type='text' id='j_empresa' style="width: 145px;"
																	class="lowerCase" />
															</p>
															<p>
																<label for="j_username"><spring:message
																		code="login.usuario" htmlEscape="true" /></label> <input
																	type='text' name='j_username' id='j_username'
																	style="width: 145px;" class="lowerCase" />
															</p>
															<p>
																<label for="j_password"><spring:message
																		code="login.pass" htmlEscape="true" /></label> <input
														...
														<td><c:if test="${not empty param.login_error}">
																<font
																	style="font-size: 11px; color: red; position: absolute; text-align: center; padding-left: 50px;">
													...
													<tr>
														<td style="text-align: center;">
															<button name="guardar" type="button" class="botonLoggin"
																onclick="login()">
																<img src="<%=request.getContextPath()%>/images/ok3.png"
																	border="0" />
																<spring:message code="botones.ingresar"
																	htmlEscape="true" />
															</button>
														</td>
													</tr>
													<tr>
														<td style="text-align: center;"><a
															href="precargaFormularioRestorePassword.html"
															style="color: #003090; font-size: 11px;"><spring:message
																	code="login.restorePassword" htmlEscape="true" /></a></td>
													</tr>
												</table>
											</fieldset>
										</form>
			...
			<sec:authorize ifAnyGranted="ROLE_NO_LICENSE">
				<font style="font-size: large; color: #8A0808;"> <spring:message
						code="notif.licencia.licenciaNoValida" htmlEscape="true" />
				</font>
				<br />
				<br />
				<table>
					<tr>
						<td>
							<fieldset>
								...
								<form:form action="enviarMailAdministrador.html"
									commandName="mail" method="post" modelAttribute="mail">
									<table>
										<tr>
											<td style="vertical-align: top;"><spring:message
													code="mail.asunto" htmlEscape="true" /></td>
											<td style="vertical-align: top;"><input type="text"
												id="asunto" name="asunto" style="width: 414px;"
												maxlength="100" /></td>
										</tr>
										<tr>
											<td style="vertical-align: top;"><spring:message
													code="mail.mensaje" htmlEscape="true" /></td>
											<td style="vertical-align: top;"><textarea id="mensaje"
													name="mensaje" rows="10" cols="50" style="resize: none;"><c:out
														value="${clienteFormulario.observaciones}" /></textarea></td>
										</tr>
										<tr>
											<td style="text-align: right;" colspan="2">
												<button type="submit" class="botonCentrado">
													<img
														src="<%=request.getContextPath()%>/images/mail_forward.png" />
			...
			<sec:authorize ifAnyGranted="ROLE_ANY_AUTHENTICATED">
				<c:if test="${setEmpresa == null}">
					<font style="font-size: large; color: #8A0808;"> <spring:message
							code="notif.empresaSucursal.noConfigurada" htmlEscape="true" />
					</font>
					<br />
					<br />
					<table>
						<tr>
							<td>
								<fieldset>
									<legend>
										<spring:message code="notif.empresaSucursal.infomarcion"
											htmlEscape="true" />
									</legend>
									<form:form id="continuar" name="continuar"
										action="noConfigurarEmpresaSucursal.html" method="POST">
										<table>
											<tr>
												<td style="vertical-align: top;"><spring:message
														code="notif.empresaSucursal.mensaje" htmlEscape="true" />
												</td>
											</tr>
											<tr>
												<td style="text-align: center;">
													<button name="aceptar" type="button"
														onclick="configurarEmpresaSucursal();"
														class="botonCentrado">
														<img src="<%=request.getContextPath()%>/images/match.png"
			...
			<c:if test="${setEmpresa == true}">
				<sec:authorize ifNotGranted="ROLE_NO_LICENSE"
					ifAnyGranted="ROLE_ANY_AUTHENTICATED">
				...
				<table>
						...
						<tr>
							<td class="texto_ti">
								<form action="redirect.html" method="post" id="secmodForm">
									<input type="hidden" name="modulo" value="security"> <input
										type="hidden" name="submodulo" value="secmod"> <a
										href="#"
										onclick="javascript:document.getElementById('secmodForm').submit();">
										<img src="<%=request.getContextPath()%>/images/c_gris.png" />
										&nbsp;<spring:message code="index.modulo.aspmod"
											htmlEscape="true" />
									</a>
								</form>
							</td>
							...
							<td class="texto_ti">
								<form action="redirect.html" method="post" id="cccmodForm">
									...
									<a href="#" onclick="ingresarModulo('cccmodForm','cccmod');">
										<img src="<%=request.getContextPath()%>/images/c_gris.png" />
										&nbsp;<spring:message code="index.modulo.cccmod"
											htmlEscape="true" />
									</a>
								</form>
							</td>
							...
							<td class="texto_ti">
								<form action="redirect.html" method="post" id="cfgmodForm">
									...
									<a href="#" onclick="ingresarModulo('cfgmodForm','cfgmod');">
										<img src="<%=request.getContextPath()%>/images/c_gris.png" />
										&nbsp;<spring:message code="index.modulo.cfgmod"
											htmlEscape="true" />
									</a>
								</form>
							</td>
							...
							<td class="texto_ti">
								<form action="redirect.html" method="post" id="depmodForm">
									...
									<a href="#" onclick="ingresarModulo('depmodForm','depmod');">
										<img src="<%=request.getContextPath()%>/images/c_gris.png" />
										&nbsp;<spring:message code="index.modulo.depmod"
											htmlEscape="true" />
									</a>
								</form>
							</td>
					...
					<sec:authorize ifAnyGranted="ROLE_MOD_DEPOSITOS">
						...
						<tr>
							<td class="texto_ti">
								<form action="redirectProxy.html" method="post"
									id="cargaRefForm" name="cargaRefForm">
									<input type="hidden" name="modulo" value="configuracionGeneral">
									<input type="hidden" name="submodulo"
										value="consultaLotesReferencia"> <a href="#"
										onclick="javascript:document.getElementById('cargaRefForm').submit();">
										<img src="<%=request.getContextPath()%>/images/c_gris.png" />
										&nbsp;<spring:message code="index.modulo.cargaDoc"
											htmlEscape="true" />
									</a>
								</form>
							</td>
						...
						<tr>
							<td class="texto_ti">
								<form action="redirectProxy.html" method="post"
									id="consultaRefForm" name="consultaRefForm">
									<input type="hidden" name="modulo" value="configuracionGeneral">
									<input type="hidden" name="submodulo" value="iniciarReferencia">
									<a href="#"
										onclick="javascript:document.getElementById('consultaRefForm').submit();">
										<img src="<%=request.getContextPath()%>/images/c_gris.png" />
										&nbsp;<spring:message code="index.modulo.busquedaDoc"
											htmlEscape="true" />
									</a>
								</form>
							</td>
							...
							<td class="texto_ti">
								<form action="redirect.html" method="post" id="secmodForm">
									<input type="hidden" name="modulo" value="security"> <input
										...
										onclick="javascript:document.getElementById('secmodForm').submit();">
										<img src="<%=request.getContextPath()%>/images/c_gris.png" />
										&nbsp;<spring:message code="index.modulo.secmod"
											htmlEscape="true" />
									</a>
								</form>
							</td>
					...
					<sec:authorize ifAnyGranted="ROLE_MOD_REQUERIMIENTOS_WEB">
						...
						<tr>
							<td class="texto_ti">
								<form action="redirectProxy.html" method="post"
									id="reqwebProxyForm" name="reqwebProxyForm">
									<input type="hidden" name="modulo" value="configuracionGeneral">
									<input type="hidden" name="submodulo"
										value="precargaFormularioRequerimientoWeb"> <a
										href="#"
										onclick="javascript:document.getElementById('reqwebProxyForm').submit();">
										<img src="<%=request.getContextPath()%>/images/c_gris.png" />
										&nbsp;<spring:message code="index.modulo.pedidoWeb"
											htmlEscape="true" />
									</a>
								</form>
							</td>
					...
					<sec:authorize ifAnyGranted="ROLE_ABM_FACTURAS">
						<tr>
							<td class="texto_ti">
								<form action="redirect.html" method="post" id="fctmodForm"
									name="fctmodForm">
									<input type="hidden" name="modulo" value="facturacion">
									<input type="hidden" name="submodulo" value="fctmod"> <a
										href="#" onclick="ingresarModulo('fctmodForm','fctmod');">
										<img src="<%=request.getContextPath()%>/images/c_gris.png" />
										&nbsp;<spring:message code="index.modulo.fctmod"
											htmlEscape="true" />
									</a>
								</form>
							</td>
