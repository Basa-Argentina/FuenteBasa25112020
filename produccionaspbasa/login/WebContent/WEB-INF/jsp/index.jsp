      	   ...
      	   <a href="#" onclick="javascript:document.getElementById('consultaRefForm').submit();">
       	   ...
       	   &nbsp;<spring:message code="index.modulo.busquedaDoc" htmlEscape="true"/>
							...
							<td class="texto_ti">			
								<form action="redirect.html" method="post" id="reqmodForm">
									...
									<a href="#" onclick="ingresarModulo('reqmodForm','reqmod');">
										<img src="<%=request.getContextPath()%>/images/c_gris.png"/>
										&nbsp;<spring:message code="index.modulo.reqmod" htmlEscape="true"/>
									</a>
								</form>							
							</td>
						</tr>
					...
					<%-- 	<tr>	
						...
						<sec:authorize ifAnyGranted="ROLE_ABM_REARCHIVOS">	
						<tr>	
							<td class="texto_ti">					
								<form action="redirectProxy.html" method="post" id="reqarchivoProxyForm" name="reqarchivoProxyForm">
									<input type="hidden" name="modulo" value="configuracionGeneral">
									<input type="hidden" name="submodulo" value="consultaLotesRearchivo">
									<a href="#" onclick="javascript:document.getElementById('reqarchivoProxyForm').submit();">
										<img src="<%=request.getContextPath()%>/images/c_gris.png"/>
										&nbsp;<spring:message code="menu.loteRearchivo" htmlEscape="true"/>
									</a>
								</form>						
							</td>
						</tr>
