...
<title><spring:message code="formularioCambioEtiqueta.titulo"
...
<body
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioCambioEtiqueta.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarPosicionLibre.html"
					...
					<fieldset>
						<legend>
							<spring:message
								code="formularioCambioEtiqueta.datosPosicionLibre.elementos"
								htmlEscape="true" />
						</legend>
	...
	<div id="pop">
		<img src="<%=request.getContextPath()%>/images/wait.gif" border="0"
			width="20px" height="20px"> <label>Buscando Lecturas.
			Espere por favor...</label>
	</div>
</body>
</html>