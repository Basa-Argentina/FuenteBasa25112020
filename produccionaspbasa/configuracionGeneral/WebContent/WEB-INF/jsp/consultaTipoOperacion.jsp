...
<title><spring:message code="formularioTipoOperacion.titulo"
...
<script type="text/javascript"
	src="js/mavalos_consulta_tipo_operacion.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioTipoOperacion.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarTipoOperacion.html"
					modelAttribute="tipoOperacionBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioTipoOperacion.filtro.codigo"
											htmlEscape="true" /></td>
									...
									<td class="texto_ti"><spring:message
											code="formularioTipoOperacion.filtro.descripcion"
											htmlEscape="true" /></td>
									...
									<td class="texto_ti"><spring:message
											code="formularioTipoOperacion.filtro.tipoRequerimiento"
											htmlEscape="true" /></td>
				...
				<fieldset>
					<display:table name="tipos" id="tipo"
						requestURI="mostrarTipoOperacion.html" pagesize="20" sort="list"
						keepStatus="true">
						...
						<display:column property="codigo"
							titleKey="formularioTipoOperacion.filtro.codigo" sortable="true"
							class="celdaAlineadoIzquierda upperCase" />
						<display:column property="descripcion"
							titleKey="formularioTipoOperacion.filtro.descripcion"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="tipoRequerimiento.descripcion"
							titleKey="formularioTipoOperacion.filtro.tipoRequerimiento"
