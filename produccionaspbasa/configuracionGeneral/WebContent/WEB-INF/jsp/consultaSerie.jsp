...
<title><spring:message code="formularioSerie.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioSerie.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarSerie.html" commandName="serieBusqueda"
					method="post">
					<fieldset>
						<table width="100%">
							<thead>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioSerie.datosSerie.codigo" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioSerie.nombreSerie" htmlEscape="true" /></td>
				...
				<fieldset>
					<display:table name="series" id="serie"
						requestURI="mostrarSerie.html" pagesize="20" sort="list"
						keepStatus="true">
						...
						<display:column property="tipoSerie"
							titleKey="formularioSerie.datosSerie.tipoSerie" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="codigo"
							titleKey="formularioSerie.datosSerie.codigo" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="descripcion"
							titleKey="formularioSerie.nombreSerie" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="empresa.descripcion"
							titleKey="formularioSerie.datosSerie.empresa" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="sucursal.descripcion"
							titleKey="formularioSerie.datosSerie.sucursal" sortable="true"
							class="celdaAlineadoIzquierda" />
