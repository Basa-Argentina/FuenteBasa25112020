...
<body
	onload="mostrarErrores(${errores}); mostrarAvisos(${hayAvisos || hayAvisosNeg});seleccionarCombos();">
									...
									<td colspan="3">
										<table style="width: 100%;">
													...
													<table>
														<tr>
															...
															<td class="texto_ti"><input type="checkBox"
																id="controlaReferencias" name="controlaReferencias"
																style="width: 10px;" value="1"
											...
											<tr>
													...
													<table>
														<tr>
															<td class="texto_ti"><spring:message
																	...
																	htmlEscape="true" /></td>
															<td class="texto_ti"><input type="checkBox"
																id="reqTipoTrabajo" name="reqTipoTrabajo"
												...
												<td class="texto_ti"><select id="empresaAdministra"
													name="empresaAdministra" size="1" class="requerido"
													<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
								...
								<tr>
									<td colspan="3">
										<fieldset>
											<legend>
												<spring:message
													code="formularioCliente.datosCliente.persona"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
												...
												<tr>
													<td class="texto_ti"><select id="tipoPersona"
														name="tipoPersona" size="1" class="requerido"
														<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
															...
															<option value="Juridica"
																...
																<spring:message
																	code="formularioCliente.datosCliente.tipoPersona.juridica"
																	htmlEscape="true" />
															</option>
															...
															<option value="Fisica"
																...
																<spring:message
																	code="formularioCliente.datosCliente.tipoPersona.fisica"
																	htmlEscape="true" />
															</option>
													</select></td>
													<td class="texto_ti"><input type="text"
														class="requerido" id="razonSocial" maxlength="200"
													...
													<td class="texto_ti"><input type="text" id="nombre"
														class="requerido" name="nombre" style="width: 200px;"
														maxlength="60"
													...
													<td class="texto_ti"><input type="text" id="apellido"
														class="requerido" name="apellido" style="width: 200px;"
														maxlength="60"
												...
												<tr>
													...
													<td class="texto_ti"><select id="idAfipCondIva"
														class="requerido" name="idAfipCondIva" size="1"
														style="width: 190px;"
														<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
													...
													<td class="texto_ti"><input type="text" id="provincia"
														...
														<div style="display: none;">
															<label id="provinciaLabel" for="provincia"> <c:out
																	value="${clienteFormulario.direccion.barrio.localidad.provincia.id}"
																	default="" />
															</label>
														</div></td>
													<td class="texto_ti"><input type="text" id="localidad"
														...
														<div style="display: none;">
															<label id="localidadLabel" for="localidad"> <c:out
																	value="${clienteFormulario.direccion.barrio.localidad.id}"
																	default="" />
															</label>
														</div></td>
													<td class="texto_ti"><input id="idBarrio"
														...
														<div style="display: none;">
															<label id="barrioLabel" for="barrio"> <c:out
																	value="${clienteFormulario.direccion.barrio.id}"
																	default="" />
															</label>
														</div></td>
										...
										<fieldset>
												...
												<thead>
													<tr>
														<th align="left" id="grupoImg"><font
															style="color: #003090"> <spring:message
																	code="formularioCliente.asignacionListas"
																	htmlEscape="true" />
											...
											<div id="grupoDiv" align="center">
												<table>
													<tr>
														<td class="texto_ti"><spring:message
																code="formularioCliente.listasDisponibles"
																htmlEscape="true" /></td>
														<td>&nbsp;</td>
														<td class="texto_ti"><spring:message
																code="formularioCliente.listasAsignadas"
																htmlEscape="true" /></td>
													</tr>
													<tr>
														<td width="40%" align="center"><select
															id="listasSeleccionadasIzq" name="listasSeleccionadasIzq"
															size="8" style="width: 250px" multiple="multiple">
													...
													<tr>
														<td class="texto_ti"><spring:message
																code="formularioCliente.listaDefecto" htmlEscape="true" />
														</td>
														<td>&nbsp;</td>
													</tr>
													<tr>
														<td width="40%" align="center"><select
															id="listasSeleccionadasDef" style="width: 250px"
															name="listaDer">
																<c:forEach items="${listasDer}" var="listaDer">
																	<option value="<c:out value="${listaDer.id}"/>">
																		<c:out value="${listaDer.descripcion}" />
											...
											<table style="width: 100%;">
												<tr>
													<td class="texto_ti" style="width: 30%;"><spring:message
															code="formularioCliente.datosCliente.mesesFacturacion"
															htmlEscape="true" /></td>
													<td class="texto_ti" style="width: 70%;"><spring:message
															code="formularioCliente.datosCliente.notasFacturacion"
															htmlEscape="true" /></td>
												</tr>

												<tr>
													<td style="width: 30%;"><display:table id="mes"
															name="meses">
															<display:column class="celdaAlineadoCentrado">
																<input type="checkbox" name="mesesFacturables"
																	value="${mes.mes}"
															...
															<display:column
																titleKey="formularioCliente.datosCliente.mes"
													...
													<td style="width: 70%;"><textarea
															id="notasFacturacion" name="notasFacturacion" rows="10"
															cols="40"
															<c:if test="${accion == 'CONSULTA'}">
							       								readonly="readonly"
							       							</c:if>><c:out
																value="${clienteFormulario.notasFacturacion}" /></textarea></td>
												</tr>
											</table>
										</fieldset>
									</td>
										...
										<fieldset>
											...
											<table style="width: 100%;">
												...
												<tr>
													...
													<td style="width: 95%;"><textarea id="observaciones"
															name="observaciones" rows="10" cols="40"
															<c:if test="${accion == 'CONSULTA'}">
							       								readonly="readonly"
							       							</c:if>><c:out
