...
<title><spring:message code="formularioListaPrecios.titulo"
...
<script type="text/javascript"
	src="js/mavalos_consulta_lista_precios.js"></script>
<script type="text/javascript" src="js/ini.js" language="JavaScript"></script>
<script type="text/javascript"
	src="js/jquery.displaytag-ajax-1.2-original.js" language="JavaScript"></script>
<script type="text/javascript" src="js/jquery.alerts.js"></script>
</head>
<body
	onload="mostrarErrores(${errores}); mostrarAvisos(${hayAvisos || hayAvisosNeg}); buscarAsociacionesOnBodyLoad('${listaSel.id}');">
	<div class="contextMenu" id="myMenu1">
		<ul>
			<li id="consultar"><img src="images/consultar.png" /><font
		...
		<ul>
			<sec:authorize ifAllGranted="ROLE_AJUSTAR_LISTA_DE_PRECIOS">
				<li id="modificar"><img src="images/modificar.png" /> <font
					size="2"><spring:message code="botones.modificar"
							htmlEscape="true" /></font></li>
				<li id="quitar"><img src="images/eliminar.png" /> <font
					size="2"><spring:message code="botones.eliminar"
							htmlEscape="true" /></font></li>
			</sec:authorize>
		</ul>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioListaPrecios.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarListaPrecios.html"
					commandName="listaPreciosBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="textos.buscar" htmlEscape="true" />&nbsp;<spring:message
												code="formularioListaPrecios.titulo" htmlEscape="true" />
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_td"><spring:message
											code="formularioListaPrecios.filtro.codigo" htmlEscape="true" />
									</td>
									<td class="texto_ti"><input type="text" id="codigo"
										name="codigo" style="width: 150px;"
										value="<c:out value="${listaPreciosBusqueda.codigo}" default="" />" />
									</td>
									<td class="texto_td"><spring:message
											code="formularioListaPrecios.filtro.descripcion"
											htmlEscape="true" /></td>
									<td class="texto_ti"><input type="text" id="descripcion"
										name="descripcion" style="width: 150px;"
						...
						<td style="width: 25%; min-width: 25%; vertical-align: top;">
							<fieldset style="min-height: 200px;">
								<table width="100%">
									<thead>
										<tr>
											<th align="left"><font style="color: #003090"> <spring:message
														code="formularioListaPrecios.tabla.listaPrecios"
														htmlEscape="true" />
											</font></th>
										</tr>
									</thead>
								...
								<div style="text-align: center;">
									<display:table name="listas" id="lista" requestURI=""
										...
										<display:column property="codigo"
											titleKey="formularioListaPrecios.filtro.codigo"
											sortable="true" class="celdaAlineadoIzquierda" />
										<display:column property="descripcion"
											titleKey="formularioListaPrecios.filtro.descripcion"
											sortable="true" class="celdaAlineadoIzquierda" />
							...
							<fieldset style="min-height: 200px;">
								<table width="100%;">
									<thead>
										<tr>
											<th align="left"><font style="color: #003090"> <spring:message
														code="formularioListaPrecios.tablaB.titulo"
														htmlEscape="true" />
											</font></th>
										</tr>
									</thead>
								</table>
								<div class="displayTagDiv"
									style="text-align: center; height: 80%;">
									<display:table name="listaSel.detalle" id="detalle"
										requestURI="mostrarListaPrecios.html" pagesize="10"
										sort="list" keepStatus="true" defaultsort="1">
										<display:column class="hidden" headerClass="hidden">
											<input type="hidden" id="hdn_id" value="${detalle.id}" />
										</display:column>
										<display:column class="hidden" headerClass="hidden">
											<input type="hidden" id="hdn_eliminar"
												value="<spring:message code="formularioAgregarConcepto.manesaje.deasociarConcepto" htmlEscape="true"/>" />
										</display:column>
										<display:column property="conceptoFacturable.codigo"
											titleKey="formularioListaPrecios.tablaB.codigo"
											sortable="true" class="celdaAlineadoIzquierda" />
										<display:column property="conceptoFacturable.descripcion"
											titleKey="formularioListaPrecios.tablaB.descripcion"
											sortable="true" class="celdaAlineadoIzquierda" />
										<display:column titleKey="formularioListaPrecios.tablaB.costo"
											sortable="true" class="celdaAlineadoDerecha">
											<fmt:formatNumber value="${detalle.conceptoFacturable.costo}"></fmt:formatNumber>
										</display:column>
										<display:column
											titleKey="formularioListaPrecios.tablaB.precioBase"
											sortable="true" class="celdaAlineadoDerecha">
											<fmt:formatNumber
												value="${detalle.conceptoFacturable.precioBase}"></fmt:formatNumber>
										</display:column>
										<display:column property="tipoVariacion.descripcion"
											titleKey="formularioListaPrecios.tablaB.variacion"
											sortable="true" class="celdaAlineadoIzquierda" />
										<display:column titleKey="formularioListaPrecios.tablaB.valor"
											sortable="true" class="celdaAlineadoDerecha">
											<fmt:formatNumber value="${detalle.valor}"></fmt:formatNumber>
										</display:column>
										<display:column titleKey="formularioListaPrecios.tablaB.monto"
											sortable="true" class="celdaAlineadoDerecha">
								...
								<div style="width: 100%;" align="right">
									<sec:authorize ifAllGranted="ROLE_AJUSTAR_LISTA_DE_PRECIOS">
										<button name="agregar" type="button"
											onclick="asociar('<spring:message code="notif.listaPrecios.seleccionPreviaAsocioacion" htmlEscape="true"/>');"
											class="botonCentrado">
											<img src="<%=request.getContextPath()%>/images/add.png">
