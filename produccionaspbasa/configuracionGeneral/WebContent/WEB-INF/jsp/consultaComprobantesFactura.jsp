...
<title><spring:message
		code="formularioComprobanteFactura.titulo" htmlEscape="true" /></title>
...
<script type="text/javascript"
	src="js/mavalos_consulta_comprobantes_factura.js"></script>
		...
		<ul>
			...
			<li id="eliminar"><img src="images/eliminar.png" /> <font
				size="2"><spring:message code="botones.eliminar"
						htmlEscape="true" /></font></li>
			<li id="anular" value=""><img src="images/cancelar.png" /><font
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br /> <input type="hidden" id="clienteAspId"
					value="<c:out value="${clienteAspId}" default="" />" /> <input
					type="hidden" id="clienteEmpCodigoCondIva"
					value="<c:out value="TODO" default="" />" /> <input type="hidden"
					id="sucursalId" value="<c:out value="${sucursalId}" default="" />" />
				<input type="hidden" id="codigoEmpresaRequerido"
					value="<spring:message code="formularioComprobanteFactura.error.codigoEmpresa" htmlEscape="true"/>" />
				<input type="hidden" id="tituloError"
					value="<spring:message code="formularioComprobanteFactura.error.titulo" htmlEscape="true"/>" />
				<form:form name="facturaBusqueda"
					action="filtrarListaComprobantesFactura.html"
					commandName="facturaBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioComprobanteFactura.empresa" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioComprobanteFactura.tipo" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									...
									<td class="texto_ti"><select id="idAfipTipoComprobante"
										name="idAfipTipoComprobante" size="1" style="width: 190px;">
											<option value="0"
												...
												<spring:message
													code="formularioComprobanteFactura.seleccionar"
													htmlEscape="true" />
											</option>
									...
									<td class="texto_ti">
										<table align="left">
											<tr>
												<td style="padding-left: 35px;"><input type="checkbox"
													id="mostrarAnulados" name="mostrarAnulados" value="true"
													<c:if test="${facturaBusqueda.mostrarAnulados==true}">checked="checked"</c:if> />
												</td>
											</tr>
										</table>
									</td>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioComprobanteFactura.sucursal"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioComprobanteFactura.serie" htmlEscape="true" />
									</td>
										...
										<table>
											<tr>
												<td><input type="text" id="codigoSucursal"
													...
													&nbsp;&nbsp;</td>
												<td>
													<button type="button" onclick="abrirPopupSucursal();"
														title="<spring:message code="textos.buscar" htmlEscape="true"/>">
														<img src="<%=request.getContextPath()%>/images/buscar.png">
													</button> &nbsp;&nbsp;
												</td>
									...
									<td class="texto_ti">
										<table>
											<tr>
												...
												<td><label id="codigoSerieLabel" for="codigoSucursal">
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioComprobanteFactura.cliente" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioComprobanteFactura.fechaDesde"
											htmlEscape="true" />       <spring:message
											code="formularioComprobanteFactura.fechaHasta"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti">
									...
									<td class="texto_ti"><input type="text" id="fechaDesdeStr"
										...
										<script type="text/javascript">
											...
											</script> <input type="text" id="fechaHastaStr" name="fechaHastaStr"
										maxlength="10" style="width: 65px;"
				...
				<form:form name="facturas"
					action="mostrarListaComprobantesFactura.html"
					commandName="facturas" method="post">
					<fieldset>
						<display:table name="facturas" id="factura"
							requestURI="mostrarListaComprobantesFactura.html" pagesize="20"
							sort="list" keepStatus="false">
							...
							<display:column property="fechaString"
								titleKey="formularioComprobanteFactura.fecha" sortable="true"
								class="celdaAlineadoIzquierda">
							</display:column>
							<display:column property="codigoSeriePrefijoNumero"
								titleKey="formularioComprobanteFactura.comprobante"
							...
							<display:column property="clienteEmp.nombreRazonSocial"
								titleKey="formularioComprobanteFactura.cliente" sortable="true"
								class="celdaAlineadoIzquierda">
							</display:column>
							<display:column property="totalFinal"
								titleKey="formularioComprobanteFactura.importe" sortable="true"
								class="celdaAlineadoIzquierda">
							</display:column>
						</display:table>

						<button name="imprimirFacturas" type="button"
							id="imprimirFacturas">
