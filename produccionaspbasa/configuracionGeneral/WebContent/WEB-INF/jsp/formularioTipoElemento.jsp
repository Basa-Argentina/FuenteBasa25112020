...
<script type="text/javascript"
	src="js/mavalos_formulario_tipo_elemento.js"></script>
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<form:form action="guardarActualizarTipoElemento.html"
					...
					<input id="tipoEtiquetaPreseleccionado" type="hidden"
						value="${tipoEtiquetaPreseleccionado}" />
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioTipoElemento.datosTipoElemento"
												htmlEscape="true" />
								...
								<tr>
									<td colspan="3">
										<fieldset>
											<legend>
												<spring:message
													code="formularioTipoElemento.nombreTipoElemento"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
												...
												<tr>
													...
													<td class="texto_ti"><select id="tipoEtiquetaInt"
														name="tipoEtiquetaInt" class="requerido" size="1"
														<c:if test="${accion == 'CONSULTA'}">disabled="disabled"</c:if>>
															<option value="1"><spring:message
																	code="formularioTipoElemento.datosTipoElemento.tipoEtiqueta.etiquetaChica"
																	htmlEscape="true"></spring:message></option>
															<option value="2"><spring:message
																	code="formularioTipoElemento.datosTipoElemento.tipoEtiqueta.etiquetaMedia"
																	htmlEscape="true"></spring:message></option>
													</select></td>
												...
												<tr>
													<td>
														<fieldset>
															<legend>
																<spring:message
																	code="formularioTipoElemento.datosTipoElemento.caracteristicas"
																	htmlEscape="true" />
															</legend>
															<table>
																<tr>
																		...
																		<table>
																			<tr>
																				<td class="texto_ti"><spring:message
																						...
																						htmlEscape="true" /></td>
																				<td class="texto_ti"><input type="checkBox"
																					id="seleccionaTipoTrabajo"
																					name="seleccionaTipoTrabajo" style="width: 10px;"
																					value="true"
												...
												<tr>
													<td>
														<fieldset>
															<legend>
																<spring:message
																	code="formularioTipoElemento.datosTipoElemento.conceptosAsociados"
																	htmlEscape="true" />
															</legend>
															<table>
																<tr>
																	<td class="texto_ti"><spring:message
																			...
																			htmlEscape="true" /></td>
																	<td class="texto_ti"><input type="checkBox"
																		onclick="checkSelectVenta();" id="generaConceptoVenta"
																		name="generaConceptoVenta" style="width: 10px;"
																		value="true"
																	...
																	<td class="texto_ti"><div id="seccion1"
																			style="display: none">
																			<input type="text" id="conceptoCodigoVenta"
																				name="conceptoCodigoVenta" maxlength="6"
																				style="width: 50px;"
																			...
																			&nbsp;&nbsp; <label id="conceptoCodigoVentaLabel"
																...
																<tr>
																	...
																	<td class="texto_ti"><div id="seccion2"
																			style="display: none">
																			<input type="text" id="conceptoCodigoGuarda"
																				name="conceptoCodigoGuarda" maxlength="6"
																				style="width: 50px;"
																				class="completarZeros inputTextNumericPositiveIntegerOnly"
																			...
																			&nbsp;&nbsp; <label id="conceptoCodigoGuardaLabel"
																...
																<tr>
																	<td class="texto_ti"><spring:message
																			...
																			htmlEscape="true" /></td>
																	<td class="texto_ti"><input type="checkBox"
																		onclick="checkSelectStock();" id="descuentaStock"
																		name="descuentaStock" style="width: 10px;"
																		value="true"
																	...
																	<td class="texto_ti"><div id="seccion3"
																			style="display: none">
																			<input type="text" id="conceptoCodigoStock"
																				name="conceptoCodigoStock" maxlength="6"
																				style="width: 50px;"
																				class="completarZeros inputTextNumericPositiveIntegerOnly"
																			...
																			&nbsp;&nbsp; <label id="conceptoCodigoStockLabel"
