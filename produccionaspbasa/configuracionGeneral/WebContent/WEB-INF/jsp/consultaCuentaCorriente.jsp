...
<title><spring:message code="formularioCuentaCorriente.titulo"
...
<body
	...
	<div class="contextMenu" id="myMenu1">
		<sec:authorize
			ifAnyGranted="ROLE_ABM_CLIENTES,ROLE_ABM_CLASIFICACION_DOCUMENTAL">
			<ul>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioCuentaCorriente.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarCuentaCorriente.html"
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											code="formularioCuentaCorriente.datosCuentaCorriente.fechaDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><input type="text" id="fechaDesdeStr"
										name="fechaDesdeStr" style="width: 80px;"
									...
									<td class="texto_ti"><spring:message
											code="formularioCuentaCorriente.datosCuentaCorriente.fechaHasta"
											htmlEscape="true" /></td>
									<td class="texto_ti"><input type="text" id="fechaHastaStr"
										name="fechaHastaStr" style="width: 80px;"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioCuentaCorriente.datosCuentaCorriente.empresa"
											htmlEscape="true" /></td>
									...
									<td class="texto_ti"><spring:message
											code="formularioCuentaCorriente.datosCuentaCorriente.cliente"
											htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioCuentaCorriente.datosCuentaCorriente.saldoAcreedor"
											htmlEscape="true" /></td>
									<td class="texto_ti"><input type="text" id="saldoAcreedor"
										name="saldoAcreedor" style="width: 200px;" maxlength="6"
										readonly="readonly"
										value="<fmt:formatNumber value="${saldoAcreedor}"></fmt:formatNumber>" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioCuentaCorriente.datosCuentaCorriente.saldoDeudor"
											htmlEscape="true" /></td>
									<td class="texto_ti"><input type="text" id="saldoDeudor"
										name="saldoDeudor" style="width: 200px;" readonly="readonly"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioCuentaCorriente.datosCuentaCorriente.saldoTotal"
											htmlEscape="true" /></td>
									<td class="texto_ti"><input type="text" id="saldoTotal"
										name="saldoTotal" style="width: 200px;" maxlength="6"
										readonly="readonly"
				...
				<fieldset>
					<display:table name="facturaList" id="factura"
						requestURI="mostrarCuentaCorriente.html" pagesize="20" sort="list"
						keepStatus="true">
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_id" value="${factura.id}" />
							<input type="hidden" id="hdn_tipo"
								value="${factura.afipTipoDeComprobante.tipo}" />
						...
						<display:column
							...
							class="celdaAlineadoIzquierda">
							<c:if
								test="${factura.afipTipoDeComprobante.tipo == 'F' || factura.afipTipoDeComprobante.tipo=='ND' }">
						...
						<display:column
							...
							class="celdaAlineadoIzquierda">
							<c:if
								test="${factura.afipTipoDeComprobante.tipo == 'X' || factura.afipTipoDeComprobante.tipo=='NC' }">
								<fmt:formatNumber value="${factura.totalFinal}"></fmt:formatNumber>
							</c:if>
						</display:column>
					...
					<div style="width: 100%" align="right">
						<button name="agregar" type="button" onclick="agregar();">
							...
							<spring:message
								code="formularioCuentaCorriente.boton.registrarCobro"
								htmlEscape="true" />
						</button>
					</div>
				</fieldset>
