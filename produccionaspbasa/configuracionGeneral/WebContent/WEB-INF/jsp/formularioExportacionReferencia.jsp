...
<title><spring:message
		code="formularioExportacionReferencia.titulo" htmlEscape="true" /></title>
...
<script type="text/javascript"
	src="js/formulario_exportacion_referencia.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioExportacionReferencia.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="generarExcelReferencias.html"
					commandName="datosParaExportacion" method="post">
					<input type="hidden" id="elementosSeleccionados"
						name="elementosSeleccionados" />
					...
					<fieldset>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioExportacionReferencia.busqueda.empresa"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioExportacionReferencia.busqueda.sucursal"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioExportacionReferencia.busqueda.cliente"
											htmlEscape="true" /></td>
								</tr>
								<tr>
						...
						<div align="left">
							<br> <input type="radio" id="filtrarPor" name="filtrarPor"
								value="ClasificacionDocumental"
								<c:if test="${datosParaExportacion.filtrarPor != 'Empleado'}">
										checked="checked"
									</c:if>>
							Clasificacion Documental&nbsp;&nbsp; <input type="radio"
								id="filtrarPor" name="filtrarPor" value="Empleado"
								<c:if test="${datosParaExportacion.filtrarPor == 'Empleado'}">
										checked="checked"
									</c:if>>
							...
							&nbsp;&nbsp; <label id="codigoClasificacionDocumentalLabel"
								for="codigoClasificacionDocumental"> </label> <input type="text"
								id="codigoPersonal" name="codigoPersonal" tabindex="3"
								style="width: 80px; display: none;" class="requerido"
								value="<c:out value="${datosParaExportacion.codigoPersonal}" default="" />" />
							<button type="button" id="buscaPersonal" style="display: none;"
								title="<spring:message code="textos.buscar" htmlEscape="true"/>">
								<img src="<%=request.getContextPath()%>/images/buscar.png">
							</button>
						...
						<div align="left">
							<input type="checkbox" id="enviarMail" name="enviarMail"
								style="display: none;" value="true"
								<c:if test="${datosParaExportacion.enviarMail}">
										checked="checked"
									</c:if> />
							<label id="envioMailLabel" style="display: none;"> <spring:message
									code="formularioExportacionReferencia.envioMail"
									htmlEscape="true" />
							</label>&nbsp;&nbsp; <input type="checkbox" id="enviarConCopia"
								name="enviarConCopia" style="display: none;" value="true"
								<c:if test="${datosParaExportacion.enviarConCopia}">
										checked="checked"
									</c:if> />
							<label id="envioConCopiaLabel" style="display: none;"> <spring:message
									code="formularioExportacionReferencia.envioConCopia"
									htmlEscape="true" />
							</label>
						</div>
						<br style="font-size: xx-small;" />
						<div align="left">
							<table>
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioExportacionReferencia.tiposElementosDisponible"
											htmlEscape="true" /></td>
									<td>&nbsp;</td>
									<td class="texto_ti"><spring:message
											code="formularioExportacionReferencia.tiposElementosSeleccionado"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td width="40%" align="center"><select
										id="elementosSeleccionadosIzq"
										name="elementosSeleccionadosIzq" size="8" style="width: 250px"
										multiple="multiple">
											<c:forEach items="${elementosDisponibles}" var="elementoIzq">
												<option value="<c:out value="${elementoIzq.id}"/>">
													<c:out
														value="${elementoIzq.codigo} ${elementoIzq.descripcion}" />
												</option>
											</c:forEach>
									</select></td>
									<td width="20%" align="center"><img
										src="<%=request.getContextPath()%>/images/insertar.png"
										onclick="leftToRight('elementosSeleccionados')"
										title=<spring:message code="botones.insertar" htmlEscape="true"/>>
										<br /> <img
										src="<%=request.getContextPath()%>/images/quitar.png"
										onclick="rightToLeft('elementosSeleccionados')"
										title=<spring:message code="botones.quitar" htmlEscape="true"/>>
										<br /></td>
									<td width="40%" align="center"><select
										id="elementosSeleccionadosDer"
										name="elementosSeleccionadosDer" size="8" style="width: 250px"
										multiple="multiple">
											<c:forEach items="${elementsSeleccionados}" var="elementoDer">
												<option value="<c:out value="${elementoDer.id}"/>">
													<c:out
														value="${elementoDer.codigo} ${elementoDer.descripcion}" />
												</option>
											</c:forEach>
									</select></td>
								</tr>
						...
						<br style="font-size: xx-small;" />
						<div align="center">
							<button id="btnExportar" name="exportar" type="submit"
								class="botonCentrado">
				...
				<br style="font-size: xx-small;" />
				<div align="center">
					<button name="volver_atras" id="volver_atras" type="button"
						class="botonCentrado">
