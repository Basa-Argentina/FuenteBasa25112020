...
<title><spring:message code="formularioEmpresa.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioEmpresa.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarEmpresa.html"
					commandName="empresaBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											...
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioEmpresa.nombreEmpresa" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									...
									<td class="texto_ti"><input type="text"
										id="razonSocial.razonSocial" name="razonSocial.razonSocial"
										style="width: 200px;"
				...
				<fieldset>
					<display:table name="empresas" id="empresa"
						requestURI="mostrarEmpresa.html" pagesize="20" sort="list"
						keepStatus="true">
						...
						<display:column property="codigo"
							titleKey="formularioEmpresa.datosEmpresa.codigo" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="descripcion"
							titleKey="formularioEmpresa.nombreEmpresa" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="razonSocial.razonSocial"
							titleKey="formularioEmpresa.datosEmpresa.razonSocial.razonSocial"
