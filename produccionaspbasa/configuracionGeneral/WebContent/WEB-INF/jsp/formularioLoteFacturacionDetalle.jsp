...
<script type="text/javascript"
	src="js/mavalos_formulario_loteFacturacionDetalle.js"></script>
...
<body
	...
	style="background-color: #1584D6; width: 700px; padding: 10px 0px 0px 0px;">
	<div id="divContenedorFB" align="center"
		style="width: 700px; min-height: 432px; margin: 0px; padding: 0px; background-color: #FFF;"
		align="left">
		...
		<fieldset style="border: none; text-align: left; width: 97%;">
			...
			<form:form name="formFacturaDetalle"
				...
				<input type="hidden" id="accion" name="accion"
					value="<c:out value="${loteFacturacionFormulario.accion}" default="" />" />
				...
				<input type="hidden" id="codigoSucursal2" name="codigoSucursal"
					value="<c:out value="${loteFacturacionFormulario.codigoSucursal}" default="" />" />
				<input type="hidden" id="estado" name="estado"
					value="<c:out value="${loteFacturacionFormulario.estado}" default="" />" />
				...
				<input type="hidden" id="fechaRegistro" name="fechaRegistro"
					value="<c:out value="${loteFacturacionFormulario.fechaRegistro}" default="" />" />
				<input type="hidden" id="fechaFacturacion" name="fechaFacturacion"
					value="<c:out value="${loteFacturacionFormulario.fechaFacturacion}" default="" />" />

				<br style="font-size: xx-small;" />
				<fieldset>
					<display:table name="detalles" id="conceptoOperCliente"
						requestURI="mostrarLoteFacturacionDetalle.html" pagesize="20"
						sort="list" keepStatus="true">
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_id"
								value="${conceptoOperCliente.idConcepto}" />
						</display:column>
						<display:column class="hidden" headerClass="hidden">
						...
						<display:column property="razonCliente"
						...
						<display:column property="estado"
							...
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="requerimiento"
