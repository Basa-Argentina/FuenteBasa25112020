...
<script type="text/javascript"
	src="js/mavalos_formulario_elemento_seleccionados.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioElemento.titulo.elementoSeleccionados"
							htmlEscape="true" />
					</font>
				</legend>
				<br /> <br style="font-size: xx-small;" />
				<form:form action="guardarActualizarElementoSeleccionados.html"
					...
					<fieldset>
						<display:table name="sessionScope.elementos" id="elemento">
							...
							<display:column
								sortName="elemento.posicion.posVerticalHorizontal"
					...
					<input type="hidden" id="codigoTipoElemento"
						name="codigoTipoElemento" value="001" />
					...
					<fieldset>
						...
						<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"
							...
							<table class="busqueda"
									...
									<td class="texto_ti"><select id="estado" name="estado"
										size="1">
											...
											<option label="Creado" value="Creado"
												<c:if test="${elementoModificar.estado == 'Creado'}">
															selected="selected"
														</c:if>>Creado</option>
											<option label="En el Cliente" value="En el Cliente"
												<c:if test="${elementoModificar.estado == 'En el Cliente'}">
															selected="selected"
														</c:if>>En
												el Cliente</option>
											<option label="En Guarda" value="En Guarda"
												<c:if test="${elementoModificar.estado == 'En Guarda'}">
															selected="selected"
														</c:if>>En
												Guarda</option>
											<option label="En Transito" value="En Transito"
												<c:if test="${elementoModificar.estado == 'En Transito'}">
															selected="selected"
														</c:if>>En
												Transito</option>
											<option label="En Consulta" value="En Consulta"
												<c:if test="${elementoModificar.estado == 'En Consulta'}">
															selected="selected"
														</c:if>>En
												Consulta</option>
											<option label="No Existe" value="No Existe"
												<c:if test="${elementoModificar.estado == 'No Existe'}">
															selected="selected"
														</c:if>>No
												Existe</option>
											<option label="Unificado" value="Unificado"
												<c:if test="${elementoModificar.estado == 'Unificado'}">
															selected="selected"
											...
											<table>
												<tr>
													<td class="texto_ti"><input type="checkBox"
														...
														style="width: 10px;" value="true" /></td>
													<td class="texto_ti"><spring:message
								...
								<tr>
									<td class="texto_ti"><select id="tipoTrabajo"
										name="tipoTrabajo" size="1"
										<c:if test="${accion == 'CONSULTA'}">
															disabled="disabled"
														</c:if>>
											<option label="Seleccione un Tipo de Trabajo" value="">Seleccione
												un Tipo de Trabajo</option>
								...
								<tr>
									...
									<td colspan="3"><br></br>
										<div align="center">
											...
											<input type="hidden" id="hdn_guardar" name="hdn_guardar"
												value="false" />

											<button id="guardarYcontinuar" type="button">
												<img src="<%=request.getContextPath()%>/images/guardar.png">
												<spring:message code="botones.guardarContinuar"
													htmlEscape="true" />
											</button>

											&nbsp;
											<button id="guardar" type="button" title=""
												class="botonCentrado">
												<img src="<%=request.getContextPath()%>/images/guardar.png">
											...
											&nbsp;
											<button id="cancelar" type="button" value="off"
												class="botonCentrado">
