		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<form:form action="guardarActualizarGrupo.html"
					...
					<input type="hidden" id="confirmarEliminarEstante"
						value="<spring:message code="formularioGrupo.confirmarEliminarEstante"
								htmlEscape="true" />" />
									...
									<td colspan="3">
										<fieldset>
											...
											<table>
												...
												<tr>
													<td class="texto_ti"><input type="text"
														id="codigoSeccion" name="codigoSeccion" maxlength="6"
														style="width: 50px;"
													...
													<td class="texto_ti"><input type="text" id="codigo"
														class="requerido" onblur="formato(2)" maxlength="2"
												...
												<tr>
													<td class="texto_ti"><input type="text"
														id="verticales" class="requerido" maxlength="3"
														name="verticales" style="width: 200px;"
													...
													<td class="texto_ti"><input type="text"
														class="requerido" id="horizontales" name="horizontales"
														style="width: 200px;" maxlength="3"
													...
													<td class="texto_ti"><input type="text"
														id="modulosVert" class="requerido" maxlength="2"
														name="modulosVert" style="width: 200px;"
													...
													<td class="texto_ti"><input type="text"
														class="requerido" id="modulosHor" name="modulosHor"
				...
				<fieldset>
					...
					<display:table name="estantes" id="estante" requestURI=""
						pagesize="15" sort="list" keepStatus="true">
						...
						<display:column maxLength="4" property="codigo"
							titleKey="formularioGrupo.datosGrupo.estante.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="observacion"
							titleKey="formularioGrupo.datosGrupo.estante.observaciones"
							sortable="true" class="celdaAlineadoIzquierda" />
					...
					<div style="width: 100%" align="right">
						<button name="agregar" type="button" onclick="agregarEstante();"
							class="botonCentrado"
							<c:if test="${accion != 'MODIFICACION'}">
								disabled="disabled"
							</c:if>>
