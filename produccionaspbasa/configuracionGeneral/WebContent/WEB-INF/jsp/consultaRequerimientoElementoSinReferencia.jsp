...
<title><spring:message
		code="formularioElemento.tituloSinReferencia" htmlEscape="true" /></title>
...
<script type="text/javascript"
	src="js/mavalos_consulta_elementoSinReferencia.js"></script>
</head>
<body
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioElemento.tituloSinReferencia" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarRequerimientoElementoSinReferencia.html"
									...
									<td class="texto_ti"><select id="estado" name="estado"
										size="1">
											<option label="En el Cliente" value="En el Cliente"
												<c:if test="${elementoBusqueda.estado == 'En el Cliente'}">
															selected="selected"
														</c:if>>En
												el Cliente</option>
								...
								<tr>
									...
									<td class="texto_ti"><c:if
											...
											test="${elementoBusqueda==null 
												|| elementoBusqueda.tipoRequerimiento==null 
												|| !elementoBusqueda.tipoRequerimiento.retiro}">
											<spring:message code="formularioElemento.vacio"
												htmlEscape="true" />
										</c:if></td>
									...
									<td class="texto_ti"><c:if
											...
											<input type="text" id="codigoClasificacionDocumental"
												...
												for="codigoClasificacionDocumental"><c:out
													value="${elementoBusqueda.clasificacionDocumental.nombre}"
													default="" /> </label>
										</c:if> <c:if
											test="${elementoBusqueda==null 
												|| elementoBusqueda.tipoRequerimiento==null 
				...
				<form:form action="${destinoURLRequerimientoElemento}"
					name="formPreparar"
					commandName="prepararActualizarRequerimientoElementoBusqueda"
					method="post">
					<fieldset>
						<input type="hidden" id="requerimientoElementosSel"
							name="requerimientoElementosSel" value="" /> <input type="hidden"
							id="sinReferencias" name="sinReferencias" value="true" />
						<display:table name="elementos" id="elemento"
							pagesize="${pagesize}" sort="external"
							requestURI="mostrarRequerimientoElementoSinReferencia.html"
							...
							<display:column sortable="false" class="celdaAlineadoCentrado"
								media="html">
								<img id="information"
				...
				<br style="font-size: xx-small;" />
				<div align="center">
					<button name="guardar" type="button"
						onclick="seleccionar('<spring:message	code="formularioRequerimientoElemento.errorSeleccionElemento" htmlEscape="true" />');"
						class="botonCentrado">
