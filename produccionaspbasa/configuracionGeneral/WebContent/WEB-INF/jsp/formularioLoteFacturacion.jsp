...
<script type="text/javascript"
	src="js/mavalos_formulario_loteFacturacion.js"></script>
...
<body
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<form:form name="formLoteFacturacion"
					...
					<input type="hidden" id="codigoSucursal" name="codigoSucursal"
						maxlength="6" style="width: 50px;"
						value="<c:out value="${loteFacturacionFormulario.codigoSucursal}" default="" />" />
					<input type="hidden" id="periodo" name="periodo" maxlength="6"
						style="width: 50px;"
						value="<c:out value="${loteFacturacionFormulario.periodo}" default="" />" />
					<input type="hidden" id="activado" name="activado" maxlength="6"
						style="width: 50px;"
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioLoteFacturacion.datosLoteFacturacion"
												htmlEscape="true" />
								...
								<tr>
									<td colspan="3">
										<fieldset>
											<legend>
												<spring:message
													code="formularioLoteFacturacion.nombreLoteFacturacion"
													htmlEscape="true" />
											</legend>
											<table class="busqueda"
												...
												<c:if test="${accion != 'NUEVO'}">
													<tr>
														<td class="texto_td"><spring:message
																code="formularioLoteFacturacion.datosLoteFacturacion.numero"
																htmlEscape="true" /></td>

														<td class="texto_ti"><input type="text"
															id="numeroLote" name="numeroLote" maxlength="8" size="8"
															class="completarZeros"
												...
												<tr>
													<td class="texto_td"><spring:message
															code="formularioLoteFacturacion.datosLoteFacturacion.fechaRegistro"
															htmlEscape="true" /></td>
													<td class="texto_ti">
														<table>
															<tr>
																<td><input type="text" id="fechaRegistro"
																	name="fechaRegistro" class="requerido" maxlength="10"
												...
												<tr>
													<td class="texto_td"><spring:message
															code="formularioLoteFacturacion.datosLoteFacturacion.periodo"
															htmlEscape="true" /></td>
													<td>
														<table>
															<tr>
																<td class="texto_ti"><select id="añoPeriodo"
																	name="añoPeriodo" size="1" class="requerido"
																	<c:if test="${accion != 'NUEVO'}">
																	disabled="disabled"
																</c:if>>
																		<option label="Año" value="0">Año</option>
																		<c:forEach items="${años}" var="año">
																			<option label="${año}" value="${año}"
																				<c:if test="${loteFacturacionFormulario.añoPeriodo == año}">
																	selected="selected"
																</c:if>><c:out
																					value="${año}"></c:out></option>
																		</c:forEach>
																</select></td>
																<td class="texto_ti"><select id="selectPeriodo"
																	class="requerido"
																	<c:if test="${accion != 'NUEVO'}">
																		disabled="disabled"
																	</c:if>
																	name="selectPeriodo" size="1">
																		...
																		<option label="Enero" value="1"
																			<c:if test="${loteFacturacionFormulario.periodo == '1'}">
																		selected="selected"
																	</c:if>>Enero</option>
																		<option label="Febrero" value="2"
																			<c:if test="${loteFacturacionFormulario.periodo == '2'}">
																		selected="selected"
																	</c:if>>Febrero</option>
																		<option label="Marzo" value="3"
																			<c:if test="${loteFacturacionFormulario.periodo == '3'}">
																		selected="selected"
																	</c:if>>Marzo</option>
																		<option label="Abril" value="4"
																			<c:if test="${loteFacturacionFormulario.periodo == '4'}">
																		selected="selected"
																	</c:if>>Abril</option>
																		<option label="Mayo" value="5"
																			<c:if test="${loteFacturacionFormulario.periodo == '5'}">
																		selected="selected"
																	</c:if>>Mayo</option>
																		<option label="Junio" value="6"
																			<c:if test="${loteFacturacionFormulario.periodo == '6'}">
																		selected="selected"
																	</c:if>>Junio</option>
																		<option label="Julio" value="7"
																			<c:if test="${loteFacturacionFormulario.periodo == '7'}">
																		selected="selected"
																	</c:if>>Julio</option>
																		<option label="Agosto" value="8"
																			<c:if test="${loteFacturacionFormulario.periodo == '8'}">
																		selected="selected"
																	</c:if>>Agosto</option>
																		<option label="Setiembre" value="9"
																			<c:if test="${loteFacturacionFormulario.periodo == '9'}">
																		selected="selected"
																	</c:if>>Setiembre</option>
																		<option label="Octubre" value="10"
																			<c:if test="${loteFacturacionFormulario.periodo == '10'}">
																		selected="selected"
																	</c:if>>Octubre</option>
																		<option label="Noviembre" value="11"
																			<c:if test="${loteFacturacionFormulario.periodo == '11'}">
																		selected="selected"
																	</c:if>>Noviembre</option>
																		<option label="Diciembre" value="12"
																			<c:if test="${loteFacturacionFormulario.periodo == '12'}">
																		selected="selected"
												...
												<tr>
													<td class="texto_td"><spring:message
															code="formularioLoteFacturacion.datosLoteFacturacion.fechaFacturacion"
															htmlEscape="true" /></td>
													<td class="texto_ti">
														<table>
															<tr>
																<td><input type="text" id="fechaFacturacion"
																	name="fechaFacturacion" class="requerido"
																	maxlength="10"
												...
												<tr>
													<td class="texto_td"><spring:message
															code="formularioLoteFacturacion.descripcion"
															htmlEscape="true" /></td>
													<td class="texto_ti">
														<table>
															<tr>
																<td><input type="text" id="descripcion"
																	name="descripcion"
																	value="<c:out value="${loteFacturacionFormulario.descripcion}" default="" />"
																	<c:if test="${accion == 'CONSULTA'}">
													readonly="readonly"
												</c:if> />
																</td>
												...
												<c:if test="${accion != 'NUEVO'}">
													<tr>
														<td class="texto_td"><spring:message
																code="formularioLoteFacturacion.datosLoteFacturacion.estado"
																htmlEscape="true" /></td>
														<td class="texto_ti"><select id="estado"
															<c:if test="${accion == 'CONSULTA' || loteFacturacionFormulario.estado == 'Facturado'}">
																disabled="disabled"
															</c:if>
															name="estado" size="1">
																<option label="Pendiente" value="Pendiente"
																	<c:if test="${loteFacturacionFormulario.estado == 'Pendiente'}">
																selected="selected"
															</c:if>>Pendiente</option>
																<c:if
																	test="${loteFacturacionFormulario.estado == 'Facturado'}">
																	<option label="Facturado" value="Facturado"
																		<c:if test="${loteFacturacionFormulario.estado == 'Facturado'}">
																selected="selected"
															</c:if>>Facturado</option>
																</c:if>
																<option label="Anulado" value="Anulado"
																	<c:if test="${loteFacturacionFormulario.estado == 'Anulado'}">
																selected="selected"
															</c:if>>Anulado</option>
														</select></td>
													</tr>
												...
												<c:if test="${accion == 'CONSULTA'}">
													<tr>
														<td class="texto_td"><spring:message
																code="formularioLoteFacturacion.datosLoteFacturacion.usuarioRegistro"
																htmlEscape="true" /></td>
														<td class="texto_ti"><input type="text"
															readonly="readonly" id="usuarioRegistro"
															name="usuarioRegistro"
															value="<c:out value="${loteFacturacionFormulario.usuarioRegistro.persona}" default=""/>" />
														</td>
													</tr>
													<tr>
														<td class="texto_td"><spring:message
																code="formularioLoteFacturacion.datosLoteFacturacion.fechaModificacion"
																htmlEscape="true" /></td>
														<td class="texto_ti"><input type="text"
															readonly="readonly" id="fechaModificacion"
															name="fechaModificacion"
															value="<c:out value="${loteFacturacionFormulario.fechaModificacionStr}" default=""/>" />
														</td>
													</tr>
													<tr>
														<td class="texto_td"><spring:message
																code="formularioLoteFacturacion.datosLoteFacturacion.usuarioModificacion"
																htmlEscape="true" /></td>
														<td class="texto_ti"><input type="text"
															readonly="readonly" id="usuarioModificacion"
															name="usuarioModificacion"
															value="<c:out value="${loteFacturacionFormulario.usuarioModificacion.persona}" default=""/>" />
														</td>
													</tr>
												</c:if>
											</table>
					...
					<fieldset>
						<legend>
							<spring:message
								code="formularioLoteFacturacion.datosLoteFacturacion.detalles"
								htmlEscape="true" />
						</legend>
						<display:table name="listaPreFacturas" id="preFactura"
							requestURI="mostrarLoteFacturacion.html" pagesize="20"
							...
							<display:column class="hidden" headerClass="hidden">
								...
								<display:column class="hidden" headerClass="hidden">
									<input type="hidden" id="hdn_anular"
							...
							<display:column property="estado"
								titleKey="formularioComprobanteFactura.estado" sortable="false"
								class="estado celdaAlineadoIzquierda">
							</display:column>
							<display:column property="empresa.descripcion"
								titleKey="formularioComprobanteFactura.empresa" sortable="true"
								class="celdaAlineadoIzquierda">
							</display:column>
							<display:column property="sucursal.descripcion"
								titleKey="formularioComprobanteFactura.sucursal" sortable="true"
								class="celdaAlineadoIzquierda">
							</display:column>
							<display:column property="clienteEmp.razonSocialONombreYApellido"
								titleKey="formularioComprobanteFactura.cliente" sortable="true"
								class="celdaAlineadoIzquierda">
							</display:column>
							<display:column titleKey="formularioComprobanteFactura.importe"
							...
							<table>
								<tr>
									...
									<td width="10%"><spring:message
											code="formularioConceptoOperacionCliente.vacio"
											htmlEscape="true" /></td>
									<td class="texto_td"><div align="right">
											<button id="botonGenerarConceptos"
												name="botonGenerarConceptos" type="button">
												<img src="<%=request.getContextPath()%>/images/eliminar.png">
												<spring:message
													code="formularioLoteFacturacion.boton.generarConceptoMensual"
													htmlEscape="true" />
											</button>
										</div></td>
								</tr>
	...
	<!-- ----------	fancybox ------------------------- -->
	<a id="fancyboxAgregarDetalle" style="visibility: hidden;"
		href="iniciarPopUpLoteFacturacionDetalle.html"></a>
	<div id="pop">
		<img src="<%=request.getContextPath()%>/images/wait.gif" border="0"
			width="20px" height="20px"> <label>Generando conceptos
			mensuales. Espere por favor...</label>
	</div>
</body>
</html>