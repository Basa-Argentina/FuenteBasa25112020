			...
			<c:if test="${accionPreFactura != 'CONSULTA'}">
				...
				<li id="eliminar"><img src="images/eliminar.png" /> <font
					size="2"><spring:message code="botones.anular"
							htmlEscape="true" /></font></li>
				<li id="habilitar"><img src="images/add.png" /> <font size="2"><spring:message
							code="botones.habilitar" htmlEscape="true" /></font></li>
			</c:if>
		</ul>
	</div>
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br /> <input type="hidden" id="error" name="error"
					value="<spring:message code="formularioPreFactura.error" htmlEscape="true" />" />
				<input type="hidden" id="errorSeleccioneEmpresa"
					name="errorSeleccioneEmpresa"
					value="<spring:message code="formularioPreFactura.error.seleccioneEmpresa" htmlEscape="true" />" />
				<input type="hidden" id="errorSeleccioneSucursal"
					name="errorSeleccioneSucursal"
					value="<spring:message code="formularioPreFactura.error.seleccioneSucursal" htmlEscape="true" />" />
				<input type="hidden" id="errorSeleccioneCliente"
					name="errorSeleccioneCliente"
					value="<spring:message code="formularioPreFactura.error.seleccioneClienteEmp" htmlEscape="true" />" />
				<input type="hidden" id="errorSeleccioneTipoComprobante"
					name="errorSeleccioneTipoComprobante"
					value="<spring:message code="formularioPreFactura.error.seleccioneAfipTipoComprobante" htmlEscape="true" />" />
				<input type="hidden" id="errorSeleccioneFecha"
					name="errorSeleccioneFecha"
					value="<spring:message code="formularioPreFactura.error.seleccioneFecha" htmlEscape="true" />" />
				<input type="hidden" id="headerPreFacturaNoModificable"
					name="headerPreFacturaNoModificable"
					value="${headerPreFacturaNoModificable}" />

				<form:form id="formPreFactura" name="formPreFactura"
					action="guardarActualizarPreFactura.html"
					commandName="preFacturaAGuardar" method="post"
					modelAttribute="preFacturaAGuardar">
					<input type="hidden" id="accionLote" name="accionLote"
						value="<c:out value="${accionLote}" default="" />" />
					<input type="hidden" id="accionPreFactura" name="accionPreFactura"
						value="<c:out value="${accionPreFactura}" default="" />" />
					<input type="hidden" id="idAfipTipoComprobanteSelected"
						name="idAfipTipoComprobanteSelected"
						value="<c:out value="${preFacturaFormulario.idAfipTipoComprobante}" default="0" />" />
					<input type="hidden" id="ordenPreFactura" name="ordenPreFactura"
						value="<c:out value="${ordenPreFactura}" default="" />" />
					<input type="hidden" id="clienteAspId" name="clienteAspId"
						value="<c:out value="${clienteAspId}" default="" />" />
					<input type="hidden" id="codigoEmpresaDefault"
						name="codigoEmpresaDefault"
						value="<c:out value="${preFacturaFormulario.codigoEmpresa}" default="" />" />
					<input type="hidden" id="codigoSucursalDefault"
						name="codigoSucursalDefault"
						value="<c:out value="${preFacturaFormulario.codigoSucursal}" default="" />" />
					<input type="hidden" id="clienteEmpCodigoCondIva"
						name="clienteEmpCodigoCondIva"
						value="<c:out value="${preFacturaFormulario.clienteEmpCodigoCondIva}" default="" />" />
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioPreFactura.datosPreFactura"
												htmlEscape="true" />
							...
							<table style="width: 100%;">
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioPreFactura.empresa" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPreFactura.tipo" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPreFactura.notasFacturacion"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti">
										<table>
											<tr>
												<td><input type="text" id="codigoEmpresa"
													class="inputTextNumericPositiveIntegerOnly requerido"
												...
												<td><label id="codigoEmpresaLabel" for="codigoEmpresa">
														<c:if test="${preFacturaFormulario.empresa != null}">
															<c:out
																value="${preFacturaFormulario.empresa.nombreRazonSocial}"
																escapeXml="true" />
														</c:if>
												</label></td>
											</tr>
									...
									<td class="texto_ti"><select id="idAfipTipoComprobante"
										name="idAfipTipoComprobante" class="requerido" size="1"
										style="width: 190px;">
											<c:out value="${comboTipoComprobante}" escapeXml="false"></c:out>
									</select></td>
									<td class="texto_ti" rowspan="3"><textarea
											id="notasFacturacion" name="notasFacturacion" rows="5"
											cols="30"
											<c:if test="${headerPreFacturaNoModificable}">readonly="readonly"</c:if>>
											<c:out value="${preFacturaFormulario.notasFacturacion}"
												default="" />
										</textarea></td>
								</tr>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioPreFactura.sucursal" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPreFactura.serie" htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti">
										<table>
											<tr>
												<td><input type="text" id="codigoSucursal"
													class="requerido inputTextNumericPositiveIntegerOnly"
												...
												<td><label id="codigoSucursalLabel"
													for="codigoSucursal"> <c:if
															test="${preFacturaFormulario.sucursal != null}">
															<c:out
																value="${preFacturaFormulario.sucursal.descripcion}"
																escapeXml="true" />
														</c:if>
												</label></td>
											</tr>
									...
									<td class="texto_ti">
										<table>
											<tr>
												<td><input type="text" id="codigoSerie"
													class="requerido" name="codigoSerie" maxlength="4"
													style="width: 50px;"
													...
													&nbsp;&nbsp;</td>
												<td>
													<button type="button" onclick="abrirPopupSeries();"
														title="<spring:message code="textos.buscar" htmlEscape="true"/>"
														<c:if test="${headerPreFacturaNoModificable}" >
													disabled="disabled"
											</c:if>>
												...
												<td><label id="codigoSerieLabel" for="codigoSerie">
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioPreFactura.cliente" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPreFactura.fecha" htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti">
										<table>
											<tr>
												<td><input type="text" id="codigoCliente"
													class="inputTextNumericPositiveIntegerOnly requerido"
													...
													&nbsp;&nbsp;</td>
												<td>
													<button type="button" onclick="abrirPopupClienteEmp();"
														title="<spring:message code="textos.buscar" htmlEscape="true"/>"
														<c:if test="${headerPreFacturaNoModificable}" >
												disabled="disabled"
											</c:if>>
												...
												<td><label id="codigoClienteLabel" for="codigoCliente">

												</label></td>
											</tr>
										</table>
									</td>
									<td class="texto_ti"><input type="text" id="fechaStr"
										class="requerido" name="fechaStr" maxlength="10"
										style="width: 65px;"
				...
				<fieldset>
					...
					<display:table name="preFacturaDetalles" id="detalle"
						requestURI="precargaFormularioPreFactura.html" pagesize="10"
						...
						<display:column property="cantidad"
							...
							class="celdaAlineadoIzquierda" />
						<display:column titleKey="formularioPreFactura.tabla.netoTotal"
							sortable="true" class="celdaAlineadoIzquierda">
								$ <fmt:formatNumber value="${detalle.netoTotal}"></fmt:formatNumber>
						</display:column>
						<display:column titleKey="formularioPreFactura.tabla.impuestos"
							sortable="true" class="celdaAlineadoIzquierda">
								$ <fmt:formatNumber value="${detalle.impuestoTotal}"></fmt:formatNumber>
						</display:column>
						<display:column titleKey="formularioPreFactura.tabla.finalTotal"
							sortable="true" class="celdaAlineadoIzquierda">
