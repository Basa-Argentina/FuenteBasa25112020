...
<title>Rearchivar - Ubicacion Provisoria</title>
...
<script type="text/javascript"
	src="js/formulario_ubicacion_provisoria.js"></script>
<style type="text/css">
.cascade-loading {
					...
					<fieldset>
						...
						<div style="background-color: #f1e87d; WIDTH: auto;"
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti">Lectura</td>
									<td class="texto_ti">Ubicación Provisoria</td>
								...
								<tr>
									...
									<td class="texto_ti"><input type="text"
										id="ubicacionProvisoria" name="ubicacionProvisoria"
									...
									<td class="texto_ti">
										<button name="guardar" type="button" class="botonCentrado"
											id="btnGuardar" onclick="document.forms[0].submit()">
