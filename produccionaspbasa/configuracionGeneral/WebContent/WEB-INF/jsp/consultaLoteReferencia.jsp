		...
		<ul>
			...
			<li id="modificar"><img src="images/modificar.png" /> <font
				size="2"><spring:message code="botones.modificar"
						htmlEscape="true" /></font></li>
			<li id="agregarRango"><img src="images/modificar.png" /> <font
				size="2"><spring:message
						code="formularioLoteReferencia.boton.agregarRango"
						htmlEscape="true" /></font></li>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioLoteReferencia.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="consultaLotesReferencia.html"
					commandName="busquedaLoteReferenciaFormulario" method="post">
					...
					<fieldset>
						...
						<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											code="formularioLoteReferencia.busqueda.usuario.carga"
											htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti"><input type="text" id="codigoEmpresa"
										...
										value="<c:out value="${busquedaLoteReferenciaFormulario.codigoEmpresa}" default="" />"
										<c:if test='${empleadoSession!=null }'> readonly="readonly"</c:if> />
										&nbsp;&nbsp;
						...
						se saca Adrian						value="<c:out value="${busquedaLoteReferenciaFormulario.codigoSucursal}" default="" />"/>
									...
									<td class="texto_ti" style="width: 250px;"><input
										...
										&nbsp;&nbsp;
										<button type="button" name="buscaPersonal" id="buscaPersonal"
											title="<spring:message code="textos.buscar" htmlEscape="true"/>"
											<sec:authorize ifNotGranted="ROLE_CON_LOTEREF_CAMBIAR_USUARIO"> 
															disabled="disabled"
														</sec:authorize>>
										...
										for="codigoPersonal"> <c:out
												value="${busquedaLoteReferenciaFormulario.personal.nombreYApellido}"
												default="" />
									</label></td>
								</tr>
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLoteReferencia.busqueda.codigoDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteReferencia.busqueda.codigoHasta"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteReferencia.busqueda.fechaDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteReferencia.busqueda.fechaHasta"
											htmlEscape="true" /></td>
				...
				<fieldset>
					<display:table name="lotesReferencia" id="loteReferencia"
						requestURI="consultaLotesReferencia.html" pagesize="20"
						sort="external" partialList="true" size="${size}">
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_id" value="${loteReferencia.id}" />
						</display:column>
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_porRango"
								value="${loteReferencia.cargaPorRango}" />
						</display:column>
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_eliminar"
								value="<spring:message code="mensaje.eliminar" htmlEscape="true"/>" />
						</display:column>
						<display:column sortName="formularioLoteReferencia.lista.codigo"
							property="codigo"
							titleKey="formularioLoteReferencia.lista.codigo" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="formularioLoteReferencia.lista.fecha"
							property="fechaRegistroStr"
							titleKey="formularioLoteReferencia.lista.fecha" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="usuarioCarga" title="Usr. Carga"
							sortable="false" class="celdaAlineadoIzquierda" />
						<display:column property="cantidadRef" title="Cantidad Ref"
							sortable="false" class="celdaAlineadoIzquierda" />
						<display:column property="empresaStr"
							titleKey="formularioLoteReferencia.lista.empresa"
							sortable="false" class="celdaAlineadoIzquierda" />
						<display:column property="sucursalStr"
							titleKey="formularioLoteReferencia.lista.sucursal"
							sortable="false" class="celdaAlineadoIzquierda" />
						<display:column property="clienteEmpStr"
							titleKey="formularioLoteReferencia.lista.cliente"
							sortable="false" class="celdaAlineadoIzquierda" />
					...
					<div style="width: 100%" align="right">
						<button name="agregar" type="button" id="cargaIndividual"
							class="botonCentrado" style="width: 200px;">
							<img src="<%=request.getContextPath()%>/images/add.png">
							<spring:message code="formularioLoteReferencia.cargaIndividual"
								htmlEscape="true" />
						</button>
						&nbsp;&nbsp;
						<button name="agregar" type="button" id="cargaGrupal"
							class="botonCentrado" style="width: 200px;">
							<img src="<%=request.getContextPath()%>/images/add.png">
							<spring:message code="formularioLoteReferencia.cargaGrupal"
								htmlEscape="true" />
						</button>
						&nbsp;&nbsp;
						<button name="agregar" type="button" id="cargaRango"
							class="botonCentrado" style="width: 200px;">
							<img src="<%=request.getContextPath()%>/images/add.png">
							<spring:message code="formularioLoteReferencia.cargaPorRango"
								htmlEscape="true" />
						</button>
					</div>
				</fieldset>
