...
<title><spring:message code="formularioRequerimiento.titulo"
		...
		<ul>
			...
			<li id="cancelar"><img src="images/cancelar.png" /> <font
				size="2"><spring:message
						code="formularioRequerimiento.display.cancelar" htmlEscape="true" />
			</font></li>
		</ul>
	</div>
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<form:form action="filtrarRequerimiento.html" name="formBusqueda"
					...
					<input type="hidden" name="hdn_imprimir" id="hdn_imprimir"
						value="false" />
					<fieldset>
						<table width="100%">
							<thead>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti" colspan="2"><spring:message
											code="formularioRequerimiento.tipoRequerimiento"
											htmlEscape="true" /></td>
									<td class="texto_ti" colspan="3"><spring:message
											code="formularioRequerimiento.empleadoSolicitante"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioRequerimiento.fechaDesde" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioRequerimiento.fechaHasta" htmlEscape="true" />
									</td>
								...
								<tr>
									<td class="texto_ti" colspan="2"><input type="text"
										...
										value="<c:out value="${requerimientoBusqueda.tipoRequerimientoCod}" default="" />"
										class="upperCase" /> &nbsp;&nbsp;
										<button type="button"
										...
										for="tipoRequerimientoCod" style="width: 150px;"> <c:out
												value="${requerimientoBusqueda.tipoRequerimiento.descripcion}"
												default="" />
									</label></td>
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											code="formularioRequerimiento.fechaEntregaDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioRequerimiento.fechaEntregaHasta"
											htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti" colspan="4"><spring:message
											code="formularioRequerimiento.direccionEntrega"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti" colspan="4"><input type="text"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioRequerimiento.serie" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioRequerimiento.serieDesde" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioRequerimiento.serieHasta" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioRequerimiento.estado" htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti" style="width: 150px;"><input
										...
										<button type="button" id="buscaSerie" name="buscaSerie"
											...
											<c:out value="${requerimientoBusqueda.serie.prefijo}"
												default="" />
									</label></td>
									<td class="texto_ti">- <input type="text"
										id="serieDesdeStr" maxlength="8" name="serieDesdeStr"
										style="width: 70px;" class="integer"
										value="<c:out value="${requerimientoBusqueda.serieDesdeStr}" default="" />" />
									</td>
									<td class="texto_ti"><input type="text" id="serieHastaStr"
										maxlength="8" name="serieHastaStr" style="width: 70px;"
										class="integer"
				...
				<fieldset>
					<display:table name="sessionScope.requerimientos"
						id="requerimiento" pagesize="20" sort="external"
						requestURI="mostrarRequerimiento.html" partialList="true"
						size="${size}">
						...
						<display:column property="tipoRequerimiento.descripcion"
							sortName="tipoRequerimiento.descripcion"
							titleKey="formularioRequerimiento.display.tipoRequerimiento"
						...
						<display:column sortName="requerimiento.prefijoStr"
							...
							<c:out value="${requerimiento.serie.codigo}" default="" />: <c:out
								value="${requerimiento.prefijoStr}" default="" /> - <c:out
								value="${requerimiento.numeroStr}" default="" />
						</display:column>
						...
						<display:column property="fechaHoraAltaStr"
							...
							titleKey="formularioRequerimiento.display.fechaAlta"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="fechaHoraEntregaStr"
							sortName="fechaHoraEntregaStr"
							titleKey="formularioRequerimiento.display.fechaEntrega"
							sortable="true" class="celdaAlineadoIzquierda" />
						...
						<display:column property="usuario.persona"
							titleKey="formularioRequerimiento.display.usuarioRegistrante"
