	...
	<body onload="mostrarErrores(${errores}); mostrarAvisos(${hayAvisos || hayAvisosNeg})">
		...
		<div id="contenedorGeneral">
			...
			<div class="contenido" align="left">
								...
								<table>
									...
									<tr>
										...
										<td class="texto_ti"><input type="text" id="fechaAlta"
											name="fechaAlta" maxlength="10" readonly="readonly" class="requerido" style="width: 80px;"
										...
										<td class="texto_ti" >
											<input type="text" class="requerido" maxlength="5" id="horaAlta" readonly="readonly" name="horaAlta"
										...
										<td class="texto_ti" >
											<input type="text"
												class="requerido" maxlength="5" id="horaEntrega" readonly="readonly" name="horaEntrega"
												style="width: 60px;" onblur="CheckTime(this)"
									...
									<tr>
										<td style="text-align: left;" colspan="8">											
											<table style="width: 100%;">													
													...
													<td colspan="2" style="width: 100%;">
														...
														<legend>
															...
															<table>												
																...
																<tr>
																	<td>
																		<textarea id="observaciones" name="observaciones" rows="12" cols="60" 
																		<c:if test="${accion == 'CONSULTA'}">readonly="readonly"</c:if>>
												...
												<tr >
													<td class="hidden texto_ti" id="trInsertarElemento" colspan="2">
														Elemento:
												...
												`		</button>
													...
													<c:if test="${requerimientoFormulario.clienteEmp.reqTipoTrabajo}">
														...
														<fieldset>
															<display:table id="requerimientoElemento" name="requerimientoFormulario.listaElementos" requestURI="mostrarRequerimientoElemento.html" >
																<display:column class="hidden" headerClass="hidden">
																	<input type="hidden" id="hdn_id" value="${requerimientoElemento.hashCode}" />
																</display:column>
															<display:column
															...
															<display:column titleKey="formularioRequerimiento.datos.display.tipoTrabajo" class="celdaAlineadoIzquierda">						
			    ...
			    <c:if test="${accion != 'CONSULTA'}">
			    	<div align="center">
						<button id ="guardarDes" name="guardar" type="button" onclick="guardarYSalir();" class="botonCentrado">
