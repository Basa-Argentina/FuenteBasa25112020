...
<title><spring:message code="formularioDeposito.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioDeposito.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarDeposito.html"
					commandName="depositoBusqueda" method="post">
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											...
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioDeposito.nombreDeposito" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									...
									<td class="texto_ti"><input type="text"
										...
										for="codigoSucursal"> <c:out
												value="${depositoBusqueda.sucursal.descripcion}" default="" />
									</label></td>
									...
									<td class="texto_ti"><input type="text" id="codigo"
										name="codigo" style="width: 50px;" maxlength="2"
				...
				<fieldset>
					<display:table name="depositos" id="deposito"
						requestURI="mostrarDeposito.html" pagesize="20" sort="list"
						keepStatus="true">
						...
						<display:column property="sucursal.empresa.descripcion"
							titleKey="formularioDeposito.datosDeposito.empresa"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="sucursal.descripcion"
							titleKey="formularioDeposito.datosDeposito.sucursal"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="codigo"
							titleKey="formularioDeposito.datosDeposito.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="descripcion"
							titleKey="formularioDeposito.nombreDeposito" sortable="true"
