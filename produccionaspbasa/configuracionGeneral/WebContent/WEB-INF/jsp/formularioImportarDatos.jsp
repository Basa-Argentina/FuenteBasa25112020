...
<title><spring:message code="formularioImportarDatos.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioImportarDatos.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioImportarDatos.importar" htmlEscape="true" />
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioImportarDatos.conexion" htmlEscape="true" />:
									</td>
									<td class="texto_ti"><input name="stringConexion"
										id="stringConexion" type="text" width="100%" /></td>
								</tr>
								<tr>
									<td class="texto_ti">
										<button name="guardar" type="submit" class="botonCentrado"
											id="btnGuardar" onclick="abrirPopup()">
											<img src="<%=request.getContextPath()%>/images/ok.png">
											<spring:message
												code="formularioImportarDatos.botones.importar"
												htmlEscape="true" />
										</button>
									</td>
				...
				<form:form id="renombrarExtencionDatos"
					action="renombrarExtencionDatos.html"
					...
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioImportarDatos.modificarExtencion"
												htmlEscape="true" />
									</font> <img id="busquedaImgSrcDown" src="images/skip_down.png"
										title="<spring:message code="textos.cerrarPanel" htmlEscape="true"/>">
										<img id="busquedaImgSrc" src="images/skip.png"
						...
						<div style="width: 100%;" id="busquedaDiv" align="center">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioImportarDatos.path" htmlEscape="true" />:</td>
									<td class="texto_ti"><input name="path" id="path"
										type="text" width="100%" /></td>
								</tr>
								<tr>
									<td class="texto_ti">
										<button name="guardar" type="submit" class="botonCentrado"
											...
											<img src="<%=request.getContextPath()%>/images/ok.png">
											<spring:message
												code="formularioImportarDatos.botones.modificar"
												htmlEscape="true" />
										</button>
									</td>
