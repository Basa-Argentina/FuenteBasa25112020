...
<title><c:if test="${accion == 'NUEVO'}">
		<spring:message code="formularioTipoRequerimiento.titulo.registrar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'MODIFICACION'}">
		<spring:message code="formularioTipoRequerimiento.titulo.modificar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'CONSULTA'}">
		<spring:message code="formularioTipoRequerimiento.titulo.consultar"
			htmlEscape="true" />
	</c:if></title>
...
<script type="text/javascript"
	src="js/mavalos_formulario_tipo_requerimiento.js"></script>
</head>
<body
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <c:if
							test="${accion == 'NUEVO'}">
							<spring:message
								code="formularioTipoRequerimiento.titulo.registrar"
								htmlEscape="true" />
						</c:if> <c:if test="${accion == 'MODIFICACION'}">
							<spring:message
								code="formularioTipoRequerimiento.titulo.modificar"
								htmlEscape="true" />
						</c:if> <c:if test="${accion == 'CONSULTA'}">
							<spring:message
								code="formularioTipoRequerimiento.titulo.consultar"
								htmlEscape="true" />
						</c:if>
					</font>
				</legend>
				<br />
				<form:form action="guardarActualizarTipoRequerimiento.html"
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioTipoRequerimiento.datos" htmlEscape="true" />
										...
										<table>
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioTipoRequerimiento.datos.codigo"
														htmlEscape="true" /></td>
											</tr>
											<tr>
											...
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioTipoRequerimiento.datos.descripcion"
														htmlEscape="true" /></td>
											</tr>
											<tr>
											...
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioTipoRequerimiento.datos.plazo"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="text" id="plazo"
													name="plazo" style="width: 50px;" maxlength="3"
													value="<c:out value="${tipoFormulario.plazo}" default="" />"
													<c:if test="${accion == 'CONSULTA'}">
																readonly="readonly"
															</c:if> />
													<spring:message
														code="formularioTipoRequerimiento.datos.plazo.horas"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="checkbox"
													id="cargaPorCantidad" name="cargaPorCantidad"
													<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>
													...
													<spring:message
														code="formularioTipoRequerimiento.datos.cargaPorCantidad"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="checkbox" id="retiro"
													name="retiro"
													<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>
											...
											<tr>
												<td class="texto_ti"><input type="checkbox"
													id="buscarConRef" name="buscarConRef"
													<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>
													...
													Buscar con Referencias</td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="checkbox"
													id="buscarSinRef" name="buscarSinRef"
													<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>
													...
													Buscar sin Referencias</td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="checkbox"
													id="ocultaGrilla" name="ocultaGrilla"
													<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>
											...
											<c:if test="${accion == 'CONSULTA'}">
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioTipoRequerimiento.datos.fechaRegistro"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioTipoRequerimiento.datos.fechaActualizacion"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text"
