...
<title><spring:message code="formularioElemento.titulo"
		...
		<ul>
			...
			<li id="modificar"><img src="images/modificar.png" /> <font
				size="2"><spring:message code="botones.modificar"
						htmlEscape="true" /></font></li>
			<li id="modificar_seleccionados"><img src="images/modificar.png" />
				<font size="2"><spring:message
						code="botones.modificar.seleccionados" htmlEscape="true" /></font></li>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioElemento.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarElemento.html"
					commandName="elementoBusqueda" method="post">
					<input type="hidden" id="clienteId" name="clienteId"
						value="<c:out value="${clienteId}" default="" />" />
					<input type="hidden" id="errorSeleccioneEmpresa"
						name="errorSeleccioneEmpresa"
						value="<spring:message code="notif.stock.seleccionEmpresa" htmlEscape="true"/>" />
					<input type="hidden" id="errorSeleccioneSucursal"
						name="errorSeleccioneSucursal"
						value="<spring:message code="notif.stock.seleccionSucursal" htmlEscape="true"/>" />
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
						...
						<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											code="formularioElemento.sucursal" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioElemento.deposito" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									...
									<td class="texto_ti"><input type="text"
										id="codigoSucursal" name="codigoSucursal" maxlength="4"
										style="width: 50px;"
									...
									<td class="texto_ti"><input type="text"
										id="codigoDeposito" name="codigoDeposito" maxlength="2"
										style="width: 50px;"
									...
									<td class="texto_ti"><spring:message
											code="formularioElemento.vacio" htmlEscape="true" /></td>
									<td class="texto_ti"><select id="pagesize" name="pagesize"
										size="1">
											...
											<option label="40" value="40"
												<c:if test="${pagesize == '40'}">
														selected="selected"
													</c:if>>40</option>
											<option label="60" value="60"
												<c:if test="${pagesize == '60'}">
														selected="selected"
													</c:if>>60</option>
											<option label="80" value="80"
												<c:if test="${pagesize == '80'}">
														selected="selected"
													</c:if>>80</option>
											<option label="100" value="100"
												<c:if test="${pagesize == '100'}">
														selected="selected"
													</c:if>>100</option>
											<option label="200" value="200"
												<c:if test="${pagesize == '200'}">
														selected="selected"
													</c:if>>200</option>
											<option label="500" value="500"
												<c:if test="${pagesize == '500'}">
														selected="selected"
													</c:if>>500</option>
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											code="formularioElemento.contenedor" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									...
									<td class="texto_ti"><select id="estado" name="estado"
										size="1">
											...
											<option label="Seleccione un Estado" value="">Seleccione
												un Estado</option>
											...
											<option label="En Guarda" value="En Guarda"
												<c:if test="${elementoBusqueda.estado == 'En Guarda'}">
															selected="selected"
														</c:if>>En
												Guarda</option>
											<option label="En Transito" value="En Transito"
												<c:if test="${elementoBusqueda.estado == 'En Transito'}">
															selected="selected"
														</c:if>>En
												Transito</option>
											<option label="En Consulta" value="En Consulta"
												<c:if test="${elementoBusqueda.estado == 'En Consulta'}">
															selected="selected"
														</c:if>>En
												Consulta</option>
											<option label="No Existe" value="No Existe"
												<c:if test="${elementoBusqueda.estado == 'No Existe'}">
															selected="selected"
														</c:if>>No
												Existe</option>
											<option label="Unificado" value="Unificado"
												<c:if test="${elementoBusqueda.estado == 'Unificado'}">
															selected="selected"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioElemento.desde" htmlEscape="true" /> <label>     
									</label> <spring:message code="formularioElemento.hasta"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									<td class="texto_ti"><input type="text" id="codigoDesde"
										name="codigoDesde" maxlength="12" size="12"
										value="<c:out value="${elementoBusqueda.codigoDesde}" default="" />" />
										<label> a </label> <input type="text" id="codigoHasta"
										name="codigoHasta" maxlength="12" size="12"
										value="<c:out value="${elementoBusqueda.codigoHasta}" default="" />" />
									</td>
									<td class="texto_ti"><input type="text" id="codigoLectura"
				...
				<fieldset>
					<display:table name="elementos" id="elemento"
						pagesize="${pagesize}" sort="external"
						requestURI="mostrarElemento.html" partialList="true"
						size="${size}" export="true" defaultsort="4">
						...
						<display:column class="hidden" headerClass="hidden" media="html">
							<input type="hidden" id="hdn_eliminar"
								value="<spring:message code="mensaje.eliminar" htmlEscape="false"/>" />
						</display:column>
						...
						<display:column sortName="codigo" property="codigo"
							titleKey="formularioElemento.datosElemento.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column sortName="tipoElemento.descripcion"
							property="tipoElemento.descripcion"
							titleKey="formularioElemento.nombreElemento" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="clienteEmp.razonSocialONombreYApellido"
							property="clienteEmp.razonSocialONombreYApellido"
							titleKey="formularioElemento.cliente" sortable="false"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="depositoActual.descripcion"
							property="depositoActual.descripcion"
							titleKey="formularioElemento.deposito" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column
							sortName="posicion.estante.grupo.seccion.descripcion"
							titleKey="formularioElemento.seccion" sortable="false"
							class="celdaAlineadoIzquierda">
							<c:choose>
								<c:when test="${elemento.contenedor != null}">
									<c:out
										value="${elemento.contenedor.posicion.estante.grupo.seccion.descripcion}" />
								</c:when>
								<c:otherwise>
									<c:if test="${elemento.posicion != null}">
										<c:out
											value="${elemento.posicion.estante.grupo.seccion.descripcion}" />
									</c:if>
								</c:otherwise>
							</c:choose>
						</display:column>
						<display:column sortName="elemento.posicion.posVerticalHorizontal"
							titleKey="formularioElemento.datosElemento.posicion"
							sortable="false" class="celdaAlineadoIzquierda">
							<c:choose>
								<c:when test="${elemento.contenedor != null}">
									<c:out
										value="E:${elemento.contenedor.posicion.estante.codigo} (${elemento.contenedor.posicion.posVertical};${elemento.contenedor.posicion.posHorizontal})" />
								</c:when>
								<c:otherwise>
									<c:if test="${elemento.posicion.posVertical != null}">
										<c:out
											value="E:${elemento.posicion.estante.codigo} (${elemento.posicion.posVertical};${elemento.posicion.posHorizontal})" />
									</c:if>
								</c:otherwise>
							</c:choose>
						</display:column>
						<display:column sortName="ubicacionProvisoria"
							property="ubicacionProvisoria"
							titleKey="formularioElemento.ubicacionProvisoria" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="contenedor.codigo"
							property="contenedor.codigo"
							titleKey="formularioElemento.contenedor" sortable="false"
							class="contenedor celdaAlineadoIzquierda">
							<input type="text" id="hdn_conten"
								value="${elemento.contenedor.codigo}" />
						</display:column>
						<display:column sortName="estado" property="estado"
							titleKey="formularioElemento.datosElemento.estado"
							sortable="true" class="celdaAlineadoCentrado" />
						<display:column sortName="cerrado"
							titleKey="formularioElemento.datosElemento.cerrado"
						...
						<display:column sortName="tipoTrabajo" property="tipoTrabajo"
							titleKey="formularioElemento.datosElemento.tipoTrabajo"
							sortable="true" class="celdaAlineadoCentrado" />
					</display:table>
					<br>
					<div align="right">
				...
				<div style="width: 100%">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
									<th align="left" id="imprimirImg"><font
										style="color: #003090"> <spring:message
												code="textos.imprimir" htmlEscape="true" />
									</font> <img id="imprimirImgSrcDown" src="images/skip_down.png"
										title="<spring:message code="textos.cerrarPanel" htmlEscape="true"/>">
										<img id="imprimirImgSrc" src="images/skip.png"
										style="DISPLAY: none"
										title="<spring:message code="textos.abrirPanel" htmlEscape="true"/>">
									</th>
								</tr>
						...
						<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"
							id="imprimirDiv" align="left">
							<table class="imprimir"
								style="width: 100%; background-color: white;">
								<tr>
									<td><select id="cantImprimir" name="cantImprimir" size="1"
										style="width: 190px;">
											<option label="Solo página actual" value="1">Solo
												página actual</option>
											<option label="Todas las páginas" value="2">Todas
												las páginas</option>
									</select></td>
									<td>
										<button id="imprimirModulos" name="imprimirModulos"
											...
											<spring:message code="botones.imprimirReporte"
												htmlEscape="true" />
										</button>
									</td>
									<td>
										<button id="descargarImprimirModulos"
											name="descargarImprimirModulos" type="button">
											<img src="<%=request.getContextPath()%>/images/diskette.gif">
											<spring:message code="botones.descargarReporte"
												htmlEscape="true" />
										</button>
									</td>
									<td></td>
