...
<script type="text/javascript"
	src="js/mavalos_formulario_plantillaFacturacion.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <c:if
							...
							<spring:message
								code="formularioPlantillaFacturacion.titulo.registrar"
								htmlEscape="true" />
						</c:if> <c:if test="${accion == 'MODIFICACION'}">
							<spring:message
								code="formularioPlantillaFacturacion.titulo.modificar"
								htmlEscape="true" />
						</c:if> <c:if test="${accion == 'CONSULTA'}">
							<spring:message
								...
								<tr>
									<td>
										<fieldset>
											<table>
												<tr>
													<td class="texto_ti" style="padding-right: 180px;"><spring:message
															code="formularioPlantillaFacturacion.estado"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="checkbox"
														id="habilitado" name="habilitado" value="true"
												...
												<tr>
													...
													<td class="texto_ti" style="padding-right: 180px;"><spring:message
															...
															htmlEscape="true" /></td>
													<td class="texto_ti" style="padding-right: 180px;"><spring:message
															code="formularioPlantillaFacturacion.serie"
															htmlEscape="true" /></td>
												...
												<tr>
													...
													<td class="texto_ti"><input type="text"
														...
														for="listaPreciosCodigo"> </label></td>
													<td class="texto_ti"><input type="text"
