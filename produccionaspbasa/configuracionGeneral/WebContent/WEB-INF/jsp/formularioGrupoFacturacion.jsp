...
<script type="text/javascript"
	src="js/mavalos_formulario_grupo_facturacion.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <c:if
							...
							<spring:message
								code="formularioGrupoFacturacion.titulo.modificar"
								htmlEscape="true" />
						</c:if> <c:if test="${accion == 'CONSULTA'}">
							<spring:message
								code="formularioGrupoFacturacion.titulo.consultar"
								htmlEscape="true" />
						</c:if>
					</font>
				</legend>
				<br />
				<form:form name="formGrupoFacturacion"
					action="guardarActualizarGrupoFacturacion.html"
					...
					<input type="hidden" id="empleadosSeleccionados"
						name="empleadosSeleccionados" />
					<input type="hidden" id="direccionesSeleccionadas"
						name="direccionesSeleccionadas" />
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioGrupoFacturacion.datosGrupoFacturacion"
												htmlEscape="true" />
								...
								<tr>
									<td colspan="3">
										<fieldset>
											<legend>
												<spring:message
													code="formularioGrupoFacturacion.nombreGrupoFacturacion"
													htmlEscape="true" />
											</legend>
											<table align="center">
												<tr>
										...
										<fieldset id="direcciones">
												...
												<thead>
													<tr>
														<th align="left" id="grupoImg"><font
															style="color: #003090"> <spring:message
																	code="formularioGrupoFacturacion.asignacionDirecciones"
																	htmlEscape="true" />
											...
											<div id="grupoDiv" align="center">
												<table>
													<tr>
														<td class="texto_ti"><spring:message
																code="formularioGrupoFacturacion.direccionesDisponibles"
																htmlEscape="true" /></td>
														<td>&nbsp;</td>
														<td class="texto_ti"><spring:message
																code="formularioGrupoFacturacion.direccionesAsignadas"
																htmlEscape="true" /></td>
													</tr>
													<tr>
														<td width="40%" align="center"><select
															id="direccionesSeleccionadasIzq"
															name="direccionesSeleccionadasIzq" size="8"
										...
										<fieldset id="empleados">
											<table width="100%">
												<thead>
													<tr>
														<th align="left" id="grupoImg"><font
															style="color: #003090"> <spring:message
																	code="formularioGrupoFacturacion.asignacionEmpleados"
																	htmlEscape="true" />
														</font> <img id="grupoImgSrcDown" src="images/skip_down.png"
															title="<spring:message code="textos.cerrarPanel" htmlEscape="true"/>">
															<img id="grupoImgSrc" style="DISPLAY: none"
											...
											<div id="grupoDiv" align="center">
												<table>
													<tr>
														<td class="texto_ti"><spring:message
																code="formularioGrupoFacturacion.empleadosDisponibles"
																htmlEscape="true" /></td>
														<td>&nbsp;</td>
														<td class="texto_ti"><spring:message
																code="formularioGrupoFacturacion.empleadosAsignados"
																htmlEscape="true" /></td>
													</tr>
													<tr>
														<td width="40%" align="center"><select
