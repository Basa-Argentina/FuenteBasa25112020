...
<title><spring:message code="formularioFactura.aviso.impresion"
...
<body
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioFactura.aviso.impresion" htmlEscape="true" />
					</font>
				</legend>
				<br />
			</fieldset>
	...
	<div id="pop" class="darkClassWithoutHeight">
		<img src="<%=request.getContextPath()%>/images/wait.gif" border="0"
			width="20px" height="20px"> <label style="font-weight: bold;">Generando
			facturas. Espere por favor...</label>
	</div>
</body>
</html>