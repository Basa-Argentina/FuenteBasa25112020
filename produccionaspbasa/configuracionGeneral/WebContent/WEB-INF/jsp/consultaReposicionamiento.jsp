...
<title><spring:message code="formularioReposicionamiento.titulo"
...
<script type="text/javascript"
	src="js/mavalos_consulta_reposicionamiento.js"></script>
...
<body
	...
	<input id="errorCodigoLecturaInvalido" type="hidden"
		value="<spring:message code="formularioReposicionamiento.error.codigoLecturaInvalido" htmlEscape="true" />" />
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioReposicionamiento.titulo" htmlEscape="true" />
					</font>
				</legend>
				<form:form name="formulario" id="formulario"
					action="mostrarReposicionamiento.html" method="get">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
						...
						<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"
							...
							<table class="busqueda"
								...
								<tr>
									<td><label for="codigo"
										title="<spring:message code="formularioReposicionamiento.lecturaNoUtilizada"></spring:message>">
											<spring:message code="formularioReposicionamiento.lectura"></spring:message>
									</label>&nbsp;&nbsp;</td>
									<td></td>
								</tr>
								<tr>
									<td><input type="hidden" id="codigoEmpresa"
										name="codigoEmpresa" value="${codigoEmpresa}" /> <input
										type="text" id="codigoLectura" name="codigoLectura"
										class="inputTextNumericPositiveIntegerOnly" maxlength="8"
										style="width: 50px;"
										...
										for="codigoLectura"> <c:out
												value="${lecturaBusqueda.descripcion}" default="" />
									</label>&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td>
										<fieldset>
											...
											<spring:message
												code="formularioReposicionamiento.liberaPosicionesAuto"
												htmlEscape="true" />
										</fieldset>
									</td>
									<td style="text-align: right;">
										<button id="cargarLectura" name="cargarLectura" type="button"
											onclick="" class="botonCentrado">
											<img src="<%=request.getContextPath()%>/images/buscar.png">
											<spring:message
												code="formularioReposicionamiento.boton.cargar"
												htmlEscape="true" />
										</button>
									</td>
								</tr>
				...
				<fieldset>
					<br style="font-size: xx-small;" />
					<display:table name="elementosReposicionados"
						id="elementoReposicionado"
						requestURI="mostrarReposicionamiento.html" pagesize="20"
						sort="list" keepStatus="true">
						<display:caption>
							<spring:message code="formularioReposicionamiento.nuevaPosicion"
								htmlEscape="true" />
						</display:caption>
						...
						<display:column property="codigo"
							titleKey="formularioReposicionamiento.datosElemento.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column
							property="posicionFutura.estante.grupo.seccion.deposito.descripcion"
							titleKey="formularioReposicionamiento.deposito" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column
							property="posicionFutura.estante.grupo.seccion.descripcion"
							titleKey="formularioReposicionamiento.seccion" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="posicionFutura.estante.codigo"
							titleKey="formularioReposicionamiento.estante" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column
							titleKey="formularioReposicionamiento.datosElemento.posicion"
							sortable="true" class="celdaAlineadoCentrado">
							<c:out
								value="(${elementoReposicionado.posicionFutura.posVertical};${elementoReposicionado.posicionFutura.posHorizontal})" />
						</display:column>
					</display:table>
					&nbsp;&nbsp;
				</fieldset>
