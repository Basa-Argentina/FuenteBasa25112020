	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form name="formRemito" action="guardarActualizarRemito.html"
							...
							<table style="width: 100%;">
								<tr>
									<td colspan="3">
										<fieldset>
											<legend>
												<spring:message code="formularioRemito.tipoRemito"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
													<td><input type="radio" id="tipoRemito"
														name="tipoRemito" value="cliente"
														...
														<spring:message code="formularioRemito.cliente"
															htmlEscape="true" /></td>
													<td><input type="radio" id="tipoRemito"
														name="tipoRemito" value="interno"
														...
														<spring:message code="formularioRemito.interno"
															htmlEscape="true" /></td>
													...
													<td id="tdEgresoIngreso">
														<fieldset>
															<legend>
																<spring:message
																	code="formularioRemito.datosRemito.ingresoEgreso"
																	htmlEscape="true" />
															</legend>
															<table>
																<tr>
													...
													<td class="texto_ti"><spring:message
															code="formularioRemito.verificaLectura" htmlEscape="true" />
													</td>
											...
											<table class="busqueda"
												...
												<tr>
													<td class="texto_ti" id="tdtituloDepositoOrigen"><spring:message
															code="formularioRemito.datosRemito.depositoOrigen"
															htmlEscape="true" /></td>
													<td class="texto_ti" id="tdtituloCliente"><spring:message
															code="formularioRemito.cliente" htmlEscape="true" /></td>
													<td class="texto_ti" id="tdtituloDepositoDestino"><spring:message
															code="formularioRemito.datosRemito.depositoDestino"
															htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
															code="formularioRemito.serie" htmlEscape="true" /></td>

												</tr>
												<tr>
													<td class="texto_ti" id="tdcodigoDepositoOrigen"><input
														type="text" id="codigoDepositoOrigen"
														name="codigoDepositoOrigen" maxlength="6"
													...
													<td class="texto_ti" id="tdcodigoDepositoDestino"><input
														type="text" id="codigoDepositoDestino"
														name="codigoDepositoDestino" maxlength="6"
														style="width: 50px;" class="requerido"
													...
													<td class="texto_ti"><input type="text"
														id="codigoSerie" name="codigoSerie" maxlength="6"
														style="width: 50px;" class="requerido"
														...
														for="codigoRemito"> <c:out
																value="${remitoFormulario.serie.descripcion}" default="" />
													</label></td>
												...
												<tr>
													...
													<td class="texto_ti" id="tdtituloPersonal"><spring:message
															code="formularioRemito.personal" htmlEscape="true" /></td>
													<td class="texto_ti" id="tdtituloPersonalVacio"><spring:message
															code="formularioRemito.vacio" htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
															code="formularioRemito.datosRemito.numero"
															htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
															code="formularioRemito.vacio" htmlEscape="true" /></td>
												</tr>
												<tr>
													...
													<td class="texto_ti"><spring:message
															code="formularioRemito.vacio" htmlEscape="true" /></td>
													<td class="texto_ti" id="tdcodigoPersonal"><input
														type="text" id="codigoPersonal" name="codigoPersonal"
														maxlength="6" style="width: 50px;" class="requerido"
													...
													<td class="texto_ti" id="tdcodigoPersonalVacio"><spring:message
															code="formularioRemito.vacio" htmlEscape="true" /></td>
													<td class="texto_ti"><input type="text" id="prefijo"
														name="prefijo" maxlength="4" size="4" class="requerido"
														value="<c:out value="${remitoFormulario.prefijo}" default="" />"
														readonly="readonly" /> - <input type="text"
														id="numeroSinPrefijo" name="numeroSinPrefijo"
														maxlength="8" size="8" class="requerido"
														value="<c:out value="${remitoFormulario.numeroSinPrefijo}" default="" />"
														<c:if test="${accion == 'CONSULTA'}">
															readonly="readonly"
														</c:if> />
													</td>
												...
												<tr>
													...
													<td class="texto_ti" id="tdtituloDireccion"><spring:message
															code="formularioRemito.direccion" htmlEscape="true" /></td>
													<td class="texto_ti" id="tdtituloDireccionVacio"><spring:message
															code="formularioRemito.vacio" htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
															code="formularioRemito.datosRemito.fechaEmision"
															htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
															code="formularioRemito.datosRemito.fechaEntrega"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text"
														...
														for="codigoTransporte"> <c:out
																value="${remitoFormulario.transporte.descripcion}"
																default="" />
													</label></td>
													<td class="texto_ti" id="tdcodigoDireccion"><input
														type="text" id="codigoDireccion" name="codigoDireccion"
														maxlength="6" style="width: 50px;" class="requerido"
													...
													<td class="texto_ti" id="tdcodigoDireccionVacio"><spring:message
															code="formularioRemito.vacio" htmlEscape="true" /></td>
													<td class="texto_ti"><input type="text"
														id=fechaEmision name="fechaEmision" maxlength="10"
														class="requerido"
													...
													<td class="texto_ti"><input type="text"
														id="fechaEntrega" name="fechaEntrega" maxlength="10"
						...
						<table style="width: 100%;" id="tablaUnica">
							<tr style="width: 100%;">
								<td style="width: 100%;"><display:table
										name="remitoDetalles" id="detalles"
										requestURI="precargaFormularioRemito.html" pagesize="40"
										...
										<display:column
											property="elemento.tipoElemento.descripcionStr"
											titleKey="formularioLectura.lecturaDetalle.tipo"
											sortable="true" class="celdaAlineadoIzquierda" />
										<display:column property="elemento.codigo"
											titleKey="formularioRemito.elemento" sortable="true"
											class="celdaAlineadoIzquierda" />
										<display:column property="elemento.estado"
											titleKey="formularioRemito.datosRemito.estado"
											sortable="true" class="celdaAlineadoIzquierda" />
										<display:column
											property="elemento.clienteEmp.razonSocialONombreYApellido"
											titleKey="formularioRemito.cliente" sortable="true"
											class="celdaAlineadoIzquierda" />
									</display:table></td>
							</tr>
						</table>
							...
							<tr style="width: 100%;">
								<td style="width: 50%;">
									<fieldset>
										...
										<display:table name="sessionScope.listaNuevos" id="movNuevo"
											requestURI="precargaFormularioRemito.html" pagesize="40"
											sort="list" keepStatus="true">
											<display:column property="elemento.codigo"
												titleKey="formularioRemito.elemento" sortable="true"
								...
								<td style="width: 50%;">
									<fieldset>
										...
										<display:table name="sessionScope.listaDevolucion"
											id="movDevolucion" requestURI="precargaFormularioRemito.html"
								...
								<tr>
									<td class="texto_ti" width="50%">
										<button type="button" onclick="abrirPopupCargaElementos();"
											...
											<spring:message code="formularioRemito.botonAgregar"
												htmlEscape="true" />
							...
							<tr>
								<td class="texto_ti"><textarea id="observacion"
										...
										<c:if test="${accion == 'CONSULTA'}">
											...
											value="${remitoFormulario.observacion}" default="" /></textarea></td>
								<td class="texto_ti"><spring:message
										code="formularioRemito.vacio" htmlEscape="true" /></td>
								<td class="texto_ti"><spring:message
										code="formularioRemito.cantidad" htmlEscape="true" /></td>
