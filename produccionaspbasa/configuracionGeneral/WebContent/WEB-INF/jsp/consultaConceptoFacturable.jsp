...
<title><spring:message
		code="formularioConceptoFacturable.titulo" htmlEscape="true" /></title>
<script type="text/javascript" src="js/jquery-1.5.js"></script>
<script type="text/javascript" src="js/jquery.contextmenu.js"></script>
<script type="text/javascript" src="js/mavalos_jquery.tools.min.js"
	language="JavaScript"></script>
<script type="text/javascript"
	src="js/mavalos_consulta_concepto_facturable.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioConceptoFacturable.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarConceptoFacturable.html"
					modelAttribute="conceptoFacturableBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioConceptoFacturable.filtro.codigo"
											htmlEscape="true" /></td>
									...
									<td class="texto_ti"><spring:message
											code="formularioConceptoFacturable.filtro.descripcion"
											htmlEscape="true" /></td>
									...
									<td class="texto_ti"><spring:message
											code="formularioConceptoFacturable.filtro.tipo"
											htmlEscape="true" /></td>
				...
				<fieldset>
					<display:table name="conceptos" id="concepto"
						requestURI="mostrarConceptoFacturable.html" pagesize="20"
						...
						<display:column property="codigo"
							titleKey="formularioConceptoFacturable.filtro.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="descripcion"
							titleKey="formularioConceptoFacturable.filtro.descripcion"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="tipo.descripcion"
							titleKey="formularioConceptoFacturable.tabla.tipo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="tipoCalculo"
							titleKey="formularioConceptoFacturable.tabla.tipoCalculo"
							sortable="true" class="celdaAlineadoIzquierda" />
