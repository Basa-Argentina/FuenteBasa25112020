				...
				<form:form action="guardarActualizarLoteRearchivo.html"
					...
					<fieldset style="height: 1500px;">
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioLoteRearchivo.datosGenerales"
												htmlEscape="true" />
							...
							<table style="width: 100%;">
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.codigo" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.fecha" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.tipo" htmlEscape="true" /></td>
									<td class="texto_ti" colspan="2"><spring:message
											code="formularioLoteRearchivo.remito" htmlEscape="true" /></td>
								</tr>
								<tr>
									...
									<td class="texto_ti"><select id="tipo"
										<c:if test="${accion != 'NUEVO'}">
												class="hiddenInput"
											</c:if>
										name="tipo" size="1">
											...
											<option label="Electronico" value="Electronico"
												...
												Electronico</option>
									</select> <input type="text" id="tipoAux" name="tipoAux"
										<c:if test="${accion == 'NUEVO'}">
												class="hiddenInput"
											</c:if>
										style="width: 80px; border: none; text-align: left; font-weight: bold;"
										readonly="readonly"
										value="<c:out value="${loteRearchivo.tipo}" default="" />" />
									</td>

									<td class="texto_ti"><input type="hidden"
										id="codigoRemito" name="codigoRemito" style="width: 80px;"
										class="requerido"
										...
										<button type="button" id="buscaRemito"
											...
											<c:out
												value="${loteRearchivo.remito.letraYNumeroComprobante}"
												default="" />
									</label></td>
								</tr>
								<tr>
									<td class="texto_ti" colspan="2"><spring:message
											code="formularioLoteRearchivo.empresa" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.sucursal" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.cliente" htmlEscape="true" /></td>
								</tr>
								<tr>
								...
								<tr>
									<td class="texto_ti" colspan="6"><spring:message
											code="formularioLoteRearchivo.descripcion" htmlEscape="true" />
									</td>
								</tr>
								<tr>
									<td class="texto_ti" colspan="6"><textarea
											id="descripcion" name="descripcion" cols="105" rows="1"
											<c:if test="${accion == 'CONSULTA'}">
												disabled="disabled"
											</c:if>>${loteRearchivo.descripcion}</textarea>
									</td>
								</tr>
							</table>
						</div>
						...
						<div style="width: 100%;" id="grupoDiv" align="center">
							<iframe src="seccionRearchivos.html?accion=${accion}"
								id="seccionRearchivos" width="100%" height="1250px"
