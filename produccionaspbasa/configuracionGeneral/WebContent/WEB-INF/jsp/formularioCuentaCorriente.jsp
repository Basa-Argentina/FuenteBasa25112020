...
<body
	...
	<div class="contextMenu" id="myMenu2">
		<ul>
			<li id="eliminarComprobante"><img src="images/eliminar.png" />
				<font size="2"><spring:message code="botones.eliminar"
						htmlEscape="true" /></font></li>
		</ul>
	</div>
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br /> <input type="hidden" id="error" name="error"
					value="<spring:message code="formularioFactura.error" htmlEscape="true" />" />
				<input type="hidden" id="errorSeleccioneCliente"
					name="errorSeleccioneCliente"
					value="<spring:message code="formularioFactura.error.seleccioneClienteEmp" htmlEscape="true" />" />
				<input type="hidden" id="errorSeleccioneFecha"
					name="errorSeleccioneFecha"
					value="<spring:message code="formularioFactura.error.seleccioneFecha" htmlEscape="true" />" />
				<input type="hidden" id="headerFacturaNoModificable"
					name="headerFacturaNoModificable"
					value="${headerFacturaNoModificable}" />
				<form:form action="guardarActualizarCuentaCorriente.html"
					...
					<input type="hidden" id="listasSeleccionadas"
						name="listasSeleccionadas" />
					<input type="hidden" id="listaDefecto" name="listaDefecto" />
					<input type="hidden" id="clienteId" name="clienteId"
						value="<c:out value="${clienteId}" default="" />" />
					<input type="hidden" id="idAfipTipoComprobante"
						name="idAfipTipoComprobante"
						value="${facturaFormulario.afipTipoDeComprobante.id}" />
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioCuentaCorriente.datosCuentaCorriente"
												htmlEscape="true" />
							...
							<table style="width: 100%;">
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioFactura.empresa" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioFactura.tipo" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioFactura.fecha" htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti">
										<table>
											<tr>
												...
												<td><label id="codigoEmpresaLabel" for="codigoEmpresa">
														<c:if test="${facturaFormulario.empresa != null}">
															<c:out
																value="${facturaFormulario.empresa.nombreRazonSocial}"
																escapeXml="true" />
														</c:if>
												</label></td>
											</tr>
									...
									<td class="texto_ti"><input type="text"
										id="afipTipoDeComprobante"
										class="requerido inputTextNumericPositiveIntegerOnly"
										name="afipTipoDeComprobante" style="width: 50px;"
										readonly="readonly"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioFactura.sucursal" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioFactura.serie" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioFactura.numero" htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti">
										<table>
											<tr>
												...
												<td><label id="codigoSucursalLabel"
													for="codigoSucursal"> <c:if
															test="${facturaFormulario.sucursal != null}">
															<c:out value="${facturaFormulario.sucursal.descripcion}"
																escapeXml="true" />
														</c:if>
												</label></td>
											</tr>
									...
									<td class="texto_ti">
										<table>
											<tr>
												<td><label id="prefijoSerie" for="numeroComprobante">
														XXXX </label></td>
												<td><input id="numeroComprobanteStr"
													name="numeroComprobanteStr" type="text"
													class="requerido inputTextNumericPositiveIntegerOnly completarZeros"
													value="<c:out value="${facturaFormulario.numeroComprobanteStr}" default="" />"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioFactura.cliente" htmlEscape="true" /></td>
								...
								<tr>
									...
									<td class="texto_ti" colspan="5">
										<table>
											<tr>
												<td><spring:message
														code="formularioFactura.notasFacturacion"
														htmlEscape="true" /></td>
												<td><textarea id="notasFacturacion"
														name="notasFacturacion" rows="3" cols="45"
														<c:if test="${accionFactura == 'CONSULTA'}">readonly="readonly"</c:if>>
													<c:out value="${facturaFormulario.notasFacturacion}"
															default="" />
											</textarea></td>
											</tr>
										</table>
					...
					<fieldset>
						<legend>
							<spring:message
								code="formularioCuentaCorriente.titulo.medioCobro"
								htmlEscape="true" />
						</legend>
						<display:table name="sessionScope.medioPagoList" id="medioPago"
							pagesize="20" sort="list" keepStatus="true">
						...
						<div style="width: 100%" align="right">
							<button id="agregarMedioCobro" name="agregarMedioCobro"
					...
					<fieldset>
						<legend>
							<spring:message
								code="formularioCuentaCorriente.titulo.comprobante"
								htmlEscape="true" />
						</legend>
						<display:table name="sessionScope.comprobanteList"
							id="comprobante" requestURI="mostrarCuentaCorriente.html"
							pagesize="20" sort="list" keepStatus="true">
							<display:column class="hidden" headerClass="hidden">
								<input type="hidden" id="hdn_idComprobante"
									value="${comprobante.id}" />
							</display:column>
							<display:column class="hidden" headerClass="hidden">
								<input type="hidden" id="hdn_eliminarComprobante"
									value="<spring:message code="mensaje.eliminar" htmlEscape="true"/>" />
							</display:column>
							<!-- 							COLUMNAS		           		    -->
							...
							<display:column property="afipTipoDeComprobante.codigo"
								...
								class="celdaAlineadoIzquierda" />
							<display:column titleKey="formularioCuentaCorriente.tabla.saldo"
								class="celdaAlineadoIzquierda">
								<fmt:formatNumber value="${comprobante.saldoDisponible}"></fmt:formatNumber>
							</display:column>
							<display:column
								titleKey="formularioCuentaCorriente.tabla.imputado">
								<input maxlength="15" type="text" class="numerico" id="imputado"
									name="imputado"
									value="<fmt:formatNumber value="${comprobante.imputado}"></fmt:formatNumber>"
									onblur="setImporte('${comprobante.id}',this.value,'${comprobante.saldoDisponible}');" />
							</display:column>
						...
						<div style="width: 100%" align="right">
							<button id="agregarComprobante" name="agregarComprobante"
								type="button" class="botonCentrado">
								<img src="<%=request.getContextPath()%>/images/add.png">
								<spring:message code="botones.agregar" htmlEscape="true" />
							</button>
						...
						<table>
							<tr>
								<td><spring:message
										code="formularioCuentaCorriente.titulo.medioCobro"
										htmlEscape="true" /></td>
								<td class="texto_ti"><input type="text" id="medioCobro"
									name="medioCobro" style="width: 200px;" readonly="readonly"
									value="<fmt:formatNumber value="${medioPagoTotal}"></fmt:formatNumber>" />
								</td>
								<td><spring:message
										code="formularioCuentaCorriente.titulo.imputado"
										htmlEscape="true" /></td>
								<td class="texto_ti"><input type="text" id="imputadoTotal"
									name="imputadoTotal" style="width: 200px;" readonly="readonly"
									value="<fmt:formatNumber value="${comprobanteTotal}"></fmt:formatNumber>" />
								</td>
								<td><spring:message
										code="formularioCuentaCorriente.titulo.sinImputar"
										htmlEscape="true" /></td>
								<td class="texto_ti"><input type="text" id="sinImputar"
									name="sinImputar" style="width: 200px;" readonly="readonly"
