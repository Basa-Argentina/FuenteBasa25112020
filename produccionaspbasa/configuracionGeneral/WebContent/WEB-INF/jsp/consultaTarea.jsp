...
<title>Consulta Tareas Asignadas</title>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> Consulta Tareas Asignadas
					</font>
				</legend>
				<br /> <br style="font-size: xx-small;" />
				<fieldset>
					<display:table name="tareas" id="tarea"
						requestURI="mostrarTarea.html" sort="list" keepStatus="true">
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_id" value="${tarea.id}" />
						</display:column>
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_eliminar"
								value="<spring:message code="mensaje.tarea.finalizar" htmlEscape="true"/>" />
						</display:column>
						<display:column property="elemento.codigo" title="Etiqueta"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="elemento.contenedor.codigo" title="Caja"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="loteReferencia.codigo" title="Lote"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column
							property="elemento.clienteEmp.razonSocialONombreYApellido"
							title="Municipio" class="celdaAlineadoIzquierda" />
						...
						<display:column property="texto1"
							...
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="descripcionTarea" maxLength="30"
							title="Desc. Tarea" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="estadoTarea" maxLength="30"
							title="Estado" sortable="true" class="celdaAlineadoIzquierda" />
