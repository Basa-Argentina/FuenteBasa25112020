...
<title><spring:message code="formularioCliente.titulo"
		...
		<sec:authorize
			...
			<ul>
				...
				<sec:authorize ifAllGranted="ROLE_ABM_CLASIFICACION_DOCUMENTAL">
					<li id="clasifDoc"><img src="images/open.gif" /> <font
						size="2"><spring:message
								code="formularioClasificacionDocumental.titulo"
								htmlEscape="true" /></font></li>
				</sec:authorize>
			</ul>
		</sec:authorize>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioCliente.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarCliente.html"
					commandName="clienteBusqueda" method="post">
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti"><input type="text" id="codigo"
										name="codigo" style="width: 50px;" maxlength="6"
								...
								<tr>
									<td class="texto_ti"><input type="text" id="codigoEmpresa"
										...
										for="codigoEmpresa"> <c:out
												value="${clienteBusqueda.empresa.descripcion}" default="" />
									</label></td>
									<td class="texto_ti"><input type="text" id="raSocial"
										name="raSocial" style="width: 200px;"
				...
				<fieldset>
					<display:table name="clientes" id="cliente"
						requestURI="mostrarCliente.html" pagesize="20" sort="list"
						keepStatus="true">
						...
						<display:column property="empresa.descripcion"
							titleKey="formularioCliente.datosCliente.empresa" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="codigo"
							titleKey="formularioCliente.datosCliente.codigo" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="razonSocial.razonSocial"
							titleKey="formularioCliente.datosCliente.razonSocial"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="nombre" maxLength="30"
							titleKey="formularioCliente.datosCliente.nombre" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="apellido" maxLength="30"
							titleKey="formularioCliente.datosCliente.apellido"
							sortable="true" class="celdaAlineadoIzquierda" />
