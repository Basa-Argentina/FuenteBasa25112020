...
<script type="text/javascript" src="js/calendar_us.js"
	language="JavaScript"></script>
<script language="JavaScript" src="js/formulario_comprobante.js"
...
<body
	...
	style="width: 300px;">
	<div>
		<form:form id="comprobanteForm" name="comprobanteForm"
			action="guardarActualizarComprobante.html" method="POST">
						...
						<fieldset>
							<legend>
								...
								<c:if test="${accion=='MODIFICAR'}">
									<spring:message
										code="formularioComprobante.tituloFormModificar"
										htmlEscape="true" />
								</c:if>
								<c:if test="${accion == 'CONSULTAR'}">
									<spring:message
										code="formularioComprobante.tituloFormConsultar"
										htmlEscape="true" />
								</c:if>
							</legend>
							<table>
								<tr>
									<td class="texto_ti">
										<fieldset style="border: hidden;">
											<display:table name="comprobanteList" id="comprobante"
												requestURI="mostrarCuentaCorriente.html" pagesize="20"
