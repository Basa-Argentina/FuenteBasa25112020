...
<title><spring:message code="general.empresa" htmlEscape="true" />
	<spring:message code="general.ambiente" htmlEscape="true" /></title>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="center">
			...
			<fieldset style="border: none; text-align: left;">
				<legend>
					<font id="fontTituloForm" class="tituloForm" size="5"> <input
						type="hidden" id="cfgmod" name="cfgmod"
