...
<body
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
											...
											<table align="center">
												...
												<tr>
													<td class="texto_ti"><input type="text"
														id="codigoTipoElemento" maxlength="6"
														name="codigoTipoElemento" style="width: 50px;"
														class="requerido"
												...
												<tr>
													<td class="texto_ti"><label
														id="codigoTipoElementoLabel2" for="codigoTipoElemento">
															<c:out
																value="${elementoFormulario.tipoElemento.prefijoCodigo}"
																default="" />
													</label> <input type="text" maxlength="10" id="codigo"
														name="codigo"
														class="requerido completarZeros inputTextNumericPositiveIntegerOnly"
												...
												<tr>
													<td class="texto_ti"><input type="text" maxlength="5"
														class="inputTextNumericPositiveIntegerOnly" id="cantidad"
														name="cantidad" style="width: 100px;"
														<c:if test="${accion != 'NUEVO'}">
												...
												<c:if test="${accion == 'NUEVO'}">
													<tr>
														<td class="texto_ti"><label
															id="codigoTipoElementoLabel3" for="codigoTipoElemento">
																<c:out
																	value="${elementoFormulario.tipoElemento.prefijoCodigo}"
																	default="" />
														</label> <input type="text" maxlength="10" readonly="readonly"
															id="hasta" name="hasta" style="width: 100px;"
												...
												<c:if
													test="${elementoFormulario.tipoElemento.precintoSeguridad == true}">
													<tr>
														<td class="texto_ti"><spring:message
																code="formularioElemento.nroPrecintoSeguridad"
																htmlEscape="true" /></td>
													</tr>
													<tr>
														<td class="texto_ti"><input type="text"
															id="nroPrecinto" name="nroPrecinto"
															value="<c:out value="${elementoFormulario.nroPrecinto}" default="" />"
															<c:if test="${accion == 'CONSULTA'}">
															readonly="readonly"
														</c:if>>
														</td>
													...
													<tr>
														<td class="texto_ti"><spring:message
																code="formularioElemento.nroPrecintoSeguridad1"
																htmlEscape="true" /></td>
													</tr>
													<tr>
														<td class="texto_ti"><input type="text"
															id="nroPrecinto1" name="nroPrecinto1"
															value="<c:out value="${elementoFormulario.nroPrecinto1}" default="" />"
															<c:if test="${accion == 'CONSULTA'}">
															readonly="readonly"
														</c:if>>
														</td>
												...
												<tr>
													...
													disabled="disabled"
														...
														for="codigoCliente"> <c:out
																value="${elementoFormulario.clienteEmp.nombreYApellido}"
																default="" />
													</label></td>
												</tr>
												...
												<sec:authorize ifNotGranted="ROLE_ELEM_HABILITAR_CERRAR">
													<c:if
														test="${elementoFormulario.tipoElemento.contenedor 
												...
												<c:if
													test="${elementoFormulario.tipoElemento.seleccionaTipoTrabajo == true}">
													<tr>
														<td class="texto_ti"><spring:message
												...
												<c:if test="${accion == 'CONSULTA'}">
													<tr>
														<td class="text_ti"><br style="font-size: xx-small;" />
															<fieldset>
																<legend>
																	<spring:message
																...
																<table>
																	<tr>
																		...
																		<td class="texto_ti"><spring:message
																				code="formularioElemento.vacio" htmlEscape="true" /></td>
																		<td class="texto_ti"><label
																			id="usuarioModificacionLabel"
																			for="usuarioModificacion"> <c:out
																					value="${elementoFormulario.usuarioModificacionPrecinto.persona}"
																					default="" /></label></td>
																	...
																	<tr>
																		...
																		<td class="texto_ti"><spring:message
																				code="formularioElemento.vacio" htmlEscape="true" /></td>
																		<td class="texto_ti"><label
																			id="fechaModificacionLabel" for="fechaModificacion">
																				<c:out
																					value="${elementoFormulario.fechaModificacionPrecinto}"
																					default="" />
																		</label></td>
																	</tr>
																</table>
																...
																<table>
																	<tr>
																		...
																		<td class="texto_ti"><label
																			id="usuarioModificacionLabel"
																			for="usuarioModificacion"> <c:out
																					value="${elementoFormulario.usuarioModificacion.persona}"
																					default="" /></label></td>
																	...
																	<tr>
																		...
																		<td class="texto_ti"><label
																			id="fechaModificacionLabel" for="fechaModificacion">
																				<c:out
																					value="${elementoFormulario.fechaModificacion}"
																					default="" />
																		</label></td>
																	</tr>
																</table>
			...
			<c:if test="${accion != 'CONSULTA'}">
				<div align="center">
					<button id="guardar" name="guardar" type="button"
						onclick="this.disabled=true;guardarYSalir();"
						class="botonCentrado">
