...
<title><spring:message
		code="formularioLoteExportacionRearchivo.titulo.exportar"
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="exportarLoteExportacionRearchivo.html"
					method="post" id="exportarLoteExportacionRearchivo">
							...
							<table style="width: 100%;">
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											...
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.sizeMaxArchivo"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti"><input type="text" id="codigoCliente"
										...
										&nbsp;&nbsp; <label id="codigoClienteLabel"
										for="codigoCliente"> <c:out
												value="${loteExportacionRearchivo.clienteEmp.razonSocialONombreYApellido}"
												default="" />
									</label></td>
									<td class="texto_ti"><input type="text"
										...
										for="codigoClasificacionDocumental"> <c:out
												value="${loteExportacionRearchivo.clasificacionDocumental.nombre}"
												default="" />
									</label></td>
									...
									<td class="texto_ti"><input type="text"
										id="sizeMaxArchivo" name="sizeMaxArchivo" style="width: 50px;"
										class="requerido"
								...
								<tr>
									<td class="texto_ti" colspan="4"><textarea
											...
											cols="90" rows="3">${loteExportacionRearchivo.descripcion}</textarea>
									</td>
								</tr>
							</table>
						</div>
										...
										<div style="width: 100%" id="grupoDiv" align="center">
											<fieldset>
												<display:table name="links" id="link">
													<display:column
														titleKey="formularioLoteExportacionRearchivo.archivoExportar"
