...
<script type="text/javascript"
	src="js/mavalos_consulta_requerimiento_elemento.js"></script>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="filtrarRequerimientoElemento.html"
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti" colspan="1"><spring:message
											...
											htmlEscape="true" /></td>
									<td class="texto_ti" colspan="1">Lectura</td>
								...
								<tr>
									<td class="texto_ti" colspan="1" style="width: 200px;"><input
										type="text" id="codigoTipoElemento" class="integer"
									...
									<td class="texto_ti" colspan="1" style="width: 300px;"><input
										type="text" id="codigoElemento" name="codigoElemento"
										maxlength="12" style="width: 90px;"
								...
								<tr>
									<td class="texto_ti" colspan="1" style="width: 500px;"><input
									...
									<td class="texto_ti" style="width: 300px;"><input
										type="text" id="codigoContenedor" name="codigoContenedor"
										maxlength="12" style="width: 90px;"
								...
								<tr align="right">
									<td align="left" colspan="3" style="width: 300px;"><input
										type="radio" id="unicaSelector" name="seleccion"
										<c:if test="${requerimientoElementoBusqueda == null || requerimientoElementoBusqueda.seleccion == 'unico'}"> checked="checked" </c:if>
										...
										<c:if test="${requerimientoElementoBusqueda.seleccion == 'ambos'}"> checked="checked" </c:if>
										...
										<fieldset style="height: 150px;">
											<table>
												...
												<tr
													...
													<td style="width: 140px;" class="texto_ti"><input
														type="text" id="texto2" name="texto2"
														style="width: 140px;" maxlength="255"
				...
				<form:form action="${destinoURLRequerimientoElemento}"
					...
					method="post">
					<input type="hidden" id="cantidadReferenciasSeleccionadas"
						name="cantidadReferenciasSeleccionadas" value="0" />
					<fieldset>
						<display:table name="requerimientoElementos"
							id="requerimientoElemento" pagesize="${pageSize}" sort="external"
							requestURI="mostrarRequerimientoElemento.html" partialList="true"
							size="${size}" export="true">
							...
							<display:column class="celdaAlineadoCentrado"
								...
								<c:if
									...
									<input type="checkbox" name="requerimientoElementosSel"
										value="${requerimientoElemento.idReferencia}"
										onclick="sumarReferencia(this.checked)"
										class="selectableCheckbox"
										name="${requerimientoElemento.idReferencia}"
										id="${requerimientoElemento.idReferencia}" />
								</c:if>
								<c:if test="${requerimientoElemento.enReq == 'SI'}">
									<img
										src="<%=request.getContextPath()%>/images/warning_tabla.png"
										title=<spring:message code="formularioRequerimientoElemento.display.utilizado" htmlEscape="true"/>>
								</c:if>
							</display:column>
							<display:column sortName="tipoElementos.descripcion"
							...
							<display:column sortName="elementos.codigo" sortable="true"
							...
							<display:column sortName="referencia.descripcion" sortable="true"
								...
								class="celdaAlineadoIzquierda" />
							<display:column sortName="ee.codigo" sortable="true"
								property="codigoContenedor"
								titleKey="formularioRequerimientoElemento.display.contenedor"
								class="celdaAlineadoIzquierda" />
							<display:column sortName="posicion" sortable="false"
								...
								<c:choose>
									...
									<c:otherwise>
										<c:if test="${requerimientoElemento.posicionEle != null}">
											<c:out value="${requerimientoElemento.posicionEle}"
												default="" />
										</c:if>
									</c:otherwise>
								</c:choose>
							...
							<display:column sortName="referencia.numero2" sortable="true"
								...
								class="celdaAlineadoDerecha" />
							<display:column sortName="referencia.descripcion_rearchivo"
								property="descripcionRearchivo"
								titleKey="formularioRequerimientoElemento.display.tipo"
								class="celdaAlineadoIzquierda" />
							<display:column sortName="elementos.estado" sortable="true"
								property="estadoElemento"
								titleKey="formularioRequerimientoElemento.display.estado"
								class="celdaAlineadoIzquierda" />
							<display:column sortName="idLote" sortable="false"
							...
							<display:column class="hidden" headerClass="hidden">
								...
								<input type="hidden" id="hdn_idReferencia"
									value="${requerimientoElemento.idReferencia}" />
								<input type="hidden" id="hdn_enReq"
									value="${requerimientoElemento.enReq}" />
							</display:column>
						</display:table>
					</fieldset>
				</form:form>
