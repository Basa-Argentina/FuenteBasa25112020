...
<title><spring:message code="formularioHojaRuta.titulo"
...
<body
	...
	<div class="contextMenu" id="myMenu1">
		<ul>
			...
			<li id="chequear" value=""><img src="images/chequear.png" /><font
				size="2"><spring:message code="botones.chequear"
						htmlEscape="true" /></font></li>
		</ul>
	</div>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioHojaRuta.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="consultaHojaRuta.html"
					commandName="busquedaHojaRutaFormulario" method="post">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti" colspan="2"><input type="text"
										id="codigoEmpresa" name="codigoEmpresa" style="width: 50px;"
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											code="formularioHojaRuta.busqueda.numeroDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioHojaRuta.busqueda.numeroHasta"
											htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti" style="width: 150px;"><input
										...
										<button type="button" id="buscaSerie" name="buscaSerie"
											...
											<c:out value="${busquedaHojaRutaFormulario.serie.prefijo}"
												default="" />
									</label></td>
									<td class="texto_ti">- <input type="text" id="serieDesde"
										maxlength="8" name="serieDesde" style="width: 70px;"
										class="integer"
										value="<c:out value="${busquedaHojaRutaFormulario.serieDesde}" default="" />" />
									</td>
									<td class="texto_ti"><input type="text" id="serieHasta"
										maxlength="8" name="serieHasta" style="width: 70px;"
										class="integer"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioHojaRuta.busqueda.fechaDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioHojaRuta.busqueda.fechaHasta"
											htmlEscape="true" /></td>
								...
								<tr>
									...
									<td class="texto_ti" rowspan="2"><input type="checkbox"
										style="width: 70px;" id="estado" name="estado"
				...
				<fieldset>
					<display:table name="hojaRuta" id="hojaRuta"
						requestURI="consultaHojaRuta.html" pagesize="20" sort="external"
						...
						<display:column sortName="formularioHojaRuta.lista.fecha"
							property="fechaStr" titleKey="formularioHojaRuta.lista.fecha"
							sortable="true" class="celdaAlineadoIzquierda" />

						<display:column titleKey="formularioHojaRuta.lista.numero"
							sortable="false" class="celdaAlineadoIzquierda">
							<c:out value="${hojaRuta.serie.codigo}" default="" />: <c:out
								value="${hojaRuta.serie.prefijo}" default="" /> - <c:out
								value="${hojaRuta.numeroStr}" default="" />
						</display:column>

						<display:column property="empresa.razonSocial.razonSocial"
							titleKey="formularioHojaRuta.lista.empresa" sortable="false"
							class="celdaAlineadoIzquierda" />
						<display:column property="sucursal.descripcion"
							titleKey="formularioHojaRuta.lista.sucursal" sortable="false"
							class="celdaAlineadoIzquierda" />
						<display:column property="transporte.descripcion"
							titleKey="formularioHojaRuta.lista.transporte" sortable="false"
							class="celdaAlineadoIzquierda" />
						<display:column property="estado"
							titleKey="formularioHojaRuta.lista.estado" sortable="false"
							class="celdaAlineadoIzquierda" />
					...
					<div style="width: 100%" align="right">
						<button name="agregar" type="button" id="nuevaHojaRuta"
							class="botonCentrado" style="width: 200px;">
							<img src="<%=request.getContextPath()%>/images/add.png">
							<spring:message code="formularioHojaRuta.nuevaHojaRuta"
								htmlEscape="true" />
						</button>
					</div>
				</fieldset>
