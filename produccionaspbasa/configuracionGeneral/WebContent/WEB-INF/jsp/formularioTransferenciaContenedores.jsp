...
<title><spring:message
		code="formularioTransferenciaContenedores.titulo" htmlEscape="true" />
</title>
...
<script type="text/javascript"
	src="js/formulario_transferencia_contenedor.js"></script>
<style type="text/css">
.cascade-loading {
...
<body
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<form:form action="ejecutarTransferenciaContenedor.html"
					method="post" commandName="transferenciaContenedorForm"
					id="transferenciaContenedorForm">
					<input type="hidden" id="clienteId" name="clienteId"
						value="<c:out value="${transferenciaContenedorForm.clienteId}" default="" />" />
					...
					<fieldset>
						<legend>
							<font size="1"> <spring:message
									code="formularioTransferenciaContenedores.titulo"
									htmlEscape="true" />
							</font>
						</legend>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioTransferenciaContenedores.empresa"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioTransferenciaContenedores.sucursal"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioTransferenciaContenedores.cliente"
											htmlEscape="true" /></td>
								</tr>
								<tr>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioTransferenciaContenedores.contenedorOrigen"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioTransferenciaContenedores.contenedorDestino"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti"><input type="text"
										id="codigoContenedorOrigen" class="requerido"
										name="codigoContenedorOrigen" maxlength="12"
										style="width: 90px;"
										...
										<button type="button" id="buscaContenedorOrigen"
											title="<spring:message code="textos.buscar" htmlEscape="true"/>">
											<img src="<%=request.getContextPath()%>/images/buscar.png">
										</button> &nbsp;&nbsp; <label id="codigoContenedorOrigenLabel"
										for="codigoContenedorOrigen"> </label></td>
									<td class="texto_ti"><input type="text"
										id="codigoContenedorDestino" class="requerido"
										name="codigoContenedorDestino" maxlength="12"
										style="width: 90px;"
										...
										<button type="button" id="buscaContenedorDestino"
											title="<spring:message code="textos.buscar" htmlEscape="true"/>">
											<img src="<%=request.getContextPath()%>/images/buscar.png">
										</button> &nbsp;&nbsp; <label id="codigoContenedorDestinoLabel"
										for="codigoContenedorDestino"> </label></td>
								</tr>
							</table>
						</div>
					</fieldset>
	...
	<div style="display: none">
		<input type="text" id="triggerBlurAfterSelectItemInPopUp" /> <input
			type="text" id="contenedor" /> <input type="text"
			id="codigoContenedor" />
	</div>
</body>
</html>