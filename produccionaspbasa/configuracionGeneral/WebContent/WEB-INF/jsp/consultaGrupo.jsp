...
<title><spring:message code="formularioGrupo.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioGrupo.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarGrupo.html" commandName="grupoBusqueda"
					method="post">
						...
						<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											code="formularioGrupo.datosGrupo.deposito" htmlEscape="true" />
									</td>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioGrupo.datosGrupo.seccion" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioGrupo.datosGrupo.codigo" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioGrupo.nombreGrupo" htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti"><input type="text" id="codigoSeccion"
										...
										for="codigoSeccion"> <c:out
												value="${grupoBusqueda.seccion.descripcion}" default="" />
									</label></td>
									<td class="texto_ti"><input type="text" id="codigo"
										name="codigo" style="width: 200px;" maxlength="2"
				...
				<fieldset>
					<display:table name="grupos" id="grupo"
						requestURI="mostrarGrupo.html" pagesize="20" sort="list"
						keepStatus="true">
						...
						<display:column property="seccion.deposito.descripcion"
							titleKey="formularioGrupo.datosGrupo.deposito" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="seccion.descripcion"
							titleKey="formularioGrupo.datosGrupo.seccion" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="codigo"
							titleKey="formularioGrupo.datosGrupo.codigo" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="descripcion"
							titleKey="formularioGrupo.nombreGrupo" sortable="true"
							class="celdaAlineadoIzquierda" />
