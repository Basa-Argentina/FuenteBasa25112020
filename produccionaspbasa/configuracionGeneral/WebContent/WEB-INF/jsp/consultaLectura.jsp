		...
		<div class="contextMenu" id="myMenu1">
	  	...
	  	<div id="contenedorGeneral">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
					...
					<fieldset>
						<display:table name="lecturas" id="lectura"  defaultsort="3" defaultorder="descending" requestURI="mostrarLectura.html"  pagesize="20" sort="list"  keepStatus="true">
							<display:column class="hidden" headerClass="hidden">
			              	...
			              	<display:column class="hidden" headerClass="hidden">
						    	<input type="hidden" id="hdn_eliminar" value="<spring:message code="mensaje.eliminar" htmlEscape="true"/>"/>
		           		   	...
		           		   	<display:column property="codigoStr" titleKey="formularioLectura.datosLectura.codigo" sortable="true" />
