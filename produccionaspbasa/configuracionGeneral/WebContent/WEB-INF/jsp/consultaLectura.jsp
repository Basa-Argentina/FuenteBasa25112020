...
<title><spring:message code="formularioLectura.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioLectura.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarLectura.html"
					commandName="lecturaBusqueda" method="post" name="formBusqueda">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLectura.datosLectura.fechaDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLectura.datosLectura.fechaHasta"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLectura.datosLectura.numeroDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLectura.datosLectura.numeroHasta"
											htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLectura.datosLectura.cliente"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLectura.datosLectura.tipoElemento"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLectura.datosLectura.codigoDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLectura.datosLectura.codigoHasta"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<!-- Inicio	Filtro Nuevo -->
									...
									<td class="texto_ti"><input type="text"
										...
										for="codigoTipoElemento"> <c:out value="" default="" />
									</label></td>
				...
				<fieldset>
					<display:table name="lecturas" id="lectura" defaultsort="3"
						defaultorder="descending" requestURI="mostrarLectura.html"
						...
						<display:column property="codigoStr"
							titleKey="formularioLectura.datosLectura.codigo" sortable="true" />
						<display:column property="fechaStr"
							titleKey="formularioLectura.datosLectura.fecha" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="descripcion" maxLength="30"
							titleKey="formularioLectura.datosLectura.descripcion"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="elementos"
							titleKey="formularioLectura.datosLectura.cantidadElementos"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="usuario.usernameSinCliente"
							titleKey="formularioLectura.datosLectura.usuario" sortable="true"
							class="celdaAlineadoIzquierda" />
