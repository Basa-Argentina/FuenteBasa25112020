...
<script type="text/javascript"
	src="js/mavalos_consulta_loteFacturacion.js"></script>
		...
		<ul>
			...
			<li id="eliminar"><img src="images/eliminar.png" /> <font
				size="2"><spring:message code="botones.eliminar"
						htmlEscape="true" /></font></li>
			<li id="facturar"><img src="images/eliminar.png" /> <font
				size="2"><spring:message code="botones.facturar"
						htmlEscape="true" /></font></li>
		</ul>
	</div>
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<form:form action="filtrarLoteFacturacion.html"
					...
					<input type="hidden" id="mensajeFacturar" name="mensajeFacturar"
						value="<spring:message code="formularioLoteFacturacion.notificacion.facturarLote" htmlEscape="true"/>" />
									...
									<td class="texto_ti"><select id="estado" name="estado"
										size="1">
											...
											<option label="Pendiente" value="Pendiente"
												<c:if test="${loteFacturacionBusqueda.estado == 'Pendiente'}">
															selected="selected"
														</c:if>>Pendiente</option>
											<option label="Facturado" value="Facturado"
												<c:if test="${loteFacturacionBusqueda.estado == 'Facturado'}">
															selected="selected"
														</c:if>>Facturado</option>
											<option label="Anulado" value="Anulado"
												<c:if test="${loteFacturacionBusqueda.estado == 'Anulado'}">
															selected="selected"
														</c:if>>Anulado</option>
									</select></td>
				...
				<form:form action="cambiarEstadoLoteFacturaciones.html"
					commandName="loteFacturacionTable" method="post">
					<fieldset>
						<display:table name="lotesFacturacion" id="loteFacturacion"
							...
							<display:column sortName="estado" property="estado"
								titleKey="formularioLoteFacturacion.datosLoteFacturacion.estado"
								sortable="true" class="celdaAlineadoIzquierda" />
							<display:column sortName="fechaRegistro"
								property="fechaRegistroStr"
								titleKey="formularioLoteFacturacion.datosLoteFacturacion.fechaRegistro"
								sortable="true" class="celdaAlineadoIzquierda" />
							<display:column property="numeroStr" sortName="numero"
								titleKey="formularioLoteFacturacion.datosLoteFacturacion.numero"
								sortable="true" class="celdaAlineadoIzquierda" />
							<display:column property="descripcion"
								titleKey="formularioLoteFacturacion.descripcion"
