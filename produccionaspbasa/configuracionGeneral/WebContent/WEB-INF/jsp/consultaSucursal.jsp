...
<title><spring:message code="formularioSucursal.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioSucursal.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarSucursal.html"
					commandName="sucursalBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											...
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioSucursal.nombreSucursal" htmlEscape="true" />
									</td>
				...
				<fieldset>
					<display:table name="sucursales" id="sucursal"
						requestURI="mostrarSucursal.html" pagesize="20" sort="list"
						keepStatus="true">
						...
						<display:column property="empresa.descripcion"
							titleKey="formularioSucursal.datosSucursal.empresa"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="codigo"
							titleKey="formularioSucursal.datosSucursal.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="descripcion" maxLength="30"
							titleKey="formularioSucursal.nombreSucursal" sortable="true"
