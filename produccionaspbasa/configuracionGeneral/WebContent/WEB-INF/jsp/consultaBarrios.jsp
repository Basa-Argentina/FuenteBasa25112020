...
<body
	...
	<table style="width: 100%; border-spacing: 0px;">
		<tr>
			<td style="width: 100%; vertical-align: top;"><form:form
					action="filtrarBarrios.html" commandName="paisBusqueda"
					method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioLugares.buscarBarrios" htmlEscape="true" />
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
										...
										type="hidden" id="locId" name="locId" style="width: 150px;"
								...
								<tr>
									<td class="texto_ti"><input type="text" id="id" name="id"
										style="width: 150px;"
										value="<c:out value="${barrioBusqueda.id}" default="" />" /></td>
								</tr>
								<tr>
									<td class="texto_ti"><spring:message
						...
						<thead>
							<tr>
								<th align="left"><font style="color: #003090"> <spring:message
											code="formularioLugares.barrios" htmlEscape="true" />
								</font></th>
							</tr>
						</thead>
					</table>
					<div class="displayTagDiv2" style="text-align: left; height: 80%;">
						<display:table name="localidadSel.barrios" id="barrio"
							requestURI="mostrarBarrios.html" pagesize="10" sort="list"
							...
							<display:column class="hidden" headerClass="hidden">
								<input type="hidden" id="hdn_eliminar"
									value="<spring:message code="formularioLugares.mensaje.eliminarBarrio" htmlEscape="true"/>" />
							</display:column>
							...
							<display:column class="hidden" headerClass="hidden">
								<input type="hidden" id="hdn_idLoc"
									value="${barrio.localidad.id}" />
							</display:column>
						</display:table>
					</div>
					<br>
