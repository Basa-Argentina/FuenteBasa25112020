...
<title><spring:message
		code="formularioHojaRutaChequearOp.titulo" htmlEscape="true" /></title>
...
<script type="text/javascript"
	src="js/formulario_hoja_ruta_chequear_op.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioHojaRutaChequearOp.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<fieldset>
					<table width="97%">
						<tr>
							<td><font size="3"> <spring:message
										code="formularioHojaRutaChequearOp.fechaHojaRuta"
										htmlEscape="true" />
							</font></td>
							<td><font size="3"> <spring:message
										code="formularioHojaRutaChequearOp.numero" htmlEscape="true" />
							</font></td>

							<td><font size="3"> <spring:message
										code="formularioHojaRutaChequearOp.responsable"
										htmlEscape="true" />
							</font></td>
							<td><font size="3"> <spring:message
										code="formularioHojaRutaChequearOp.scanear" htmlEscape="true" />
							</font></td>
						</tr>
						<tr>
							<td><label>${fechaHoraSalida}</label></td>
							<td><label>${nroSerieHr}</label></td>
							<td><label>${responsable}</label></td>
							<td><input type="text" id="txtScanear" name="txtScanear"
								onkeydown="scanearOperacion(event)"></td>
						</tr>
					</table>
				</fieldset>
				<form:form action="guardarChequearHojaRuta.html" method="post">
					<input type="hidden" id="hd_idHojaRuta" name="hd_idHojaRuta"
						value="${idHojaRuta}" />
					<fieldset>
						<display:table name="listaOperaciones" id="listaOperaciones"
							...
							<display:column
								sortName="formularioHojaRutaChequearOp.lista.fecha"
								property="serie"
								titleKey="formularioHojaRutaChequearOp.lista.req"
								sortable="true" class="celdaAlineadoIzquierda" />
							<display:column property="fechaEntrega"
								titleKey="formularioHojaRutaChequearOp.lista.fecha"
								sortable="false" class="celdaAlineadoIzquierda" />
							<display:column property="cliente"
								titleKey="formularioHojaRutaChequearOp.lista.cliente"
								sortable="false" class="celdaAlineadoIzquierda" />
							<display:column property="tipoRequerimiento"
								titleKey="formularioHojaRutaChequearOp.lista.tipo"
								sortable="false" class="celdaAlineadoIzquierda" />
							<display:column property="direccionEntrega"
								titleKey="formularioHojaRutaChequearOp.lista.sector"
								sortable="false" class="celdaAlineadoIzquierda" />
							<display:column property="cantidadElemento"
								titleKey="formularioHojaRutaChequearOp.lista.cantidad"
								sortable="false" class="celdaAlineadoIzquierda" />
							<display:column property="solicitante"
								titleKey="formularioHojaRutaChequearOp.lista.solicitante"
								sortable="false" class="celdaAlineadoIzquierda" />
							<display:column class="celdaAlineadoCentrado" media="html"
								sortable="false">
								<input type="checkbox"
									id="op_${listaOperaciones.idHojaRutaOpElemnt}"
									name="operacionSeleccionada"
									value="${listaOperaciones.idHojaRutaOpElemnt}"
