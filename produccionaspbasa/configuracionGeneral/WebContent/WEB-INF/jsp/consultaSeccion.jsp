...
<title><spring:message code="formularioSeccion.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioSeccion.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarSeccion.html"
					commandName="seccionBusqueda" method="post">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											...
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioSeccion.nombreSeccion" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioSeccion.vacio" htmlEscape="true" /></td>
								</tr>
								<tr>
				...
				<fieldset>
					<display:table name="secciones" id="seccion"
						requestURI="mostrarSeccion.html" pagesize="20" sort="list"
						keepStatus="true">
						...
						<display:column property="deposito.descripcion"
							titleKey="formularioSeccion.datosSeccion.deposito"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="codigo"
							titleKey="formularioSeccion.datosSeccion.codigo" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="descripcion"
							titleKey="formularioSeccion.nombreSeccion" sortable="true"
							class="celdaAlineadoIzquierda" />
