...
<title><c:if test="${accion == 'NUEVO'}">
		<spring:message code="formularioListaPrecios.titulo.registrar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'MODIFICACION'}">
		<spring:message code="formularioListaPrecios.titulo.modificar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'CONSULTA'}">
		<spring:message code="formularioListaPrecios.titulo.consultar"
			htmlEscape="true" />
	</c:if></title>
...
<script type="text/javascript"
	src="js/mavalos_formulario_lista_precios.js"></script>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="guardarActualizarListaPrecios.html"
					modelAttribute="listaFormulario" method="post" name="formPrecios">
					<input type="hidden" id="accion" name="accion"
						value="<c:out value="${accion}" default="" />" />
					<input type="hidden" id="clienteId" name="clienteId"
						value="<c:out value="${clienteId}" default="" />" />
					<input type="hidden" id="id" name="id"
						value="<c:out value="${listaFormulario.id}" default="" />" />
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioListaPrecios.datos" htmlEscape="true" />
							...
							<table>
								<tr>
									<td style="text-align: left;" colspan="2">
										<fieldset>
											<legend>
												<spring:message code="formularioListaPrecios.datos"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
													<td class="texto_ti"><input type="checkbox"
														id="habilitada" name="habilitada"
														...
														<spring:message
															code="formularioListaPrecios.datos.habilitada"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioListaPrecios.datos.codigo"
															htmlEscape="true" /></td>
												</tr>
												<tr>
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioListaPrecios.datos.tipoVariacion"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><select id="tipoVariacionId"
														name="tipoVariacionId" class="requerido"
														<c:if test="${accion == 'CONSULTA'}">
																	disabled="disabled"
																</c:if>>
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioListaPrecios.datos.valor"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text" id="valor"
														name="valor" style="text-align: right; width: 60px;"
														value="<c:out value="${listaFormulario.valor}" default="" />"
														class="requerido"
														<c:if test="${accion == 'CONSULTA'}">
																		readonly="readonly"
																	</c:if> />
												...
												<tr>
													<td class="texto_ti"><input type="checkbox"
														...
														<spring:message
															code="formularioListaPrecios.datos.listaFija"
															htmlEscape="true" /></td>

												</tr>
												<tr>
													<td class="texto_ti"><input type="checkbox"
														id="usaVencimiento" name="usaVencimiento"
														onclick="checkSelect();"
														<c:if test="${accion == 'CONSULTA'}">
																	disabled="disabled"
																</c:if>
														...
														<spring:message
															code="formularioListaPrecios.datos.usaVencimiento"
															htmlEscape="true" /> <br></td>
												...
												<tr>
													...
													<td class="texto_ti">
														<div id="seccion1" style="display: none">
															...
															<spring:message
																code="formularioListaPrecios.datos.vencimiento"
																htmlEscape="true" />
															<br> <input type="text" id="fechaVencimiento"
																name="fechaVencimiento" maxlength="10"
												...
												<c:if test="${accion == 'CONSULTA'}">
													<tr>
														<td class="texto_ti"><spring:message
																code="formularioListaPrecios.datos.fechaRegistro"
																htmlEscape="true" /></td>
													</tr>
													<tr>
														<td class="texto_ti"><input type="text"
													...
													<tr>
														<td class="texto_ti"><spring:message
																code="formularioListaPrecios.datos.fechaActualizacion"
																htmlEscape="true" /></td>
													</tr>
													<tr>
														<td class="texto_ti"><input type="text"
													...
													<tr>
														<td class="texto_ti"><spring:message
																code="formularioListaPrecios.datos.modifico"
																htmlEscape="true" /></td>
													</tr>
													<tr>
			...
			<c:if test="${accion != 'CONSULTA'}">
				<div align="center">
					<button name="guardar" type="button"
						onclick="popupOpcionDetalle('${accion}', ${listaVacia});"
						class="botonCentrado">
