...
<script type="text/javascript"
	src="js/mavalos_formulario_cliente_direccion.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <c:if
							test="${accion == 'NUEVO'}">
							<spring:message
								code="formularioClienteDireccion.tituloFormAgregar"
								htmlEscape="true" />
						</c:if> <c:if test="${accion == 'MODIFICACION'}">
							<spring:message
								code="formularioClienteDireccion.tituloFormModificar"
								htmlEscape="true" />
						</c:if> <c:if test="${accion == 'CONSULTA'}">
							<spring:message
								code="formularioClienteDireccion.tituloFormConsultar"
								htmlEscape="true" />
						</c:if>
					</font>
				</legend>
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioClienteDireccion.datosClienteDireccion"
												htmlEscape="true" />
							...
							<table style="width: 100%;">
								...
								<tr>
									...
									<td class="texto_ti"><input type="text" id="descripcion"
										class="requerido" name="descripcion" style="width: 200px;"
										maxlength="100"
								...
								<tr>
									<td colspan="4">
										<fieldset>
											<legend>
												<spring:message
													code="formularioClienteDireccion.datosClienteDireccion.direccion"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
													...
													<td class="texto_ti"><spring:message
															code="formularioClienteDireccion.numero"
															htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
												...
												<tr>
													<td class="texto_ti"><input type="text"
														id="direccion.calle" class="requerido"
														name="direccion.calle" style="width: 200px;"
														maxlength="30"
													...
													<td class="texto_ti"><input type="text"
														id="direccion.numero" class="requerido"
														name="direccion.numero" style="width: 200px;"
														maxlength="6"
													...
													<td class="texto_ti"><input type="text"
														id="direccion.piso" name="direccion.piso"
													...
													<td class="texto_ti"><input type="text"
														id="direccion.dpto" name="direccion.dpto"
												...
												<tr>
													...
													<td class="texto_ti"><spring:message
															code="formularioClienteDireccion.provincia"
															htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
															code="formularioClienteDireccion.localidad"
															htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
															code="formularioClienteDireccion.barrio"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													...
													<td class="texto_ti"><input type="text" id="provincia"
														...
														<div style="display: none;">
															<label id="provinciaLabel" for="provincia"> <c:out
																	value="${clienteDireccionFormulario.direccion.barrio.localidad.provincia.id}"
																	default="" />
															</label>
														</div></td>
													<td class="texto_ti"><input type="text" id="localidad"
														...
														<div style="display: none;">
															<label id="localidadLabel" for="localidad"> <c:out
																	value="${clienteDireccionFormulario.direccion.barrio.localidad.id}"
																	default="" />
															</label>
														</div></td>
													<td class="texto_ti"><input id="idBarrio"
														...
														<div style="display: none;">
															<label id="barrioLabel" for="barrio"> <c:out
																	value="${clienteDireccionFormulario.direccion.barrio.id}"
																	default="" />
															</label>
														</div></td>
								...
								<tr>
									<td colspan="4">
										<fieldset>
											<legend>
												<spring:message
													code="formularioClienteDireccion.geolocalizacion"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioClienteDireccion.latitud"
															htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
															code="formularioClienteDireccion.longitud"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text"
														id="direccion.latitud" name="direccion.latitud"
														style="width: 200px;"
													...
													<td class="texto_ti"><input type="text"
														id="direccion.longitud" name="direccion.longitud"
														style="width: 200px;"
								...
								<tr>
									<td colspan="4">
										<fieldset>
											<legend>
												<spring:message
													code="formularioClienteDireccion.datosClienteDireccion.adicionales"
													htmlEscape="true" />
											</legend>
											<table>
												<tr style="vertical-align: top;">
													<td class="texto_ti"><spring:message
															code="formularioClienteDireccion.edificio"
															htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
															code="formularioClienteDireccion.observaciones"
															htmlEscape="true" /></td>
												</tr>
												<tr style="vertical-align: top;">
													<td class="texto_ti"><input type="text"
														id="direccion.edificio" name="direccion.edificio"
