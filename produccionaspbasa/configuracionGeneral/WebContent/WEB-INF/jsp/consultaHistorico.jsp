...
<title><c:if test="${tipoHistorico=='elemento'}">
		<spring:message code="formularioHistoricoElemento.titulo"
			htmlEscape="true" />
	</c:if> <c:if test="${tipoHistorico=='referencia'}">
		<spring:message code="formularioHistoricoReferencia.titulo"
			htmlEscape="true" />
	</c:if></title>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="${rutaHistorico}" commandName="historicoBusqueda"
					method="post" name="formBusqueda">
					<input type="hidden" id="clienteId" name="clienteId"
						value="<c:out value="${clienteId}" default="" />" />
					<input type="hidden" id="tipoHistorico" name="tipoHistorico"
						value="<c:out value="${tipoHistorico}" default="" />" />
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioHistoricoElemento.datosHistorico.fechaDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioHistoricoElemento.datosHistorico.fechaHasta"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioHistoricoElemento.datosHistorico.usuario"
											htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti"><input type="text" id="fechaDesdeStr"
										name="fechaDesdeStr" maxlength="10" style="width: 90px;"
									...
									<td class="texto_ti"><input type="text" id="fechaHastaStr"
										name="fechaHastaStr" maxlength="10" style="width: 90px;"
									...
									<td class="texto_ti"><input type="hidden"
										...
										type="text" id="codigoUsuario" name="codigoUsuario"
										maxlength="6" style="width: 90px;"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioHistoricoElemento.datosHistorico.cliente"
											htmlEscape="true" /></td>
									<c:if test="${tipoHistorico=='elemento'}">
										<td class="texto_ti"><spring:message
												code="formularioHistoricoElemento.datosHistorico.tipoElemento"
												htmlEscape="true" /></td>
										<td class="texto_ti"><spring:message
												code="formularioHistoricoElemento.datosHistorico.elemento"
												htmlEscape="true" /></td>
									</c:if>
									<c:if test="${tipoHistorico=='referencia'}">
										<td class="texto_ti"><spring:message
												code="formularioHistoricoReferencia.datosHistorico.loteReferencia"
												htmlEscape="true" /></td>
										<td class="texto_ti"><spring:message
												code="formularioHistoricoReferencia.datosHistorico.elemento"
												htmlEscape="true" /></td>
										<td class="texto_ti"><spring:message
												code="formularioHistoricoReferencia.datosHistorico.contenedor"
												htmlEscape="true" /></td>
									</c:if>
								</tr>
								<tr>
									...
									<td class="texto_ti"><input type="text" id="codigoCliente"
										name="codigoCliente" maxlength="12" style="width: 90px;"
									...
									<c:if test="${tipoHistorico=='referencia'}">
										<td class="texto_ti"><input type="text"
											id="idLoteReferencia" name="idLoteReferencia" maxlength="12"
											style="width: 90px;"
				...
				<fieldset>
					<display:table name="historicos" id="historico"
						requestURI="mostrarHistorico.html" pagesize="20" sort="external"
						...
						<display:column sortName="nombreCliente" property="nombreCliente"
							titleKey="formularioHistoricoReferencia.datosHistorico.nombreCliente"
							sortable="true" class="celdaAlineadoIzquierda" />
						<c:if test="${tipoHistorico=='elemento'}">
							<display:column sortName="nombreTipoElemento"
								property="nombreTipoElemento"
								titleKey="formularioHistoricoElemento.datosHistorico.tipoElemento"
								sortable="true" class="celdaAlineadoIzquierda" />
							<display:column sortName="codigoElemento"
								property="codigoElemento"
								titleKey="formularioHistoricoElemento.datosHistorico.elemento"
								sortable="true" class="celdaAlineadoIzquierda" />
						</c:if>
						<c:if test="${tipoHistorico=='referencia'}">
							<display:column sortName="idLoteReferencia"
								property="idLoteReferencia"
								titleKey="formularioHistoricoReferencia.datosHistorico.loteReferencia"
								sortable="true" class="celdaAlineadoIzquierda" />
							<display:column sortName="codigoElemento"
								property="codigoElemento"
								titleKey="formularioHistoricoReferencia.datosHistorico.elemento"
								sortable="true" class="celdaAlineadoIzquierda" />
							<display:column sortName="codigoContenedor"
								property="codigoContenedor"
								titleKey="formularioHistoricoReferencia.datosHistorico.contenedor"
								sortable="true" class="celdaAlineadoIzquierda" />
						</c:if>
						<display:column sortName="accion"
							titleKey="formularioHistoricoElemento.datosHistorico.accion"
							sortable="true" class="celdaAlineadoIzquierda">
							<spring:message code="${historico.accion}" htmlEscape="true" />
						</display:column>
						<display:column sortName="fechaHora" property="fechaHoraStr"
							titleKey="formularioHistoricoElemento.datosHistorico.fechaHora"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column sortName="usuario" property="usuario.persona"
							titleKey="formularioHistoricoElemento.datosHistorico.usuario"
							sortable="true" class="celdaAlineadoIzquierda" />
					</display:table>
