...
<title><spring:message code="formularioRemito.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioRemito.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarRemito.html" commandName="remitoBusqueda"
					method="post">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioRemito.empresa" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioRemito.cliente" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioRemito.fechaDesde" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioRemito.fechaHasta" htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti"><input type="text" id="codigoEmpresa"
										...
										for="codigoEmpresa"> <c:out
												value="${remitoBusqueda.empresa.descripcion}" default="" />
									</label></td>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioRemito.sucursal" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioRemito.deposito" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									<td class="texto_ti"><input type="text"
										...
										for="codigoSucursal"> <c:out
												value="${remitoBusqueda.sucursal.descripcion}" default="" />
									</label></td>

									<td class="texto_ti"><input type="text"
										id="codigoDepositoOrigen" name="codigoDepositoOrigen"
									...
									<td class="texto_ti"><input type="text" id="codigoSerie"
										...
										<button type="button"
											...
											<img src="<%=request.getContextPath()%>/images/buscar.png">
										</button>&nbsp;&nbsp; <label id="codigoSerieLabel" for="codigoRemito">
											<c:out value="${remitoBusqueda.serie.descripcion}" default="" />
									</label></td>
									...
									<td class="texto_ti"><select id="estado" name="estado"
										size="1">
											...
											<option label="Pendiente" value="Pendiente"
												<c:if test="${remitoBusqueda.estado == 'Pendiente'}">
															selected="selected"
														</c:if>>Pendiente</option>
											<option label="Cancelado" value="Cancelado"
												<c:if test="${remitoBusqueda.estado == 'Cancelado'}">
															selected="selected"
														</c:if>>Cancelado</option>
											<option label="En Transito" value="En Transito"
												<c:if test="${remitoBusqueda.estado == 'En Transito'}">
															selected="selected"
														</c:if>>En
												Transito</option>
											<option label="Entregado" value="Entregado"
												<c:if test="${remitoBusqueda.estado == 'Entregado'}">
															selected="selected"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioRemito.transporte" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioRemito.tipoRemito" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioRemito.numeroDesde" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioRemito.numeroHasta" htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti"><input type="text"
									...
									<td class="texto_ti"><select id="tipoRemito"
										...
										<c:if test="${accion == 'CONSULTA'}">disabled="disabled"</c:if>>
											...
											<option label="cliente" value="cliente"
												<c:if test="${remitoBusqueda.tipoRemito == 'cliente'}">
															selected="selected"
														</c:if>>Cliente</option>
											<option label="interno" value="interno"
												<c:if test="${remitoBusqueda.tipoRemito == 'interno'}">
															selected="selected"
														</c:if>>Interno</option>
									</select></td>
				...
				<fieldset>
					<display:table name="remitos" id="remito"
						requestURI="mostrarRemito.html" pagesize="20" sort="external"
						...
						<display:column sortName="fecha" property="fechaEmisionStr"
							titleKey="formularioRemito.fecha" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="comprobante"
							property="letraYNumeroComprobante"
							titleKey="formularioRemito.comprobante" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="tipo" property="tipoRemito"
							titleKey="formularioRemito.tipo" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="ingresoEgreso" property="ingresoEgreso"
							titleKey="formularioRemito.datosRemito.ingreEgre" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="cantidadElementos"
							property="cantidadElementos"
							titleKey="formularioRemito.datosRemito.cant" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="empresa" property="empresa.descripcion"
							titleKey="formularioRemito.empresa" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="sucursal"
							property="sucursal.descripcion"
							titleKey="formularioRemito.sucursal" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="destino" property="destino"
							titleKey="formularioRemito.destino" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column sortName="estado" property="estado"
							titleKey="formularioRemito.datosRemito.estado" sortable="true"
							class="celdaAlineadoIzquierda" />
					</display:table>
					<div style="width: 100%" align="right">
						<table width="100%">
							<tr>
								<td align="left"><form:form
										action="cambiarEstadoRemitos.html" commandName="posicionTable"
										method="post">
										<input type="hidden" id="selectedSel" name="selectedSel" />
										<select id="estadoRemito" name="estadoRemito" size="1">
											<option label="Seleccione un Estado" value="">Seleccione
												un Estado</option>
											<option label="Pendiente" value="Pendiente">Pendiente</option>
											<option label="Cancelado" value="Cancelado">Cancelado</option>
											<option label="En Transito" value="En Transito">En
												Transito</option>
										...
										<button name="cambiarEstado" id="cambiarEstado" type="button">
											...
											<spring:message code="botones.cambiarEstado"
												htmlEscape="true" />
										</button>
									</form:form></td>
								<td align="right">
									<button name="imprimirRemitos" type="button"
										id="imprimirRemitos">
										<img src="<%=request.getContextPath()%>/images/skip.png">
