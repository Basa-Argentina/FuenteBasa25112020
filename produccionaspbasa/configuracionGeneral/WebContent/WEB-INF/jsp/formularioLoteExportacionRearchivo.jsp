...
<title><c:if test="${accion == 'NUEVO'}">
		<spring:message
			code="formularioLoteExportacionRearchivo.titulo.registar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'MODIFICACION'}">
		<spring:message
			code="formularioLoteExportacionRearchivo.titulo.modificar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'CONSULTA'}">
		<spring:message
			code="formularioLoteExportacionRearchivo.titulo.consultar"
			htmlEscape="true" />
	</c:if></title>
...
<script type="text/javascript"
	src="js/formulario_exportacion_rearchivo.js"></script>
<style type="text/css">
.cascade-loading {
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<form:form action="guardarActualizarLoteExportacionRearchivo.html"
					...
					<input type="hidden" id="sizeMaxArchivo" name="sizeMaxArchivo"
						value="<c:out value="${loteExportacionRearchivo.sizeMaxArchivo}" default="" />" />
					<input type="hidden" id="cantPartesGeneradas"
						name="cantPartesGeneradas"
						value="<c:out value="${loteExportacionRearchivo.cantPartesGeneradas}" default="" />" />
					<input type="hidden" id="pathArchivoBase" name="pathArchivoBase"
						value="<c:out value="${loteExportacionRearchivo.pathArchivoBase}" default="" />" />

					<!-- para las acciones -->
					<input type="hidden" id="accion" name="accion"
						value="<c:out value="${accion}" default="" />" />
					<input type="hidden" id="codigoLoteRearchivoSeleccionado"
						name="codigoLoteRearchivoSeleccionado" value="" />
					<input type="hidden" id="codigoLoteRearchivoEliminar"
						name="codigoLoteRearchivoEliminar" value="" />
					<!-- para los mensajes -->
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioLoteExportacionRearchivo.datosGenerales"
												htmlEscape="true" />
							...
							<table style="width: 100%;">
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.codigo"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.fecha"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.empresa"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.sucursal"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti"><input type="text" id="codigo"
										name="codigo" style="width: 50px;" readonly="readonly"
										value="<c:out value="${loteExportacionRearchivo.id}" default="" />"
									...
									<td class="texto_ti"><input type="text" id="fechaRegistro"
										name="fechaRegistro" style="width: 80px;" class="requerido"
									...
									<td class="texto_ti"><input type="text" id="codigoEmpresa"
										name="codigoEmpresa" style="width: 50px;" class="requerido"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.cliente"
											htmlEscape="true" /></td>
									<td class="texto_ti" colspan="2"><spring:message
											code="formularioLoteExportacionRearchivo.clasificacionDocumental"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.estado"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti"><input type="text" id="codigoCliente"
										name="codigoCliente" style="width: 50px;" class="requerido"
									...
									<td class="texto_ti" colspan="2"><input type="text"
										...
										name="codigoClasificacionDocumental" style="width: 50px;"
										class="requerido"
										...
										for="codigoClasificacionDocumental"> </label></td>
									<td class="texto_ti"><input type="text" id="estado"
										name="estado" style="width: 250px;" class="requerido"
										readonly="readonly"
								...
								<tr>
									<td class="texto_ti" colspan="4"><spring:message
											code="formularioLoteExportacionRearchivo.descripcion"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti" colspan="4"><textarea
											id="descripcion" name="descripcion" cols="90" rows="3">${loteExportacionRearchivo.descripcion}</textarea>
									</td>
								</tr>
							</table>
						</div>
							...
							<thead>
								<tr>
									<th align="left" id="grupoImg"><font
										style="color: #003090"> <spring:message
												code="formularioLoteExportacionRearchivo.lotesRearchivo"
												htmlEscape="true" />
								...
								<tr>
									<td>
										<div style="width: 100%" id="grupoDiv" align="center">
											<fieldset>
												<display:table name="sessionScope.lotesRearchivo"
													id="loteRearchivo">
													<display:column class="hidden" headerClass="hidden">
														<input type="hidden" id="hdn_id"
															value="${loteRearchivo.id}" />
													</display:column>
													<display:column class="hidden" headerClass="hidden">
														<input type="hidden" id="hdn_eliminar"
															value="<spring:message code="mensaje.eliminar" htmlEscape="true"/>" />
													</display:column>
													<display:column sortName="id" property="id"
														titleKey="formularioLoteRearchivo.lista.codigo"
														sortable="true" sortProperty="id"
														class="celdaAlineadoIzquierda" />
													<display:column sortName="tipo" property="tipo"
														titleKey="formularioLoteRearchivo.lista.tipo"
														sortProperty="tipo" sortable="true"
														class="celdaAlineadoIzquierda" />
													<display:column sortName="fechaRegistroStr"
														property="fechaRegistroStr"
														titleKey="formularioLoteRearchivo.lista.fecha"
														sortable="true" class="celdaAlineadoIzquierda" />
													<display:column property="empresa.razonSocial.razonSocial"
														titleKey="formularioLoteRearchivo.lista.empresa"
														class="celdaAlineadoIzquierda" />
													<display:column property="sucursal.descripcion"
														titleKey="formularioLoteRearchivo.lista.sucursal"
														class="celdaAlineadoIzquierda" />
													<display:column
														property="clienteEmp.razonSocialONombreYApellido"
														titleKey="formularioLoteRearchivo.lista.cliente"
														class="celdaAlineadoIzquierda" />
													<display:column property="clasificacionDocumental.nombre"
														titleKey="formularioLoteRearchivo.lista.clasificacionDocumental"
														class="celdaAlineadoIzquierda" />
													<display:column sortName="indiceIndividualStr"
														property="indiceIndividualStr"
														titleKey="formularioLoteRearchivo.lista.tipoIndice"
														sortable="true" class="celdaAlineadoIzquierda" />
													<display:column property="contenedor.codigo"
														titleKey="formularioLoteRearchivo.lista.contenedor"
														class="celdaAlineadoIzquierda" />
													<display:column sortName="cantidad" property="cantidad"
														titleKey="formularioLoteRearchivo.lista.cantidad"
														sortProperty="cantidad" sortable="true"
														class="celdaAlineadoDerecha" />
													<display:column property="remito.letraYNumeroComprobante"
														titleKey="formularioLoteRearchivo.lista.remito"
														class="celdaAlineadoIzquierda" />
												...
												<c:if test="${accion != 'CONSULTA' }">
													<div style="width: 100%" align="right">
														<button name="agregar" type="button"
															onclick="agregarLoteRearchivo();" class="botonCentrado">
			...
			<c:if test="${accion == 'CONSULTA'}">
				<div align="center">
					...
					&nbsp;
					<button name="exportar" type="button" class="botonCentrado"
						id="btnExportar" style="width: 200px;">
