...
<script type="text/javascript"
	src="js/mavalos_consulta_tipo_requerimiento.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioTipoRequerimiento.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarTipoRequerimiento.html"
					modelAttribute="tipoRequerimientoBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
						...
						<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
											code="formularioTipoRequerimiento.filtro.plazo"
											htmlEscape="true" /></td>
									<td class="texto_ti"><input type="text" id="plazo"
										name="plazo" style="width: 150px;"
				...
				<fieldset>
					<display:table name="tipos" id="tipo"
						requestURI="mostrarTipoRequerimiento.html" pagesize="20"
						...
						<display:column
							titleKey="formularioTipoRequerimiento.filtro.plazo"
