			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioLoteRearchivo.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="consultaLotesRearchivo.html"
					commandName="busquedaLoteRearchivoFormulario" method="post">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.busqueda.empresa"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.busqueda.sucursal"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.busqueda.cliente"
											htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.busqueda.tipo"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.busqueda.clasificacionDocumental"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.busqueda.contenedor"
											htmlEscape="true" /></td>

								</tr>
								<tr>
									<td class="texto_ti"><select id="tipo" name="tipo"
										size="1" style="width: 140px;">
											...
											<option label="Fisico" value="Fisico"
												...
												<spring:message code="formularioLoteRearchivo.tipo.fisico"
													htmlEscape="true" />
											</option>
											<option label="Lote" value="Lote"
												...
												<spring:message code="formularioLoteRearchivo.tipo.lote"
													htmlEscape="true" />
											</option>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.busqueda.codigoDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.busqueda.codigoHasta"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.busqueda.fechaDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteRearchivo.busqueda.fechaHasta"
											htmlEscape="true" /></td>

								</tr>
								<tr>
									<td class="texto_ti"><input type="text" id="codigoDesde"
										name="codigoDesde" style="width: 50px;"
										value="<c:out value="${busquedaLoteRearchivoFormulario.codigoDesde}" default="" />" />
									</td>
									<td class="texto_ti"><input type="text" id="codigoHasta"
										name="codigoHasta" style="width: 50px;"
										value="<c:out value="${busquedaLoteRearchivoFormulario.codigoHasta}" default="" />" />
									</td>
									<td class="texto_ti"><input type="text" id="fechaDesde"
										name="fechaDesde" style="width: 80px;"
									...
									<td class="texto_ti"><input type="text" id="fechaHasta"
										name="fechaHasta" style="width: 80px;"
				...
				<fieldset>
					<display:table name="lotesRearchivo" id="loteRearchivo"
						requestURI="consultaLotesRearchivo.html" pagesize="10"
						...
						<display:column sortName="id" property="id"
							titleKey="formularioLoteRearchivo.lista.codigo" sortable="true"
							sortProperty="id" class="celdaAlineadoIzquierda" />
						<display:column sortName="tipo" property="tipo"
							titleKey="formularioLoteRearchivo.lista.tipo" sortProperty="tipo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column sortName="fechaRegistroStr"
							property="fechaRegistroStr"
							titleKey="formularioLoteRearchivo.lista.fecha" sortable="true"
