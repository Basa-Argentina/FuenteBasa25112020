...
<title><c:if test="${accion == 'NUEVO'}">
		<spring:message code="formularioAgregarConcepto.titulo.registrar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'MODIFICACION'}">
		<spring:message code="formularioAgregarConcepto.titulo.modificar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'CONSULTA'}">
		<spring:message code="formularioAgregarConcepto.titulo.consultar"
			htmlEscape="true" />
	</c:if></title>
...
<script type="text/javascript"
	src="js/mavalos_formulario_agregar_concepto.js"></script>
<script type="text/javascript" src="js/jquery.displaytag-ajax-1.2.js"></script>
</head>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="guardarActualizarAgregarConcepto.html"
					modelAttribute="detalle" method="post">
					<input type="hidden" id="accion" name="accion"
						value="<c:out value="${accion}" default="" />" />
					<input type="hidden" id="urlDestino" name="urlDestino"
						value="<c:out value="${detalle.urlDestino}" default="" />" />
					<input type="hidden" id="id" name="id"
						value="<c:out value="${detalle.id}" default="" />" />
					...
					<fieldset>
						...
						<div style="width: 100%;" id="busquedaDiv" align="center">
							<fieldset>
								<legend>
									<spring:message code="formularioAgregarConcepto.datos"
										htmlEscape="true" />
								</legend>
								<table>
									<tr>
										<td class="texto_ti"><spring:message
												code="formularioAgregarConcepto.datos.concepto"
												htmlEscape="true" /></td>
									</tr>
									<tr>
										<td class="texto_ti"><input type="text"
											...
											style="width: 50px;"
											value="<c:out value="${detalle.conceptoFacturable.codigo}" default="" />"
											...
											for="conceptoCodigo"> <c:out
													value="${detalle.conceptoFacturable.descripcion}"
													default="" />
										</label></td>
									</tr>
									<tr>
										<td class="texto_ti"><spring:message
												code="formularioAgregarConcepto.datos.listaPrecios"
												htmlEscape="true" /></td>
									</tr>
									<tr>
										<td class="texto_ti"><input type="text"
											id="listaPreciosCodigo" name="listaPreciosCodigo"
											style="width: 50px;" maxlength="6"
											value="<c:out value="${detalle.listaPrecios.codigo}" default="" />"
											class="requerido upperCase alphaNumeric"
											...
											<button type="button" onclick="abrirPopup('listaPopupMap');"
												...
												<img src="<%=request.getContextPath()%>/images/buscar.png">
											</button>&nbsp;&nbsp; <label id="listaPreciosCodigoLabel"
											for="listaPreciosCodigo"> <c:out
													value="${detalle.listaPrecios.descripcion}" default="" />
										</label></td>
									</tr>
									<tr>
										<td class="texto_ti"><spring:message
												code="formularioAgregarConcepto.datos.tipoVariacion"
												htmlEscape="true" /></td>
									</tr>
									<tr>
										<td class="texto_ti"><select id="variacionId"
											name="variacionId" class="requerido"
									...
									<tr>
										<td class="texto_ti"><spring:message
												code="formularioAgregarConcepto.datos.valor"
												htmlEscape="true" /></td>
									</tr>
									<tr>
										<td class="texto_ti"><input type="text" id="valor"
											name="valor" style="text-align: right;" class="requerido"
									...
									<tr>
										<td class="texto_ti"><spring:message
												code="formularioAgregarConcepto.datos.precioFinal"
												htmlEscape="true" /></td>
									</tr>
									<tr>
										<td class="texto_ti"><input type="text"
											id="precioConcepto" style="text-align: right;"
											class="requerido" readonly="readonly"
											value="<c:out value="${detalle.calcularMonto}" default="" />" />
										</td>
									</tr>
									<c:if test="${accion != 'CONSULTA'}">
										<tr>
