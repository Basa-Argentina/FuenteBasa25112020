...
<title><spring:message code="formularioTipoJerarquia.titulo"
...
<script type="text/javascript"
	src="js/mavalos_consulta_tipo_jerarquia.js"></script>
...
<body
	onload="mostrarErrores(${errores}); mostrarAvisos(${hayAvisos || hayAvisosNeg}); buscarAsociacionesOnBodyLoad('${tipoSel.id}');">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioTipoJerarquia.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarTipoJerarquia.html"
					commandName="tipoJerarquiaBusqueda" method="post">
					<input type="hidden" id="hdn_idTipoJerarquia"
						name="hdn_idTipoJerarquia"
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_td"><spring:message
											code="formularioTipoJerarquia.filtro.codigo"
											htmlEscape="true" /></td>
									...
									<td class="texto_td"><spring:message
											code="formularioTipoJerarquia.filtro.descripcion"
											htmlEscape="true" /></td>
						...
						<td style="width: 40%; min-width: 40%; vertical-align: top;">
							<fieldset style="min-height: 200px;">
								...
								<div style="text-align: center;">
									<display:table name="tipos" id="tipo"
										requestURI="mostrarTipoJerarquia.html" pagesize="10"
										...
										<display:column property="codigo"
											titleKey="formularioTipoJerarquia.filtro.codigo"
											sortable="true" class="celdaAlineadoIzquierda upperCase" />
										<display:column property="descripcion"
											titleKey="formularioTipoJerarquia.filtro.descripcion"
											sortable="true" class="celdaAlineadoIzquierda" />
										<display:column property="observacion"
											titleKey="formularioTipoJerarquia.tabla.observacion"
											sortable="true" class="celdaAlineadoIzquierda" />
								...
								<div class="displayTagDiv"
									...
									<table width="100%;">
										<thead>
											<tr>
												<th align="left"><font style="color: #003090"> <spring:message
															code="formularioTipoJerarquia.tablaB.titulo"
															htmlEscape="true" />&nbsp;<c:out
															value="${tipoSel.descripcion}" />
												</font></th>
											</tr>
										</thead>
									</table>
									<display:table name="tipoSel.jerarquias" id="jerarquia"
										requestURI="mostrarTipoJerarquia.html" pagesize="10"
										sort="list" keepStatus="true">
										<display:column class="hidden" headerClass="hidden">
										...
										<display:column class="hidden" headerClass="hidden">
											<input type="hidden" id="hdn_eliminar"
												value="<spring:message code="formularioJerarquia.confirmacion.eliminarJerarquia" htmlEscape="true"/>" />
										</display:column>
										<display:column property="descripcion"
											titleKey="formularioListaPrecios.tablaB.descripcion"
											sortable="true" class="celdaAlineadoIzquierda" />
										<display:column property="valoracion"
											titleKey="formularioTipoJerarquia.tablaB.valoracion"
											sortable="true" class="celdaAlineadoDerecha" />
										<display:column titleKey="formularioJerarquia.datos.desde"
											sortable="true" class="celdaAlineadoDerecha">
											<c:out value="${jerarquia.coordenadasDesde}" />
										</display:column>
										<display:column titleKey="formularioJerarquia.datos.hasta"
											sortable="true" class="celdaAlineadoDerecha">
											<c:out value="${jerarquia.coordenadasHasta}" />
										</display:column>
										<display:column property="observacion"
											titleKey="formularioTipoJerarquia.tablaB.observacion"
											sortable="true" class="celdaAlineadoIzquierda" />
										<display:column class="celdaAlineadoCentrado">
											<img id="information"
												src="<%=request.getContextPath()%>/images/information.png"
