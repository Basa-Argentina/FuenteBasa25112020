...
<script type="text/javascript" src="js/calendar_us.js"
	language="JavaScript"></script>
<script language="JavaScript" src="js/formulario_medio_cobro.js"
...
<body
					...
					<fieldset>
						<legend>
							...
							<c:if test="${accion == 'CONSULTAR'}">
								<spring:message code="formularioMedioCobro.tituloFormConsultar"
									htmlEscape="true" />
							</c:if>
						</legend>
						<table>
										...
										<table>
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioMedioCobro.campos.tipo" htmlEscape="true" />:
												</td>
												<td class="texto_ti"><select id="idTipoMedioPago"
													name="idTipoMedioPago">
														...
														<c:forEach items="${tipoMedioPagoList}"
															var="tipoMedioPago">
											...
											<tr id="banco">
												<td class="texto_ti"><spring:message
														code="formularioMedioCobro.campos.banco" htmlEscape="true" />:
												</td>
												<td class="texto_ti"><select id="idBancoSel"
													name="idBancoSel">
														<option value="-1"
											...
											<tr id="numero">
												<td class="texto_ti"><spring:message
														code="formularioMedioCobro.tabla.numero" htmlEscape="true" />:
												</td>
												<td class="texto_ti" colspan="3"><input type="text"
													maxlength="15" id="numero" name="numero"
													value="${fn:trim(medioPagoReciboForm.numero)}"
													<c:if test="${accion == 'CONSULTAR'}">disabled="disabled"</c:if>>
												</td>
											</tr>
											<tr id="fechaVencimiento">
												<td class="texto_ti"><spring:message
														code="formularioMedioCobro.tabla.vencimiento"
														htmlEscape="true" />:</td>
												<td class="texto_ti"><input type="text"
													id="fechaVencimientoStr" name="fechaVencimientoStr"
											...
											<tr id="titular">
												<td class="texto_ti"><spring:message
														code="formularioMedioCobro.tabla.titular"
														htmlEscape="true" />:</td>
												<td class="texto_ti" colspan="3"><input type="text"
													maxlength="40" id="titular" name="titular"
											...
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioMedioCobro.tabla.importe"
														htmlEscape="true" />:</td>
												<td class="texto_ti" colspan="3"><input type="text"
													maxlength="10" class="numerico" id="importe" name="importe"
											...
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioMedioCobro.tabla.nota" htmlEscape="true" />:
												</td>
												<td class="texto_ti" colspan="3"><textarea id="nota"
														name="nota" rows="3" cols="40" class="textArea_400"
														style="resize: none;"
														<c:if test="${accion=='CONSULTAR' }">
														readonly="readonly"
													</c:if>>${fn:trim(medioPagoReciboForm.nota)}</textarea>
												</td>
											</tr>
										</table>
									</fieldset>
	...
	<div id="darkLayer" class="darkClassWithoutHeight" style="height: 50%;">&nbsp;</div>
