...
<title><spring:message code="formularioTransporte.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioTransporte.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarTransporte.html"
					commandName="transporteBusqueda" method="post">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioTransporte.buscar.empresa" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioTransporte.buscar.codigoMin"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioTransporte.buscar.codigoMax"
											htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti"><input type="text" id="codigoEmpresa"
										...
										for="codigoEmpresa"> <c:out
												value="${transporteBusqueda.empresa.descripcion}" default="" />
									</label></td>
									<td class="texto_ti"><input type="text" id="codigoMin"
										maxlength="3" name="codigoMin" style="width: 200px;"
										value="<c:out value="${transporteBusqueda.codigoMin}" default="" />" />
									</td>
									<td class="texto_ti"><input type="text" id="codigoMax"
										maxlength="3" name="codigoMax" style="width: 200px;"
				...
				<fieldset>
					<display:table name="transportes" id="transporte"
						requestURI="mostrarTransporte.html" pagesize="20" sort="list"
						keepStatus="true">
						...
						<display:column property="empresa.descripcion"
							titleKey="formularioTransporte.datosTransporte.empresa"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="codigo"
							titleKey="formularioTransporte.datosTransporte.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="descripcion" maxLength="30"
							titleKey="formularioTransporte.datosTransporte.descripcion"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column
							titleKey="formularioTransporte.datosTransporte.habilitado"
							sortable="true" class="celdaAlineadoIzquierda">
							<c:if test="${transporte.habilitado == true }">
								<spring:message code="formularioTransporte.habilitado"
									htmlEscape="true"></spring:message>
							</c:if>
							<c:if test="${transporte.habilitado == false }">
								<spring:message code="formularioTransporte.deshabilitado"
									htmlEscape="true"></spring:message>
							</c:if>
						</display:column>
