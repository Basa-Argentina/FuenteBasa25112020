...
<title><spring:message code="formularioLugares.titulo"
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 25%; min-width: 25%; vertical-align: top;">
						<form:form action="filtrarLugares.html" commandName="paisBusqueda"
							method="post">
							<fieldset>
								<table width="100%">
									<thead>
										<tr>
											<th align="left" id="busquedaImg"><font
												style="color: #003090"> <spring:message
														code="formularioLugares.buscarPaises" htmlEscape="true" />
									...
									<table class="busqueda"
										...
										<tr>
											<td class="texto_ti"><spring:message
													code="formularioLugares.código" htmlEscape="true" /></td>
										</tr>
										<tr>
											<td class="texto_ti"><input type="text" id="id"
												name="id" style="width: 150px;"
												value="<c:out value="${paisBusqueda.id}" default="" />" /></td>
										</tr>
										<tr>
											<td class="texto_ti"><spring:message
						...
						<fieldset style="min-height: 200px;">
								...
								<thead>
									<tr>
										<th align="left"><font style="color: #003090"> <spring:message
													code="formularioLugares.paises" htmlEscape="true" />
										</font></th>
									</tr>
								</thead>
							</table>
							<div style="text-align: center;">
								<display:table name="paises" id="pais" requestURI=""
									pagesize="10" sort="list" keepStatus="true" defaultsort="4">
									<display:column class="hidden" headerClass="hidden">
										<input type="hidden" id="hdn_id" value="${pais.id}" />
									</display:column>
									<display:column class="hidden" headerClass="hidden">
										<input type="hidden" id="hdn_eliminar"
											value="<spring:message code="formularioLugares.mensaje.eliminarPais" htmlEscape="true"/>" />
									</display:column>
									<display:column property="id"
										titleKey="formularioLugares.código" sortable="true"
							...
							<div style="width: 100%" align="center">
								...
								<input type="hidden" id="accion" name="accion"
									...
									value="<c:out value="${paisFormulario.id}" default="" />" /> <input
									type="text" id="nuevo" name="nuevo" size="35"
					...
					<td style="width: 75%; vertical-align: top;"><iframe
							src="mostrarProvincias.html" id="iframePcias" frameborder="0"
							height="700px" width="100%" align="top"
							style="border-spacing: 0px; margin: 0px; padding: 0px;"></iframe>
