...
<title><spring:message code="formularioImpuesto.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioImpuesto.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarImpuesto.html"
					commandName="impuestoBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
				...
				<fieldset>
					<display:table name="impuestos" id="impuesto"
						requestURI="mostrarImpuesto.html" pagesize="7" sort="list"
						keepStatus="true">
						...
						<display:column property="codigo"
							titleKey="formularioImpuesto.filtro.codigo" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="descripcion"
							titleKey="formularioImpuesto.filtro.descripcion" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="tipo"
							titleKey="formularioImpuesto.tabla.tipo" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="alicuota"
							titleKey="formularioImpuesto.tabla.alicuota" sortable="true"
