...
<title><spring:message code="formularioTipoElemento.titulo"
...
<script type="text/javascript"
	src="js/mavalos_consulta_tipo_elemento.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioTipoElemento.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarTipoElemento.html"
					commandName="tipoElementoBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti"><input type="text" id="descripcion"
										name="descripcion" style="width: 200px;" maxlength="30"
				...
				<fieldset>
					<display:table name="tipoElementos" id="tipoElemento"
						requestURI="mostrarTipoElemento.html" pagesize="20" sort="list"
						keepStatus="true">
						...
						<display:column property="codigo"
							titleKey="formularioTipoElemento.datosTipoElemento.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="descripcion"
							titleKey="formularioTipoElemento.nombreTipoElemento"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column value="${tipoElemento.contenedor ? 'SI' : 'NO'}"
							titleKey="formularioTipoElemento.datosTipoElemento.contenedor"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column value="${tipoElemento.contenido ? 'SI' : 'NO'}"
							titleKey="formularioTipoElemento.datosTipoElemento.contenido"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column value="${tipoElemento.posicionable ? 'SI' : 'NO'}"
							titleKey="formularioTipoElemento.datosTipoElemento.posicionable"
							sortable="true" class="celdaAlineadoIzquierda" />
