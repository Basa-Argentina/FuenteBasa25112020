				...
				<fieldset style="border: none; text-align: left; width: 97%;">
					<c:if test="${param.accion != 'CONSULTA'}">
						<form:form action="agregarReferencia.html" commandName="referenciaFormulario" method="post" id="referenciaFormulario">
							...
							<img id="zoom_01" height= "200" src="http://farm6.staticflickr.com/5474/9765019294_91f9710e92_b_d.jpg" data-zoom-image="http://farm6.staticflickr.com/5474/9765019294_91f9710e92_b_d.jpg"/>
							<fieldset>
								...
								<c:if test="${porRango != null && porRango == true}">
										...
										<c:if test="${referencia.clasificacionDocumental!=null && porRango == null || porRango == false || porRango == ''}">
											<tr>
												...
												<td class="texto_ti" id="tit_fecha2" colspan="3">
													<c:if test="${referencia.indiceIndividual}">
											...
											<tr>
												<td class="texto_ti">
													<c:if test="${referencia.indiceIndividual && referencia.clasificacionDocumental.individualNumero1Seleccionado
														...
														<input type="text" id="numero1" name="numero1" style="width: 100px;" tabindex="4" <c:if test="${bloqueoNumero1}">readonly="readonly"</c:if>
											...
											<tr>
												<td class="texto_ti" id="tit_texto1" colspan="2">
													<c:if test="${referencia.indiceIndividual && referencia.clasificacionDocumental.individualTexto1Seleccionado
														...
														/>
														<input type="checkbox" id="chkDoubleInput" name="chkDoubleInput" value="true" title="Ingresar texto por duplicado y verificar"
												...
												<td class="texto_ti" id="tit_texto2" colspan="2">
													<c:if test="${referencia.indiceIndividual && referencia.clasificacionDocumental.individualTexto2Seleccionado
														...
														<input type="text" id="texto2" name="texto2" style="width: 325px;" tabindex="9" maxlength="1255"
											...
											<c:if test="${referencia.clasificacionDocumental.descripcionSeleccionado}">
												...
												<tr>
													<td class="texto_ti" colspan="4">
														<textarea id="descripcion" name="descripcion" cols="90" rows="3" tabindex="10"
