	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
									...
									<td colspan="3">
										<fieldset>
											...
											<table>
														...
														<table>
															<tr>
																...
																<td class="texto_ti"><input type="checkBox"
																	checked="checked" id="habilitado" name="habilitado"
												...
												<tr>
													<td class="texto_ti"><select id="idEmpresa"
														class="requerido" name="idEmpresa" size="1"
														style="width: 190px;"
														<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
													...
													<td class="texto_ti"><select id="idSucursal"
														class="requerido" name="idSucursal" size="1"
														style="width: 190px;"
														<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
															<c:if test="${accion != 'NUEVO'}">
																<c:forEach items="${serieFormulario.empresa.sucursales}"
																	var="sucursal">
												...
												<tr>
													<td class="texto_ti"><select id="tipoSerie"
														class="requerido" name="tipoSerie" size="1"
														style="width: 190px;"
														<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
													...
													<td class="texto_ti"><select
														id="idAfipTipoComprobante" class="requerido"
														name="idAfipTipoComprobante" size="1"
														style="width: 190px;"
														<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
													...
													<td class="texto_ti"><input type="text" id="prefijo"
														maxlength="4" name="prefijo" style="width: 190px;"
														class="requerido"
													...
													<td class="texto_ti"><input type="text"
														id="ultNroImpreso" maxlength="8" name="ultNroImpreso"
														style="width: 190px;"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioSerie.vacio" htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioSerie.condicionIvaClientes"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><select id="condIvaClientes"
														class="requerido" name="condIvaClientes" size="1"
														style="width: 190px;"
														<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
				...
				<fieldset>
					<legend>
						<spring:message code="formularioSerie.nombreTalonCai"
							htmlEscape="true" />
					</legend>
					<display:table name="cais" id="cai"
						requestURI="precargaFormularioSerie.html" pagesize="20"
						...
						<display:column property="numero"
							titleKey="formularioSerie.datosCai.cai.numero" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="fechaVencimientoStr"
							titleKey="formularioSerie.datosCai.cai.vencimiento"
					...
					<div style="width: 100%" align="right">
						<button name="agregar" type="button" onclick="agregarCai();"
							class="botonCentrado"
							<c:if test="${accion != 'MODIFICACION'}">
									disabled="disabled"
								</c:if>>
