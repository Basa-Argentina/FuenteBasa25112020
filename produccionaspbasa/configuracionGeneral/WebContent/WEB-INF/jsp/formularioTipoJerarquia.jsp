...
<title><c:if test="${accion == 'NUEVO'}">
		<spring:message code="formularioTipoJerarquia.titulo.registrar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'MODIFICACION'}">
		<spring:message code="formularioTipoJerarquia.titulo.modificar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'CONSULTA'}">
		<spring:message code="formularioTipoJerarquia.titulo.consultar"
			htmlEscape="true" />
	</c:if></title>
...
<script type="text/javascript"
	src="js/mavalos_formulario_tipo_jerarquia.js"></script>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="guardarActualizarTipoJerarquia.html"
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioTipoJerarquia.datos" htmlEscape="true" />
										...
										<table>
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioTipoJerarquia.datos.codigo"
														htmlEscape="true" /></td>
											</tr>
											<tr>
											...
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioTipoJerarquia.datos.observacion"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="text"
													id="observacion" name="observacion" style="width: 370px;"
													maxlength="60"
													value="<c:out value="${tipoFormulario.descripcion}" default="" />"
													<c:if test="${accion == 'CONSULTA'}">
																readonly="readonly"
											...
											<c:if test="${accion == 'CONSULTA'}">
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioTipoJerarquia.datos.fechaRegistro"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioTipoJerarquia.datos.fechaActualizacion"
															htmlEscape="true" /></td>
												</tr>
												<tr>
													<td class="texto_ti"><input type="text"
