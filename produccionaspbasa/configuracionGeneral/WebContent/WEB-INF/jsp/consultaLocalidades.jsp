...
<body
	...
	<table style="width: 100%; border-spacing: 0px;">
		<tr>
			<td style="width: 48%; vertical-align: top;"><form:form
					action="filtrarLocalidades.html" commandName="paisBusqueda"
					method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioLugares.buscarLocalidades" htmlEscape="true" />
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
										...
										type="hidden" id="pciaId" name="pciaId" style="width: 150px;"
						...
						<thead>
							<tr>
								<th align="left"><font style="color: #003090"> <spring:message
											code="formularioLugares.localidades" htmlEscape="true" />
								</font></th>
							</tr>
						</thead>
					</table>
					<div class="displayTagDiv2" style="text-align: left; height: 80%;">
						<display:table name="pciaSel.localidades" id="localidad"
							requestURI="mostrarLocalidades.html" pagesize="10" sort="list"
							keepStatus="true" defaultsort="1">
							<display:column class="hidden" headerClass="hidden">
								<input type="hidden" id="hdn_id" value="${localidad.id}" />
							</display:column>
							<display:column class="hidden" headerClass="hidden">
								<input type="hidden" id="hdn_eliminar"
									value="<spring:message code="formularioLugares.mensaje.eliminarLocalidad" htmlEscape="true"/>" />
							</display:column>
							...
							<display:column class="hidden" headerClass="hidden">
								<input type="hidden" id="hdn_idPcia"
									value="${localidad.provincia.id}" />
							</display:column>
						</display:table>
					</div>
					<br>
			...
			<td style="width: 52%; vertical-align: top;"><iframe
					src="mostrarBarrios.html" id="iframeBarrios" frameborder="0"
					height="495px" width="100%"></iframe></td>
		</tr>
	</table>
