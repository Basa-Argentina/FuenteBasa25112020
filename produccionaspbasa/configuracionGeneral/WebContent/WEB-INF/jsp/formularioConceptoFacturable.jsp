...
<title><c:if test="${accion == 'NUEVO'}">
		<spring:message code="formularioConceptoFacturable.titulo.registrar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'MODIFICACION'}">
		<spring:message code="formularioConceptoFacturable.titulo.modificar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'CONSULTA'}">
		<spring:message code="formularioConceptoFacturable.titulo.consultar"
			htmlEscape="true" />
	</c:if></title>
...
<script type="text/javascript"
	src="js/mavalos_formulario_concepto_facturable2.js"></script>
</head>
<body
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <c:if
							test="${accion == 'NUEVO'}">
							<spring:message
								code="formularioConceptoFacturable.titulo.registrar"
								htmlEscape="true" />
						</c:if> <c:if test="${accion == 'MODIFICACION'}">
							<spring:message
								code="formularioConceptoFacturable.titulo.modificar"
								htmlEscape="true" />
						</c:if> <c:if test="${accion == 'CONSULTA'}">
							<spring:message
								code="formularioConceptoFacturable.titulo.consultar"
								htmlEscape="true" />
						</c:if>
					</font>
				</legend>
				<br />
				<form:form action="guardarActualizarConceptoFacturable.html"
					modelAttribute="conceptoFormulario" method="post">
					<input type="hidden" id="accion" name="accion"
						value="<c:out value="${accion}" default="" />" />
					<input type="hidden" id="id" name="id"
						value="<c:out value="${conceptoFormulario.id}" default="" />" />
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioConceptoFacturable.datos" htmlEscape="true" />
										...
										<table>
											<tr>
												<td class="texto_ti"><input type="checkbox"
													...
													<spring:message
														code="formularioConceptoFacturable.datos.habilitado"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioConceptoFacturable.datos.codigo"
														htmlEscape="true" /></td>
											</tr>
											<tr>
											...
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioConceptoFacturable.datos.descripcion"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="text"
													id="descripcion" name="descripcion" style="width: 300px;"
													maxlength="60"
													value="<c:out value="${conceptoFormulario.descripcion}" default="" />"
													class="requerido"
													<c:if test="${accion == 'CONSULTA'}">
																readonly="readonly"
															</c:if> />
											...
											<tr>
												<td class="texto_ti"><input type="checkbox"
													id="generaStock" name="generaStock"
													<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>
													...
													<spring:message
														code="formularioConceptoFacturable.datos.generaStock"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioConceptoFacturable.datos.costo"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="text" id="costo"
													name="costo" style="text-align: right;"
													value="<c:out value="${conceptoFormulario.costo}" default="" />"
													class="requerido"
													<c:if test="${accion == 'CONSULTA'}">
																readonly="readonly"
															</c:if> />
											...
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioConceptoFacturable.datos.precioBase"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="text" id="precioBase"
													name="precioBase" style="text-align: right;"
													value="<c:out value="${conceptoFormulario.precioBase}" default="" />"
													class="requerido"
													<c:if test="${accion == 'CONSULTA'}">
																readonly="readonly"
															</c:if> />
											...
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioConceptoFacturable.datos.impuesto"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><input type="text"
													id="impuestoCodigo" name="impuestoCodigo" maxlength="3"
													style="width: 50px;"
													...
													<button type="button"
														onclick="abrirPopup('impuestosPopupMap');"
														title="<spring:message code="textos.buscar" htmlEscape="true"/>"
														<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
														<img src="<%=request.getContextPath()%>/images/buscar.png">
													</button>&nbsp; <label id="impuestoCodigoLabel" for="impuestoCodigo">
														<c:out value="${conceptoFormulario.impuesto.descripcion}"
															default="" />
												</label></td>
											</tr>
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioConceptoFacturable.datos.calculoAutomatico"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><select size="1" id="tipoCalculo"
													name="tipoCalculo" class="requerido"
													<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
											...
											<tr>
												<td class="texto_ti"><spring:message
														code="formularioConceptoFacturable.datos.tipo"
														htmlEscape="true" /></td>
											</tr>
											<tr>
												<td class="texto_ti"><select id="tipoId" name="tipoId"
													class="requerido"
													<c:if test="${accion == 'CONSULTA'}">
																disabled="disabled"
															</c:if>>
