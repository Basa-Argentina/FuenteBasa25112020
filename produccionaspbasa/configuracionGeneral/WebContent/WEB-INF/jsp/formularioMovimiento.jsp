	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form name="formMovimiento"
					action="guardarActualizarMovimiento.html"
					commandName="movimientoFormulario" method="post"
					...
					<input type="hidden" id="codigoSucursalActual"
						name="codigoSucursalActual" maxlength="6" style="width: 50px;"
								...
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioMovimiento.datosMovimiento"
												htmlEscape="true" />
							...
							<table style="width: 100%;">
								<tr>
									<td colspan="3">
										<fieldset>
											<legend>
												<spring:message code="formularioMovimiento.claseMovimiento"
													htmlEscape="true" />
											</legend>
											<table>
												<tr>
													<td><input type="radio" id="claseMovimiento"
														name="claseMovimiento" value="cliente"
														...
														<spring:message code="formularioMovimiento.cliente"
															htmlEscape="true" /></td>
													<td><input type="radio" id="claseMovimiento"
														name="claseMovimiento" value="interno"
														...
														<spring:message code="formularioMovimiento.interno"
															htmlEscape="true" /></td>
													...
													<td id="tdEgresoIngreso">
														<fieldset>
															<legend>
																<spring:message
																	code="formularioMovimiento.datosMovimiento.tipoMovimiento"
																	htmlEscape="true" />
															</legend>
															<table>
																<tr>
											...
											<table class="busqueda"
												...
												<tr>
													<td class="texto_ti" id="tdtituloDepositoActual"><spring:message
															code="formularioMovimiento.depositoActual"
															htmlEscape="true" /></td>
													<td class="texto_ti" id="tdtituloCliente"><spring:message
															code="formularioMovimiento.clienteOrigen"
															htmlEscape="true" /></td>
													<td class="texto_ti" id="tdtituloClienteDestino"><spring:message
															code="formularioMovimiento.clienteDestino"
															htmlEscape="true" /></td>
													<td class="texto_ti" id="tdtituloSucursalDestino"><spring:message
															code="formularioMovimiento.datosMovimiento.sucursalDestino"
															htmlEscape="true" /></td>
													<td class="texto_ti" id="tdtituloDepositoDestino"><spring:message
															code="formularioMovimiento.datosMovimiento.depositoDestino"
															htmlEscape="true" /></td>
													<td class="texto_ti" id="tdtituloSucursalOrigen"><spring:message
															code="formularioMovimiento.datosMovimiento.sucursalOrigen"
															htmlEscape="true" /></td>
													<td class="texto_ti" id="tdtituloDepositoOrigen"><spring:message
															code="formularioMovimiento.datosMovimiento.depositoOrigen"
															htmlEscape="true" /></td>

												</tr>
												<tr>
													<td class="texto_ti" id="tdcodigoDepositoActual"><input
														type="text" id="codigoDepositoActual"
														name="codigoDepositoActual" maxlength="6"
													...
													<td class="texto_ti" id="tdcodigoCliente"><input
														type="text" id="codigoClienteEmp" name="codigoClienteEmp"
														maxlength="6" style="width: 50px;"
													...
													<td class="texto_ti" id="tdcodigoSucursalDestino"><input
														type="text" id="codigoSucursalOrigenDestino"
														name="codigoSucursalOrigenDestino" maxlength="6"
														style="width: 50px;" class="requerido"
													...
													<td class="texto_ti" id="tdcodigoDepositoDestino"><input
														type="text" id="codigoDepositoOrigenDestino"
														name="codigoDepositoOrigenDestino" maxlength="6"
														style="width: 50px;" class="requerido"
												...
												<tr>
													<td class="texto_ti"><spring:message
															code="formularioMovimiento.fecha" htmlEscape="true" /></td>
													<td class="texto_ti"><spring:message
												...
												<tr>
													...
													<td class="texto_ti"><input type="text"
														id="codigoResponsable" name="codigoResponsable"
														maxlength="6" style="width: 50px;"
												...
												<tr>
													<td class="texto_ti" colspan="2"><spring:message
															code="formularioMovimiento.descripcion" htmlEscape="true" />
													</td>
												</tr>
												<tr>
													<td class="texto_ti" colspan="2"><textarea
															id="descripcion" name="descripcion" rows="2" cols="40">
												<c:out value="${movimientoFormulario.descripcion}"
																default="" />
											</textarea></td>
												</tr>
											</table>
					...
					<fieldset>
						...
						<display:table name="listaElementos" id="elemento"
							requestURI="precargaFormularioMovimiento.html" pagesize="40"
							...
							<display:column property="clienteEmp.razonSocialONombreYApellido"
								titleKey="formularioMovimiento.cliente" sortable="true"
								class="celdaAlineadoIzquierda" />
							<display:column property="depositoActual.descripcion"
								titleKey="formularioMovimiento.depositoActual" sortable="true"
								class="celdaAlineadoIzquierda" />
							<display:column
								titleKey="formularioMovimiento.detalles.tipoTrabajo"
								sortable="false" class="trabajo celdaAlineadoIzquierda">
								<c:if test="${elemento.estado == 'En el Cliente'}">
									<select id="tipoTrabajo" name="tipoTrabajo" size="1"
										onchange="listadoTipoTrabajo();"
										<c:if test="${accion == 'CONSULTA'}">
															disabled="disabled"
														</c:if>>
						...
						<c:if test="${accion != 'CONSULTA'}">
							<table>
								<tr>
									<td class="texto_ti" width="50%">
										<button type="button" onclick="abrirPopupCargaElementos();"
											class="botonCentradoGrande">
											<spring:message code="formularioMovimiento.botonAgregar"
												htmlEscape="true" />
											<img src="<%=request.getContextPath()%>/images/add.png">
										</button>
										<button type="button" id="botonQuitar" name="botonQuitar"
											class="botonCentradoGrande">
											<spring:message code="formularioMovimiento.botonQuitar"
												htmlEscape="true" />
											<img src="<%=request.getContextPath()%>/images/cancelar.png">
										</button>
									</td>
									<td class="texto_td" width="50%"><spring:message
											code="formularioPosicionLibre.posicionLibreDetalle.lectura"
											htmlEscape="true" /> <input type="text" id="codigoLectura"
										...
										for="codigoLectura"> <c:out value="${descripcion}"
												default="" />
									</label> <input type="button" name="importar" id="importar"
										class="botonCentrado"
										value="<spring:message code="botones.importar" htmlEscape="true"/>" />
										<input type="checkbox" id="anexar" value="true" name="anexar"
										checked="checked"
										<c:if test="${accion == 'CONSULTA'}">
																	disabled="disabled"
																</c:if> />
									<spring:message code="formularioLectura.lecturaDetalle.anexar"
											htmlEscape="true" /></td>
								</tr>
							</table>
						</c:if>
						...
						<table>
							...
							<tr>
								...
								<td class="texto_ti"><spring:message
										code="formularioMovimiento.vacio" htmlEscape="true" /></td>
								<td class="texto_ti"><spring:message
										code="formularioMovimiento.cantidad" htmlEscape="true" /></td>
