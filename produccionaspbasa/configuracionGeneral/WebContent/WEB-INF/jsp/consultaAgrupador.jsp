...
<title><spring:message code="formularioAgrupador.titulo"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioAgrupador.titulo" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarAgrupador.html"
					commandName="agrupadorBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											...
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioAgrupador.nombreAgrupador" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									...
									<td class="texto_ti"><select id="tipoAgrupador"
										...
										<c:if test="${accion == 'CONSULTA'}">
											...
											<option label="Seleccione un Tipo de Agrupador" value="">Seleccione
												un Tipo de Agrupador</option>
											<option label="Empleado" value="E">Empleado</option>
											<option label="Direcciones de Entrega" value="D">Direcciones
												de Entrega</option>
									</select></td>
								</tr>
							</table>
				...
				<fieldset>
					<display:table name="agrupadores" id="agrupador" requestURI=""
						...
						<display:column style="width:80px;" property="codigo"
							titleKey="formularioAgrupador.datosAgrupador.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="descripcion"
							titleKey="formularioAgrupador.nombreAgrupador" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column style="width:150px;"
							value="${agrupador.tipoAgrupador == 'D' ? 'Direcciones de Entrega' : 'Empleado'}"
							titleKey="formularioAgrupador.datosAgrupador.tipoAgrupador"
							sortable="true" class="celdaAlineadoIzquierda" />
