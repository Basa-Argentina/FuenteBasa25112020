...
<script type="text/javascript"
	src="js/mavalos_consulta_plantillaFacturacion.js"></script>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioPlantillaFacturacion.cliente"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPlantillaFacturacion.serie" htmlEscape="true" />
									</td>
									<td class="texto_ti"><spring:message
											code="formularioPlantillaFacturacion.estado"
											htmlEscape="true" /></td>
								</tr>
								<tr>
										...
										<c:if test="${accion != 'MODIFICACION'}">
											<button type="button" name="buscaSerie" id="buscaSerie"
												...
												<img src="<%=request.getContextPath()%>/images/buscar.png">
													...
													<label id="codigoSerieLabel" for="codigoSerie"> </label>
										</c:if></td>
									<td class="texto_ti"><select id="habilitado"
										name="habilitado">
											<option value=""
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioPlantillaFacturacion.tipoComprobante"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPlantillaFacturacion.listaPrecio"
											htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti"><select id="tipoComprobanteId"
										name="tipoComprobanteId">
											...
											<option value="1"
												...
												<c:if test="${accion == 'CONSULTAR'}">disabled="disabled"</c:if>>Facturas
												A</option>
											<option value="5"
									...
									<td class="texto_ti"><input type="text"
										...
										<c:if test="${accion != 'MODIFICACION'}">
											<button type="button" name="buscaListaPrecio"
												id="buscaListaPrecio"
												title="<spring:message code="textos.buscar" htmlEscape="true"/>"
												<c:if test="${accion == 'CONSULTA'}">
																							disabled="disabled"
												...
												<img src="<%=request.getContextPath()%>/images/buscar.png">
															...
															<label id="listaPreciosCodigoLabel"
												for="listaPreciosCodigo"> </label>
										</c:if></td>
								<tr>
							</table>
						</div>
				...
				<fieldset>
					<display:table name="plantillasFacturacion"
						id="plantillaFacturacion"
						requestURI="mostrarPlantillaFacturacion.html" pagesize="20"
						sort="external" partialList="true" size="${size}">
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_id"
								value="${plantillaFacturacion.id}" />
						</display:column>
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_eliminar"
								value="<spring:message code="mensaje.eliminar" htmlEscape="true"/>" />
						</display:column>
						<display:column sortName="clienteEmp"
						...
						<display:column sortName="serie" property="serie.descripcion"
							...
							class="celdaAlineadoIzquierda" />
						<display:column property="afipTipoComprobante.descripcion"
							sortName="afipTipoComprobante"
							titleKey="formularioPlantillaFacturacion.tipoComprobante"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="listaPrecios.descripcion"
							sortName="listaPrecios"
							titleKey="formularioPlantillaFacturacion.listaPrecio"
