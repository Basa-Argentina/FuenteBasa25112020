...
<title><c:if test="${accion == 'NUEVO'}">
		<spring:message code="formularioImpuesto.titulo.registrar"
			htmlEscape="true" />
	</c:if> <c:if test="${accion == 'MODIFICACION'}">
		<spring:message code="formularioImpuesto.titulo.modificar"
			htmlEscape="true" />
	</c:if></title>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="guardarActualizarImpuesto.html" method="post"
					modelAttribute="impuestoFormulario">
					<input type="hidden" id="accion" name="accion"
						value="<c:out value="${accion}" default="" />" />
					<input type="hidden" id="id" name="id"
						value="<c:out value="${impuestoFormulario.id}" default="" />" />
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
									<th align="left" id="busquedaImg"><font
										style="color: #003090"> <spring:message
												code="formularioImpuesto.datos" htmlEscape="true" />
						...
						<div style="width: 100%;" id="busquedaDiv" align="center">
							<table style="width: 100%;">
								<tr>
									<td class="texto_td" style="width: 50%;"><spring:message
											code="formularioImpuesto.filtro.codigo" htmlEscape="true" />
									</td>
									<td class="texto_ti"><input type="text" id="codigo"
										name="codigo" style="width: 30px;"
										class="requerido upperCase alphaNumeric" maxlength="3"
										value="<c:out value="${impuestoFormulario.codigo}" default="" />" />
									</td>
								</tr>
								<tr>
									<td class="texto_td"><spring:message
											code="formularioImpuesto.filtro.descripcion"
											htmlEscape="true" /></td>
									<td class="texto_ti"><input type="text" id="descripcion"
										name="descripcion" style="width: 200px;" class="requerido"
										value="<c:out value="${impuestoFormulario.descripcion}" default="" />"
										maxlength="30" /></td>
								</tr>
								<tr>
									<td class="texto_td"><spring:message
											code="formularioImpuesto.tabla.tipo" htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_td"><spring:message
											code="formularioImpuesto.tabla.alicuota" htmlEscape="true" />
									</td>
									<td class="texto_ti"><input type="text" id="alicuota"
										name="alicuota" maxlength="6" style="width: 50px;"
										class="requerido"
