...
<title><spring:message
		code="formularioLoteExportacionRearchivo.titulo" htmlEscape="true" />
</title>
...
<script type="text/javascript"
	src="js/consulta_lote_exportacion_rearchivo.js"></script>
		...
		<ul>
			...
			<li id="eliminar"><img src="images/eliminar.png" /> <font
				size="2"><spring:message code="botones.eliminar"
						htmlEscape="true" /></font></li>
			<li id="exportar"><img src="images/print.png" /> <font size="2"><spring:message
						code="botones.exportar" htmlEscape="true" /></font></li>
		</ul>
	</div>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioLoteExportacionRearchivo.titulo"
							htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="consultaExportacionRearchivo.html"
					name="busquedaExportacionLoteRearchivoFormulario"
					commandName="busquedaExportacionLoteRearchivoFormulario"
					method="post">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.busqueda.empresa"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.busqueda.sucursal"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.busqueda.cliente"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.busqueda.clasificacionDocumental"
											htmlEscape="true" /></td>
									<td class="texto_ti">
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.busqueda.codigoDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.busqueda.codigoHasta"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.busqueda.fechaDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioLoteExportacionRearchivo.busqueda.fechaHasta"
											htmlEscape="true" /></td>
				...
				<fieldset>
					<display:table name="lotesExportacion" htmlId="lotesExportacion"
						id="loteExportacion"
						form="busquedaExportacionLoteRearchivoFormulario" pagesize="20">
						...
						<display:column property="id"
							titleKey="formularioLoteExportacionRearchivo.lista.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="fechaRegistroStr"
							titleKey="formularioLoteExportacionRearchivo.lista.fecha"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="empresa.razonSocial.razonSocial"
							titleKey="formularioLoteExportacionRearchivo.lista.empresa"
							sortable="false" class="celdaAlineadoIzquierda" />
						<display:column property="sucursal.descripcion"
							titleKey="formularioLoteExportacionRearchivo.lista.sucursal"
							sortable="false" class="celdaAlineadoIzquierda" />
						<display:column property="clienteEmp.razonSocialONombreYApellido"
							titleKey="formularioLoteExportacionRearchivo.lista.cliente"
							sortable="false" class="celdaAlineadoIzquierda" />
						<display:column property="clasificacionDocumental.nombre"
							titleKey="formularioLoteExportacionRearchivo.lista.clasificacionDocumental"
							sortable="false" class="celdaAlineadoIzquierda" />
