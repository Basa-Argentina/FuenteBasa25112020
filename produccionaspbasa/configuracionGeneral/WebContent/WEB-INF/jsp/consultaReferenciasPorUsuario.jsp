...
<title><c:if test="${tipoHistorico=='elemento'}">
		<spring:message code="menu.consultaReferenciasPorUsuario"
			htmlEscape="true" />
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="informeReferenciasPorUsuario.titulo.totales"
							htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="imprimirReferenciasPorUsuarioXls.html"
					commandName="historicoBusqueda" method="post" name="formBusqueda">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="informeReferenciasPorUsuario.titulo.detallePorDia"
							htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="imprimirReferenciasPorUsuarioDetalle.html"
					commandName="historicoBusqueda" method="post" name="formBusqueda2">
					<input type="hidden" id="clienteId" name="clienteId"
						value="<c:out value="${clienteId}" default="" />" />
					<input type="hidden" id="tipoHistorico" name="tipoHistorico"
						value="<c:out value="${tipoHistorico}" default="" />" />
					<fieldset>
							...
							<thead>
								<tr>
									<th align="left" id="busquedaImg2"><font
										style="color: #003090"> <spring:message
												code="textos.buscar" htmlEscape="true" />
									</font> <img id="busquedaImgSrcDown2" src="images/skip_down.png"
										title="<spring:message code="textos.cerrarPanel" htmlEscape="true"/>">
						...
						<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><input type="text" id="fechaHoraStr"
										name="fechaHoraStr" maxlength="10" style="width: 90px;"
									...
									<td class="texto_ti"><input type="hidden"
										id="codigoEmpresa" name="codigoEmpresa"
										value="<c:out value="${codigoEmpresa}" default="" />" /> <input
										type="text" id="codigoUsuarioDia" name="codigoUsuarioDia"
										maxlength="6" style="width: 90px;"
										...
										for="codigoUsuarioDia"> <c:out value="" default="" />
									</label></td>
