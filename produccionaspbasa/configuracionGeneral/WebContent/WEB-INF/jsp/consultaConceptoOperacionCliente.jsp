...
<title><spring:message
		code="formularioConceptoOperacionCliente.titulo.administrar"
...
<script type="text/javascript"
	src="js/mavalos_consulta_conceptoOperacionCliente.js"></script>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="filtrarConceptoOperacionCliente.html"
					commandName="conceptoOperacionClienteBusqueda" method="post">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.cliente"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.fechaDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.fechaHasta"
											htmlEscape="true" /></td>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.estado"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.tipoConcepto"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.cantidadDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.cantidadHasta"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td class="texto_ti"><select id="estado" name="estado"
										size="1">
											...
											<option label="Pendiente" value="Pendiente"
												<c:if test="${conceptoOperacionClienteBusqueda.estado == 'Pendiente'}">
															selected="selected"
														</c:if>>Pendiente</option>
											<option label="Facturado" value="Facturado"
												<c:if test="${conceptoOperacionClienteBusqueda.estado == 'Facturado'}">
															selected="selected"
														</c:if>>Facturado</option>
											<option label="Cancelado" value="Cancelado"
												<c:if test="${conceptoOperacionClienteBusqueda.estado == 'Cancelado'}">
															selected="selected"
									...
									<td class="texto_ti"><select id="tipoConcepto"
										...
										<c:if test="${accion == 'CONSULTA'}">disabled="disabled"</c:if>>
											...
											<option label="Automatico" value="Automatico"
												<c:if test="${conceptoOperacionClienteBusqueda.tipoConcepto == 'Automatico'}">
															selected="selected"
														</c:if>>Automatico</option>
											<option label="Manual" value="Manual"
												<c:if test="${conceptoOperacionClienteBusqueda.tipoConcepto == 'Manual'}">
															selected="selected"
														</c:if>>Manual</option>
									</select></td>
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.numeroRequerimientoDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.numeroRequerimientoHasta"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.finalUnitarioDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.finalUnitarioHasta"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									...
									<td class="texto_ti">
										<table>
											<tr>
												<td><input type="text" id="prefijoRequerimientoDesde"
													name="prefijoRequerimientoDesde" maxlength="4" size="4"
													...
													-</td>
												<td><input type="text" id="numeroRequerimientoDesde"
													name="numeroRequerimientoDesde" maxlength="8" size="8"
													class="completarZeros inputTextNumericPositiveIntegerOnly"
									...
									<td class="texto_ti">
										<table>
											<tr>
												<td><input type="text" id="prefijoRequerimientoHasta"
													name="prefijoRequerimientoHasta" maxlength="4" size="4"
													class="completarZeros inputTextNumericPositiveIntegerOnly"
												...
												<td><input type="text" id="numeroRequerimientoHasta"
													name="numeroRequerimientoHasta" maxlength="8" size="8"
													class="completarZeros inputTextNumericPositiveIntegerOnly"
									...
									<td class="texto_ti"><input type="text"
										id="finalUnitarioDesde" name="finalUnitarioDesde"
										maxlength="12" size="12"
										value="<c:out value="${conceptoOperacionClienteBusqueda.finalUnitarioDesde}" default="" />" />
									</td>
									<td class="texto_ti"><input type="text"
										id="finalUnitarioHasta" name="finalUnitarioHasta"
										maxlength="12" size="12"
								...
								<tr>
									...
									<td><spring:message
											...
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.finalTotalDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioConceptoOperacionCliente.finalTotalHasta"
											htmlEscape="true" /></td>
								</tr>
								<tr>
									<td><spring:message
									...
									<td><spring:message
											...
											htmlEscape="true" /></td>
									<td class="texto_ti"><input type="text"
										id="finalTotalDesde" name="finalTotalDesde" maxlength="12"
										size="12"
										value="<c:out value="${conceptoOperacionClienteBusqueda.finalTotalDesde}" default="" />" />
									</td>
									<td class="texto_ti"><input type="text"
										id="finalTotalHasta" name="finalTotalHasta" maxlength="12"
										size="12"
				...
				<fieldset>
					<display:table name="conceptosOperacionCliente"
						id="conceptoOperacionCliente"
						requestURI="mostrarConceptoOperacionCliente.html" pagesize="20"
						sort="list" keepStatus="true">
						<display:column class="hidden" headerClass="hidden">
							<input type="hidden" id="hdn_id"
								value="${conceptoOperacionCliente.id}" />
						</display:column>
						<display:column class="hidden" headerClass="hidden">
						...
						<display:column property="conceptoFacturable.codigo"
							titleKey="formularioConceptoOperacionCliente.codigo"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="conceptoFacturable.descripcion"
							titleKey="formularioConceptoOperacionCliente.concepto"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="clienteEmp.razonSocialONombreYApellido"
							titleKey="formularioConceptoOperacionCliente.cliente"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="fechaAltaStr"
							titleKey="formularioConceptoOperacionCliente.fecha"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="tipoConcepto"
							titleKey="formularioConceptoOperacionCliente.tipoConcepto"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="finalUnitario"
							titleKey="formularioConceptoOperacionCliente.finalUnitario"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="cantidad"
							titleKey="formularioConceptoOperacionCliente.cantidad"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="finalTotal"
							titleKey="formularioConceptoOperacionCliente.finalTotal"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="estadoStr"
							titleKey="formularioConceptoOperacionCliente.estado"
							sortable="true" class="celdaAlineadoIzquierda" />
						<display:column property="codigoSeriePrefijoNumero"
							titleKey="formularioConceptoOperacionCliente.requerimiento"
							sortable="true" class="celdaAlineadoIzquierda" />
					</display:table>
