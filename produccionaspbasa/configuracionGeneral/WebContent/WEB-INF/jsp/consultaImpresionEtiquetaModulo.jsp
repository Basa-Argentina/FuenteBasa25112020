...
<script type="text/javascript"
	src="js/mavalos_consulta_impresion_etiqueta_modulo.js"></script>
...
<body
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<form:form action="filtrarImpresionEtiquetaModulo.html"
					...
					<input type="hidden" id="errorCodEstMayor" name="errorCodEstMayor"
						value="<spring:message code="formularioImpresionEtiquetaModulo.error.codigoEstanteriaMayor" htmlEscape="true" />" />
					<input type="hidden" id="errorCodDeposito" name="errorCodDeposito"
						value="<spring:message code="formularioImpresionEtiquetaModulo.error.codigoDeposito" htmlEscape="true" />" />
					<input type="hidden" id="errorCodSeccion" name="errorCodSeccion"
						value="<spring:message code="formularioImpresionEtiquetaModulo.error.codigoSeccion" htmlEscape="true" />" />
					<input type="hidden" id="errorTitulo" name="errorTitulo"
						value="<spring:message code="formularioImpresionEtiquetaModulo.error.titulo" htmlEscape="true" />" />
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioImpresionEtiquetaModulo.deposito"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioImpresionEtiquetaModulo.seccion"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioImpresionEtiquetaModulo.estanteriaDesde"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioImpresionEtiquetaModulo.estanteriaHasta"
											htmlEscape="true" /></td>
				...
				<form:form action="cambiarEstadoPosiciones.html"
					...
					<fieldset>
						<display:table name="modulos" id="modulo"
							requestURI="mostrarImpresionEtiquetaModulo.html" pagesize="20"
							sort="external" partialList="true" size="${size}">
							<display:column class="hidden" headerClass="hidden">
								<input type="hidden" id="hdn_id" value="${modulo.id}" />
							</display:column>
							<display:column sortProperty="deposito"
								property="estante.grupo.seccion.deposito.codigo"
								titleKey="formularioImpresionEtiquetaModulo.deposito"
								sortable="true" class="celdaAlineadoIzquierda" />
							<display:column sortName="seccion"
								property="estante.grupo.seccion.codigo"
								titleKey="formularioImpresionEtiquetaModulo.seccion"
								sortable="true" class="celdaAlineadoIzquierda" />
							<display:column sortName="estante" property="estante.codigo"
								titleKey="formularioImpresionEtiquetaModulo.posicion.estante"
								sortable="true" class="celdaAlineadoIzquierda" />
							<display:column sortName="modulo"
								titleKey="formularioImpresionEtiquetaModulo.modulo"
						...
						<fieldset>
							...
							<div
								...
								<table class="imprimir"
									style="width: 100%; background-color: white;">
									<tr>
										<td><select id="cantImprimir" name="cantImprimir"
										...
										<td>
											<button id="imprimirModulos" name="imprimirModulos"
												type="button">
												<img
													src="<%=request.getContextPath()%>/images/impresora.gif">
	...
	<div id="pop">
		<img src="<%=request.getContextPath()%>/images/wait.gif" border="0"
			width="20px" height="20px"> <label><spring:message></spring:message></label>
	</div>
</html>