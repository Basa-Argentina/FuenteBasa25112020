		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<input type="hidden" id="errorSeleccioneEmpresa"
					...
					value="<spring:message code="formularioFactura.error.seleccioneEmpresa" htmlEscape="true" />" />
				<input type="hidden" id="errorSeleccioneSucursal"
					name="errorSeleccioneSucursal"
					value="<spring:message code="formularioFactura.error.seleccioneSucursal" htmlEscape="true" />" />
				...
				<form:form id="formFactura" name="formFactura"
					action="guardarActualizarFactura.html"
					commandName="facturaAGuardar" method="post"
					modelAttribute="facturaAGuardar">
					<input type="hidden" id="accionFactura" name="accionFactura"
						value="<c:out value="${accionFactura}" default="" />" />
					<input type="hidden" id="idAfipTipoComprobanteSelected"
						name="idAfipTipoComprobanteSelected"
						value="<c:out value="${facturaFormulario.idAfipTipoComprobante}" default="0" />" />
					...
					<input type="hidden" id="clienteEmpCodigoCondIva"
						...
						value="<c:out value="${facturaFormulario.clienteEmpCodigoCondIva}" default="" />" />
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
										...
										<table>
											<tr>
												...
												<td><input id="numeroComprobanteStr"
													...
													value="<c:out value="${facturaFormulario.numeroStr}" default="" />"
				...
				<fieldset>
					...
					<display:table name="facturaDetalles" id="detalle"
						requestURI="precargaformularioFactura.html" pagesize="10"
						...
						<display:column property="listaprecios.codigo"
							...
							class="celdaAlineadoIzquierda" />
						<display:column titleKey="formularioFactura.tabla.precio"
							sortable="true" class="celdaAlineadoIzquierda">
								$ <fmt:formatNumber value="${detalle.netoUnitario}"></fmt:formatNumber>
						</display:column>
						<display:column titleKey="formularioFactura.tabla.iva"
							sortable="true" class="celdaAlineadoIzquierda">
						...
						<display:column property="cantidad"
							...
							class="celdaAlineadoIzquierda" />
						<display:column titleKey="formularioFactura.tabla.total"
							sortable="true" class="celdaAlineadoIzquierda">
					...
					<div>
						<table width="100%">
							<tr>
								<td><spring:message
										code="formularioFactura.tabla.totalNeto" htmlEscape="true" />
									$ <fmt:formatNumber value="${facturaFormulario.totalNeto}"></fmt:formatNumber>
								</td>
								<td><spring:message
										code="formularioFactura.tabla.totalImpuestos"
										htmlEscape="true" /> $ <fmt:formatNumber
										value="${facturaFormulario.totalIVA}"></fmt:formatNumber></td>
								<td><spring:message
										code="formularioFactura.tabla.totalFinal" htmlEscape="true" />
