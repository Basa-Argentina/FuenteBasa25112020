...
<title><spring:message code="formularioPosicion.tituloConsulta"
...
<body
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioPosicion.empresa" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPosicion.sucursal" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPosicion.deposito" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPosicion.seccion" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioPosicion.codigoDesdeEstante"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPosicion.codigoHastaEstante"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									...
									<td class="texto_ti"><spring:message
										...
										<spring:message code="formularioPosicion.posHorModulo"
											htmlEscape="true" /> <input type="text"
										id="posDesdeHorModulo" name="posDesdeHorModulo" maxlength="3"
										style="width: 50px;"
									...
									<td class="texto_ti"><spring:message
										...
										<spring:message code="formularioPosicion.posHorModulo"
											htmlEscape="true" /> <input type="text"
										id="posHastaHorModulo" name="posHastaHorModulo" maxlength="3"
										style="width: 50px;"
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioPosicion.codigoDesde" htmlEscape="true" /> <label>     
									</label> <spring:message code="formularioPosicion.codigoHasta"
											htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
											code="formularioPosicion.vacio" htmlEscape="true" /></td>
									<td class="texto_ti"><spring:message
								...
								<tr>
									<td class="texto_ti"><input type="text" id="codigoDesde"
										name="codigoDesde" maxlength="13" size="13"
										...
										name="codigoHasta" maxlength="13" size="13"
										class="inputTextNumericPositiveIntegerOnly completarZeros"
									...
									<td class="texto_ti"><spring:message
										...
										type="text" id="posDesdeVert" name="posDesdeVert"
									...
									<td class="texto_ti"><spring:message
											code="formularioPosicion.posVer" htmlEscape="true" /> <input
										type="text" id="posHastaVert" name="posHastaVert"
										maxlength="3" style="width: 50px;"
									...
									<td class="texto_ti" rowspan="1">
										<button id="botonExportar" name="botonExportar"
											class="botonCentrado" type="button" onclick="exportar();">
								...
								<tr>
									<td class="texto_ti"><spring:message
											code="formularioPosicion.posicion.estado" htmlEscape="true" />
									</td>
								</tr>
								<tr>
									<td class="texto_ti"><select id="estado" name="estado"
										size="1">
											...
											<option label="DISPONIBLE" value="DISPONIBLE"
												<c:if test="${posicionBusqueda.estado == 'DISPONIBLE'}">
															selected="selected"
														</c:if>>DISPONIBLE</option>
											<option label="OCUPADA" value="OCUPADA"
												<c:if test="${posicionBusqueda.estado == 'OCUPADA'}">
															selected="selected"
														</c:if>>OCUPADA</option>
											<option label="ANULADO" value="ANULADO"
												<c:if test="${posicionBusqueda.estado == 'ANULADO'}">
															selected="selected"
														</c:if>>ANULADO</option>
											<option label="TEMPORALMENTE ANULADA"
												value="TEMPORALMENTE ANULADA"
												<c:if test="${posicionBusqueda.estado == 'TEMPORALMENTE ANULADA'}">
															selected="selected"
														</c:if>>TEMPORALMENTE
												ANULADA</option>
									</select></td>
				...
				<form:form action="cambiarEstadoPosiciones.html"
					...
					<fieldset>
						<display:table name="posiciones" id="posicion"
							requestURI="mostrarPosicion.html" pagesize="${pagesize}"
							...
							<display:column style="width:100px;"
								titleKey="formularioPosicion.selected" sortable="false"
								class="celdaAlineadoCentrado" media="html">
								<input type="checkBox" id="selectedSel" name="selectedSel"
									style="width: 10px;" value="${posicion.id}"
							...
							<display:column sortName="deposito"
								property="estante.grupo.seccion.deposito.codigo"
								titleKey="formularioPosicion.deposito" sortable="true"
								class="celdaAlineadoIzquierda" />
							<display:column sortName="seccion"
								property="estante.grupo.seccion.codigo"
							...
							<display:column sortName="estante" property="estante.codigo"
								...
								class="celdaAlineadoIzquierda" />
							<display:column sortName="modulo"
								titleKey="formularioPosicion.posicion.modulo" sortable="true"
								class="celdaAlineadoCentrado">
								<c:out
									value="(${posicion.modulo.posVertical};${posicion.modulo.posHorizontal})" />
							</display:column>
							<display:column sortName="posicion"
								titleKey="formularioPosicion.posicion" sortable="true"
								class="celdaAlineadoCentrado">
								<c:out
									value="(${posicion.posVertical};${posicion.posHorizontal})" />
							</display:column>
	...
	<div id="pop">
		<img src="<%=request.getContextPath()%>/images/wait.gif" border="0"
			width="20px" height="20px"> <label>Cambiando estado de
			las Posiciones seleccionadas. Espere por favor...</label>
	</div>
</html>