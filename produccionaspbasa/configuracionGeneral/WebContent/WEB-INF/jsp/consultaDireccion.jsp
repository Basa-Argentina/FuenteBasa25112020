...
<title><spring:message code="formularioDireccion.tituloConsulta"
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				<legend>
					<font class="tituloForm" size="5"> <spring:message
							code="formularioDireccion.tituloConsulta" htmlEscape="true" />
					</font>
				</legend>
				<br />
				<form:form action="filtrarDireccion.html"
					commandName="direccionBusqueda" method="post">
					<fieldset>
						<table width="100%">
							<thead>
								<tr>
							...
							<table class="busqueda"
								...
								<tr>
									<td class="texto_ti"><select id="idBarrio" name="idBarrio"
										size="1" style="width: 200px;">
											<c:forEach
												items="${direccionBusqueda.barrio.localidad.barrios}"
												var="b">
												<option
				...
				<fieldset>
					<display:table name="direcciones" id="direccion"
						requestURI="mostrarDireccion.html" pagesize="7" sort="list"
						keepStatus="true">
						...
						<display:column property="barrio.nombre"
							titleKey="formularioDireccion.barrio" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="calle"
							titleKey="formularioDireccion.calle" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="numero"
							titleKey="formularioDireccion.numero" sortable="true"
							class="celdaAlineadoIzquierda" />
						<display:column property="observaciones"
							titleKey="formularioDireccion.observaciones" sortable="true"
							class="celdaAlineadoIzquierda" />
					...
					<div style="width: 100%" align="right">
						<button name="agregar" type="button" onclick="agregarDireccion();"
							class="botonCentrado">
